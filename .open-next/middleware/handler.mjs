...
var require_middleware = __commonJS({
  ".next/server/middleware.js"() {
    ...
    (self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([[751], { 16: (a, b, c) => {
      ...
      "use strict";
      c.d(b, { headers: () => q }), c(818), c(725);
      var d = c(535), e = c(115), f = c(557), g = c(602), h = c(801), i = c(815);
      ...
      var p = c(381);
      function q() {
        let a2 = d.J.getStore(), b2 = e.FP.getStore();
        if (a2) {
          if (b2 && "after" === b2.phase && !(0, n.iC)()) throw Object.defineProperty(Error(`Route ${a2.route} used "headers" inside "after(...)". This is not supported. If you need this data inside an "after" callback, use "headers" outside of the callback. See more info here: https://nextjs.org/docs/canary/app/api-reference/functions/after`), "__NEXT_ERROR_CODE", { value: "E367", enumerable: false, configurable: true });
          if (a2.forceStatic) return s(p.o.seal(new Headers({})));
          if (b2) {
          ...
          if (a2.dynamicShouldError) throw Object.defineProperty(new g.f(`Route ${a2.route} with \`dynamic = "error"\` couldn't be rendered statically because it used \`headers\`. See more info here: https://nextjs.org/docs/app/building-your-application/rendering/static-and-dynamic#dynamic-rendering`), "__NEXT_ERROR_CODE", { value: "E525", enumerable: false, configurable: true });
          if (b2) switch (b2.type) {
            case "prerender":
              var c2 = b2;
              let d2 = r.get(c2);
              if (d2) return d2;
              let e2 = (0, h.W)(c2.renderSignal, "`headers()`");
              return r.set(c2, e2), e2;
            case "prerender-client":
              let i2 = "`headers`";
              throw Object.defineProperty(new o.z(`${i2} must not be used within a client component. Next.js should be preventing ${i2} from being included in client components statically, but did not in this case.`), "__NEXT_ERROR_CODE", { value: "E693", enumerable: false, configurable: true });
            case "prerender-ppr":
              (0, f.Ui)(a2.route, "headers", b2.dynamicTracking);
              break;
            case "prerender-legacy":
              (0, f.xI)("headers", a2, b2);
          }
          (0, f.Pk)(a2, b2);
        }
        return s((0, e.XN)("headers").headers);
      }
      ...
      }), c(16), /* @__PURE__ */ new WeakMap(), m(function(a2, b2) {
        let c2 = a2 ? `Route "${a2}" ` : "This route ";
      ...
      "use strict";
      let d;
      c.r(b), c.d(b, { default: () => h5 });
      var e = {};
      async function f() {
        return "_ENTRIES" in globalThis && _ENTRIES.middleware_instrumentation && await _ENTRIES.middleware_instrumentation;
      }
      c.r(e), c.d(e, { config: () => h1, default: () => h0 });
      let g = null;
      async function h() {
...
Learn More: https://nextjs.org/docs/messages/node-module-in-edge-runtime`;
  ...
  `);
      ...
      function r(a10) {
        var b10, c10, d10, e10, f10, g10 = [], h6 = 0;
        function i2() {
          for (; h6 < a10.length && /\s/.test(a10.charAt(h6)); ) h6 += 1;
          return h6 < a10.length;
        }
        for (; h6 < a10.length; ) {
          for (b10 = h6, f10 = false; i2(); ) if ("," === (c10 = a10.charAt(h6))) {
            for (d10 = h6, h6 += 1, i2(), e10 = h6; h6 < a10.length && "=" !== (c10 = a10.charAt(h6)) && ";" !== c10 && "," !== c10; ) h6 += 1;
            h6 < a10.length && "=" === a10.charAt(h6) ? (f10 = true, h6 = e10, g10.push(a10.substring(b10, d10)), b10 = h6) : h6 = d10 + 1;
          } else h6 += 1;
          (!f10 || h6 >= a10.length) && g10.push(a10.substring(b10, a10.length));
        }
        return g10;
      }
      function s(a10) {
      ...
      class J {
        ...
        analyze() {
          ...
          let f10 = function(a11, b11) {
            var c11, d11;
            let { basePath: e11, i18n: f11, trailingSlash: g11 } = null != (c11 = b11.nextConfig) ? c11 : {}, h7 = { pathname: a11, trailingSlash: "/" !== a11 ? a11.endsWith("/") : g11 };
            e11 && D(h7.pathname, e11) && (h7.pathname = function(a12, b12) {
              if (!D(a12, b12)) return a12;
              let c12 = a12.slice(b12.length);
              return c12.startsWith("/") ? c12 : "/" + c12;
            }(h7.pathname, e11), h7.basePath = e11);
            let i2 = h7.pathname;
            if (h7.pathname.startsWith("/_next/data/") && h7.pathname.endsWith(".json")) {
              let a12 = h7.pathname.replace(/^\/_next\/data\//, "").replace(/\.json$/, "").split("/");
              h7.buildId = a12[0], i2 = "index" !== a12[1] ? "/" + a12.slice(1).join("/") : "/", true === b11.parseData && (h7.pathname = i2);
            }
            if (f11) {
              let a12 = b11.i18nProvider ? b11.i18nProvider.analyze(h7.pathname) : F(h7.pathname, f11.locales);
              h7.locale = a12.detectedLocale, h7.pathname = null != (d11 = a12.pathname) ? d11 : h7.pathname, !a12.detectedLocale && h7.buildId && (a12 = b11.i18nProvider ? b11.i18nProvider.analyze(i2) : F(i2, f11.locales)).detectedLocale && (h7.locale = a12.detectedLocale);
            }
            return h7;
          ...
          let h6 = (null == (c10 = this[I].domainLocale) ? void 0 : c10.defaultLocale) || (null == (e10 = this[I].options.nextConfig) || null == (d10 = e10.i18n) ? void 0 : d10.defaultLocale);
          this[I].url.pathname = f10.pathname, this[I].defaultLocale = h6, this[I].basePath = f10.basePath ?? "", this[I].buildId = f10.buildId, this[I].locale = f10.locale ?? h6, this[I].trailingSlash = f10.trailingSlash;
        }
        formatPathname() {
          var a10;
          let b10;
      ...
      let T = "Next-Router-Prefetch", U = ["RSC", "Next-Router-State-Tree", T, "Next-HMR-Refresh", "Next-Router-Segment-Prefetch"];
      var V = c(381), W = c(818), X = function(a10) {
      ...
      let ah = ["Middleware.execute", "BaseServer.handleRequest", "Render.getServerSideProps", "Render.getStaticProps", "AppRender.fetch", "AppRender.getBodyResult", "Render.renderDocument", "Node.runHandler", "AppRouteRouteHandlers.runHandler", "ResolveMetadata.generateMetadata", "ResolveMetadata.generateViewport", "NextNodeServer.createComponentTree", "NextNodeServer.findPageComponents", "NextNodeServer.getLayoutOrPageModule", "NextNodeServer.startResponse", "NextNodeServer.clientComponentLoading"], ai = ["NextNodeServer.findPageComponents", "NextNodeServer.createComponentTree", "NextNodeServer.clientComponentLoading"];
      function aj(a10) {
        return null !== a10 && "object" == typeof a10 && "then" in a10 && "function" == typeof a10.then;
      }
      let { context: ak, propagation: al, trace: am, SpanStatusCode: an, SpanKind: ao, ROOT_CONTEXT: ap } = d = c(956);
      ...
      let ar = (a10, b10) => {
        (function(a11) {
          return "object" == typeof a11 && null !== a11 && a11 instanceof aq;
        })(b10) && b10.bubble ? a10.setAttribute("next.bubble", true) : (b10 && a10.recordException(b10), a10.setStatus({ code: an.ERROR, message: null == b10 ? void 0 : b10.message })), a10.end();
      }, as = /* @__PURE__ */ new Map(), at = d.createContextKey("next.rootSpanId"), au = 0, av = { set(a10, b10, c10) {
      ...
      class aw {
        ...
        getTracePropagationData() {
          let a10 = ak.active(), b10 = [];
          return al.inject(a10, b10, av), b10;
        }
        getActiveScopeSpan() {
        ...
        withPropagatedContext(a10, b10, c10) {
          let d10 = ak.active();
          if (am.getSpanContext(d10)) return b10();
          let e10 = al.extract(d10, a10, c10);
          return ak.with(e10, b10);
        }
        trace(...a10) {
          var b10;
          let [c10, d10, e10] = a10, { fn: f10, options: g10 } = "function" == typeof d10 ? { fn: d10, options: {} } : { fn: e10, options: { ...d10 } }, h6 = g10.spanName ?? c10;
          if (!ah.includes(c10) && "1" !== process.env.NEXT_OTEL_VERBOSE || g10.hideSpan) return f10();
          let i2 = this.getSpanContext((null == g10 ? void 0 : g10.parentSpan) ?? this.getActiveScopeSpan()), j2 = false;
          i2 ? (null == (b10 = am.getSpanContext(i2)) ? void 0 : b10.isRemote) && (j2 = true) : (i2 = (null == ak ? void 0 : ak.active()) ?? ap, j2 = true);
          let k2 = au++;
          return g10.attributes = { "next.span_name": h6, "next.span_type": c10, ...g10.attributes }, ak.with(i2.setValue(at, k2), () => this.getTracerInstance().startActiveSpan(h6, g10, (a11) => {
            let b11 = "performance" in globalThis && "measure" in performance ? globalThis.performance.now() : void 0, d11 = () => {
              as.delete(k2), b11 && process.env.NEXT_OTEL_PERFORMANCE_PREFIX && ai.includes(c10 || "") && performance.measure(`${process.env.NEXT_OTEL_PERFORMANCE_PREFIX}:next-${(c10.split(".").pop() || "").replace(/[A-Z]/g, (a12) => "-" + a12.toLowerCase())}`, { start: b11, end: performance.now() });
            };
            j2 && as.set(k2, new Map(Object.entries(g10.attributes ?? {})));
            try {
              if (f10.length > 1) return f10(a11, (b13) => ar(a11, b13));
              let b12 = f10(a11);
              if (aj(b12)) return b12.then((b13) => (a11.end(), b13)).catch((b13) => {
                throw ar(a11, b13), b13;
              }).finally(d11);
              return a11.end(), d11(), b12;
            } catch (b12) {
              throw ar(a11, b12), d11(), b12;
            }
          }));
        }
        wrap(...a10) {
          let b10 = this, [c10, d10, e10] = 3 === a10.length ? a10 : [a10[0], {}, a10[1]];
          return ah.includes(c10) || "1" === process.env.NEXT_OTEL_VERBOSE ? function() {
            let a11 = d10;
            ...
            {
              let d11 = b10.getContext().bind(ak.active(), g10);
        ...
        setRootSpanAttribute(a10, b10) {
          let c10 = ak.active().getValue(at), d10 = as.get(c10);
          d10 && d10.set(a10, b10);
        }
      }
      let ax = (() => {
      ...
      class az {
        constructor(a10, b10, c10, d10) {
          ...
          }(b10, a10).isOnDemandRevalidate, g10 = null == (e10 = c10.get(ay)) ? void 0 : e10.value;
      ...
      var aB = c(115), aC = c(802), aD = c.n(aC), aE = c(730), aF = c(535);
      class aG {
        constructor(a10, b10) {
      ...
      c(356).Buffer, new aG(52428800, (a10) => a10.size), process.env.NEXT_PRIVATE_DEBUG_CACHE && console.debug.bind(console, "DefaultCacheHandler:"), process.env.NEXT_PRIVATE_DEBUG_CACHE && ((a10, ...b10) => {
        console.log(`use-cache: ${a10}`, ...b10);
      }), Symbol.for("@next/cache-handlers");
      let aH = Symbol.for("@next/cache-handlers-map"), aI = Symbol.for("@next/cache-handlers-set"), aJ = globalThis;
      function aK() {
        if (aJ[aH]) return aJ[aH].entries();
      }
      async function aL(a10, b10) {
        if (!a10) return b10();
        let c10 = aM(a10);
        try {
          return await b10();
      ...
      async function aO(a10, b10) {
        ...
        return Promise.all([aN(c10, a10.incrementalCache), ...Object.values(d10), ...e10]);
      }
      var aP = c(620), aQ = c(427);
      class aR {
        constructor({ waitUntil: a10, onClose: b10, onTaskError: c10 }) {
          this.workUnitStores = /* @__PURE__ */ new Set(), this.waitUntil = a10, this.onClose = b10, this.onTaskError = c10, this.callbackQueue = new (aD())(), this.callbackQueue.pause();
        }
        after(a10) {
          if (aj(a10)) this.waitUntil || aS(), this.waitUntil(a10.catch((a11) => this.reportTaskError("promise", a11)));
          else if ("function" == typeof a10) this.addCallback(a10);
          else throw Object.defineProperty(Error("`after()`: Argument must be a promise or a function"), "__NEXT_ERROR_CODE", { value: "E50", enumerable: false, configurable: true });
        }
        addCallback(a10) {
          this.waitUntil || aS();
          let b10 = aB.FP.getStore();
          b10 && this.workUnitStores.add(b10);
          let c10 = aQ.Z.getStore(), d10 = c10 ? c10.rootTaskSpawnPhase : null == b10 ? void 0 : b10.phase;
          this.runCallbacksOnClosePromise || (this.runCallbacksOnClosePromise = this.runCallbacksOnClose(), this.waitUntil(this.runCallbacksOnClosePromise));
          let e10 = (0, aP.cg)(async () => {
            try {
              await aQ.Z.run({ rootTaskSpawnPhase: d10 }, () => a10());
            } catch (a11) {
        ...
        async runCallbacks() {
          ...
          let a10 = aF.J.getStore();
          if (!a10) throw Object.defineProperty(new aE.z("Missing workStore in AfterContext.runCallbacks"), "__NEXT_ERROR_CODE", { value: "E547", enumerable: false, configurable: true });
          return aL(a10, () => (this.callbackQueue.start(), this.callbackQueue.onIdle()));
        }
        reportTaskError(a10, b10) {
          if (console.error("promise" === a10 ? "A promise passed to `after()` rejected:" : "An error occurred in a function passed to `after()`:", b10), this.onTaskError) try {
            ...
            console.error(Object.defineProperty(new aE.z("`onTaskError` threw while handling an error thrown from an `after` task", { cause: a11 }), "__NEXT_ERROR_CODE", { value: "E569", enumerable: false, configurable: true }));
          }
        }
      }
      function aS() {
      ...
      let aW = Symbol.for("@next/request-context");
      async function aX(a10, b10, c10) {
        ...
        return { tags: d10, expirationsByCacheKind: function(a11) {
          let b11 = /* @__PURE__ */ new Map(), c11 = aK();
          if (c11) for (let [d11, e11] of c11) "getExpiration" in e11 && b11.set(d11, aT(async () => e11.getExpiration(...a11)));
          return b11;
        }(d10) };
      }
      class aY extends M {
      ...
      let aZ = { keys: (a10) => Array.from(a10.keys()), get: (a10, b10) => a10.get(b10) ?? void 0 }, a$ = (a10, b10) => ax().withPropagatedContext(a10.headers, b10, aZ), a_ = false;
      async function a0(a10) {
        var b10;
        let d10, e10;
        if (!a_ && (a_ = true, "true" === process.env.NEXT_PRIVATE_TEST_PROXY)) {
        ...
        let h6 = process.env.__NEXT_BUILD_ID || "";
        "buildId" in g10 && (h6 = g10.buildId || "", g10.buildId = "");
        let i2 = function(a11) {
          let b11 = new Headers();
        ...
        if (!f10) for (let a11 of U) {
          ...
          null !== c10 && (m2.set(b11, c10), i2.delete(b11));
        }
        let n2 = new aY({ page: a10.page, input: function(a11) {
        ...
        j2 && Object.defineProperty(n2, "__isData", { enumerable: false, value: true }), !globalThis.__incrementalCacheShared && a10.IncrementalCache && (globalThis.__incrementalCache = new a10.IncrementalCache({ CurCacheHandler: a10.incrementalCacheHandler, minimalMode: true, fetchCacheKeyPrefix: "", dev: false, requestHeaders: a10.request.headers, getPrerenderManifest: () => ({ version: -1, routes: {}, dynamicRoutes: {}, notFoundRoutes: [], preview: aV() }) }));
        let o2 = a10.request.waitUntil ?? (null == (b10 = function() {
          let a11 = globalThis[aW];
          return null == a11 ? void 0 : a11.get();
        }()) ? void 0 : b10.waitUntil), p2 = new y({ request: n2, page: a10.page, context: o2 ? { waitUntil: o2 } : void 0 });
        if ((d10 = await a$(n2, () => {
          if ("/middleware" === a10.page || "/src/middleware" === a10.page) {
            let b11 = p2.waitUntil.bind(p2), c10 = new aU();
            return ax().trace(ag.execute, { spanName: `middleware ${n2.method} ${n2.nextUrl.pathname}`, attributes: { "http.target": n2.nextUrl.pathname, "http.method": n2.method } }, async () => {
              try {
                var d11, f11, g11, i3, j3, k2;
                let l3 = aV(), m3 = await aX("/", n2.nextUrl, null), o3 = (j3 = n2.nextUrl, k2 = (a11) => {
                  e10 = a11;
                }, function(a11, b12, c11, d12, e11, f12, g12, h7, i4, j4, k3) {
                  function l4(a12) {
                  ...
                  return { type: "request", phase: a11, implicitTags: f12, url: { pathname: d12.pathname, search: d12.search ?? "" }, rootParams: e11, get headers() {
                    return m4.headers || (m4.headers = function(a12) {
                      let b13 = V.o.from(a12);
                      for (let a13 of U) b13.delete(a13.toLowerCase());
                      return V.o.seal(b13);
                    }(b12.headers)), m4.headers;
                  }, get cookies() {
                    if (!m4.cookies) {
                      let a12 = new K.tm(V.o.from(b12.headers));
                      aA(b12, a12), m4.cookies = W.Ck.seal(a12);
                    }
                    return m4.cookies;
                  }, set cookies(value) {
                    m4.cookies = value;
                  }, get mutableCookies() {
                    if (!m4.mutableCookies) {
                      let a12 = function(a13, b13) {
                        let c12 = new K.tm(V.o.from(a13));
                        return W.K8.wrap(c12, b13);
                      }(b12.headers, g12 || (c11 ? l4 : void 0));
                      aA(b12, a12), m4.mutableCookies = a12;
                    }
                    return m4.mutableCookies;
                  }, get userspaceMutableCookies() {
                    return m4.userspaceMutableCookies || (m4.userspaceMutableCookies = (0, W.hm)(this.mutableCookies)), m4.userspaceMutableCookies;
                  }, get draftMode() {
                    return m4.draftMode || (m4.draftMode = new az(i4, b12, this.cookies, this.mutableCookies)), m4.draftMode;
                  }, renderResumeDataCache: h7 ?? null, isHmrRefresh: j4, serverComponentsHmrCache: k3 || globalThis.__serverComponentsHmrCache };
                }("action", n2, void 0, j3, {}, m3, k2, void 0, l3, false, void 0)), q3 = function({ page: a11, fallbackRouteParams: b12, renderOpts: c11, requestEndedState: d12, isPrefetchRequest: e11, buildId: f12, previouslyRevalidatedTags: g12 }) {
                  var h7;
                  let i4 = { isStaticGeneration: !c11.shouldWaitOnAllReady && !c11.supportsDynamicResponse && !c11.isDraftMode && !c11.isPossibleServerAction, page: a11, fallbackRouteParams: b12, route: (h7 = a11.split("/").reduce((a12, b13, c12, d13) => b13 ? "(" === b13[0] && b13.endsWith(")") || "@" === b13[0] || ("page" === b13 || "route" === b13) && c12 === d13.length - 1 ? a12 : a12 + "/" + b13 : a12, "")).startsWith("/") ? h7 : "/" + h7, incrementalCache: c11.incrementalCache || globalThis.__incrementalCache, cacheLifeProfiles: c11.cacheLifeProfiles, isRevalidate: c11.isRevalidate, isBuildTimePrerendering: c11.nextExport, hasReadableErrorStacks: c11.hasReadableErrorStacks, fetchCache: c11.fetchCache, isOnDemandRevalidate: c11.isOnDemandRevalidate, isDraftMode: c11.isDraftMode, requestEndedState: d12, isPrefetchRequest: e11, buildId: f12, reactLoadableManifest: (null == c11 ? void 0 : c11.reactLoadableManifest) || {}, assetPrefix: (null == c11 ? void 0 : c11.assetPrefix) || "", afterContext: function(a12) {
                    let { waitUntil: b13, onClose: c12, onAfterTaskError: d13 } = a12;
                    return new aR({ waitUntil: b13, onClose: c12, onTaskError: d13 });
                  }(c11), dynamicIOEnabled: c11.experimental.dynamicIO, dev: c11.dev ?? false, previouslyRevalidatedTags: g12, refreshTagsByCacheKind: function() {
                    let a12 = /* @__PURE__ */ new Map(), b13 = aK();
                    if (b13) for (let [c12, d13] of b13) "refreshTags" in d13 && a12.set(c12, aT(async () => d13.refreshTags()));
                    return a12;
                  }(), runInCleanSnapshot: (0, aP.$p)() };
                  return c11.store = i4, i4;
                }({ page: "/", fallbackRouteParams: null, renderOpts: { cacheLifeProfiles: null == (f11 = a10.request.nextConfig) || null == (d11 = f11.experimental) ? void 0 : d11.cacheLife, experimental: { isRoutePPREnabled: false, dynamicIO: false, authInterrupts: !!(null == (i3 = a10.request.nextConfig) || null == (g11 = i3.experimental) ? void 0 : g11.authInterrupts) }, supportsDynamicResponse: true, waitUntil: b11, onClose: c10.onClose.bind(c10), onAfterTaskError: void 0 }, requestEndedState: { ended: false }, isPrefetchRequest: n2.headers.has(T), buildId: h6 ?? "", previouslyRevalidatedTags: [] });
                return await aF.J.run(q3, () => aB.FP.run(o3, a10.handler, n2, p2));
              } finally {
                setTimeout(() => {
                  c10.dispatchClose();
                }, 0);
        ...
        if (d10 && q2 && (l2 || !f10)) {
          let b11 = new J(q2, { forceLocale: true, headers: a10.request.headers, nextConfig: a10.request.nextConfig });
          f10 || b11.host !== n2.nextUrl.host || (b11.buildId = h6 || b11.buildId, d10.headers.set("x-middleware-rewrite", String(b11)));
        ...
        if (d10 && r2 && !f10) {
          let b11 = new J(r2, { forceLocale: false, headers: a10.request.headers, nextConfig: a10.request.nextConfig });
          d10 = new Response(d10.body, d10), b11.host === g10.host && (b11.buildId = h6 || b11.buildId, d10.headers.set("Location", b11.toString())), j2 && (d10.headers.delete("Location"), d10.headers.set("x-nextjs-redirect", S(b11.toString(), g10.toString()).url));
        }
        let s2 = d10 || R.next(), t2 = s2.headers.get("x-middleware-override-headers"), u2 = [];
        if (t2) {
          for (let [a11, b11] of m2) s2.headers.set(`x-middleware-request-${a11}`, b11), u2.push(a11);
          u2.length > 0 && s2.headers.set("x-middleware-override-headers", t2 + "," + u2.join(","));
        }
        return { response: s2, waitUntil: ("internal" === p2[w].kind ? Promise.all(p2[w].promises).then(() => {
      ...
      function a3(a10, b10, c10) {
        ...
        return a10 instanceof RegExp ? function(a11, b11) {
          ...
          return a3(a11, b10, c10).source;
        }), new RegExp("(?:".concat(d10.join("|"), ")"), a2(c10))) : function(a11, b11, c11) {
          void 0 === c11 && (c11 = {});
          for (var d11 = c11.strict, e10 = void 0 !== d11 && d11, f10 = c11.start, g10 = c11.end, h6 = c11.encode, i2 = void 0 === h6 ? function(a12) {
            return a12;
          } : h6, j2 = c11.delimiter, k2 = c11.endsWith, l2 = "[".concat(a1(void 0 === k2 ? "" : k2), "]|$"), m2 = "[".concat(a1(void 0 === j2 ? "/#?" : j2), "]"), n2 = void 0 === f10 || f10 ? "^" : "", o2 = 0; o2 < a11.length; o2++) {
            var p2 = a11[o2];
            if ("string" == typeof p2) n2 += a1(i2(p2));
            else {
              var q2 = a1(i2(p2.prefix)), r2 = a1(i2(p2.suffix));
          ...
          for (var c11 = function(a12) {
            for (var b12 = [], c12 = 0; c12 < a12.length; ) {
              ...
              if ("(" === d12) {
                ...
                for (; f11 < a12.length; ) {
                  ...
                  } else if ("(" === a12[f11] && (h7++, "?" !== a12[f11 + 1])) throw TypeError("Capturing groups are not allowed at ".concat(f11));
                  i3 += a12[f11++];
                }
                if (h7) throw TypeError("Unbalanced pattern at ".concat(c12));
          ...
          }(a11), d11 = b11.prefixes, e10 = void 0 === d11 ? "./" : d11, f10 = b11.delimiter, g10 = void 0 === f10 ? "/#?" : f10, h6 = [], i2 = 0, j2 = 0, k2 = "", l2 = function(a12) {
            ...
            var b12 = h6[h6.length - 1], c12 = a12 || (b12 && "string" == typeof b12 ? b12 : "");
            if (b12 && !c12) throw TypeError('Must have text between two parameters, missing text after "'.concat(b12.name, '"'));
            return !c12 || o2(c12) ? "[^".concat(a1(g10), "]+?") : "(?:(?!".concat(a1(c12), ")[^").concat(a1(g10), "])+?");
          }; j2 < c11.length; ) {
            var q2 = l2("CHAR"), r2 = l2("NAME"), s2 = l2("PATTERN");
            if (r2 || s2) {
              var t2 = q2 || "";
              -1 === e10.indexOf(t2) && (k2 += t2, t2 = ""), k2 && (h6.push(k2), k2 = ""), h6.push({ name: r2 || i2++, prefix: t2, suffix: "", pattern: s2 || p2(t2), modifier: l2("MODIFIER") || "" });
              continue;
            }
            ...
            if (k2 && (h6.push(k2), k2 = ""), l2("OPEN")) {
              var t2 = n2(), v2 = l2("NAME") || "", w2 = l2("PATTERN") || "", x2 = n2();
              m2("CLOSE"), h6.push({ name: v2 || (w2 ? i2++ : ""), pattern: v2 && !w2 ? p2(t2) : w2, prefix: t2, suffix: x2, modifier: l2("MODIFIER") || "" });
              continue;
            }
            m2("END");
          }
      ...
      let a5 = () => {
        ...
        return false;
      }, a6 = /* @__PURE__ */ new Set(), a7 = [".lcl.dev", ".lclstage.dev", ".lclclerk.com"], a8 = [".accounts.dev", ".accountsstage.dev", ".accounts.lclclerk.com"], a9 = [".lcl.dev", ".stg.dev", ".lclstage.dev", ".stgstage.dev", ".dev.lclclerk.com", ".stg.lclclerk.com", ".accounts.lclclerk.com", "accountsstage.dev", "accounts.dev"], ba = [".lcl.dev", "lclstage.dev", ".lclclerk.com", ".accounts.lclclerk.com"], bb = [".accountsstage.dev"], bc = "https://api.clerk.com", bd = "https://frontend-api.clerk.dev", be = "/__clerk", bf = (a10) => "undefined" != typeof atob && "function" == typeof atob ? atob(a10) : void 0 !== globalThis.Buffer ? globalThis.Buffer.from(a10, "base64").toString() : a10, bg = "pk_live_";
      function bh(a10) {
      ...
      function bk(a10) {
        return a10.startsWith("live_") || a10.startsWith("pk_live_");
      }
      function bl(a10) {
      ...
      async function bm(a10, b10 = globalThis.crypto.subtle) {
        ...
        return (c10 = String.fromCharCode(...new Uint8Array(await b10.digest("sha-1", d10))), "undefined" != typeof btoa && "function" == typeof btoa ? btoa(c10) : void 0 !== globalThis.Buffer ? globalThis.Buffer.from(c10).toString("base64") : c10).replace(/\+/gi, "-").replace(/\//gi, "_").substring(0, 8);
      }
      let bn = { initialDelay: 125, maxDelayBetweenRetries: 0, factor: 2, shouldRetry: (a10, b10) => b10 < 5, retryImmediately: false, jitter: true }, bo = async (a10) => new Promise((b10) => setTimeout(b10, a10)), bp = (a10, b10) => b10 ? a10 * (1 + Math.random()) : a10, bq = async (a10, b10 = {}) => {
        let c10 = 0, { shouldRetry: d10, initialDelay: e10, maxDelayBetweenRetries: f10, factor: g10, retryImmediately: h6, jitter: i2, onBeforeRetry: j2 } = { ...bn, ...b10 }, k2 = /* @__PURE__ */ ((a11) => {
          let b11 = 0;
          return async () => {
            await bo((() => {
        ...
        for (; ; ) try {
          ...
          j2 && await j2(c10), h6 && 1 === c10 ? await bo(bp(100, i2)) : await k2();
        }
      };
      function br(a10) {
        return function(b10) {
...
Docs: ${d10}`), b10;
      ...
      var bv = class a10 extends bs {
        ...
        constructor(b10, c10) {
          ...
          super({ ...c10, message: b10, code: "api_response_error" }), Object.setPrototypeOf(this, a10.prototype), this.status = e10, this.clerkTraceId = f10, this.retryAfter = g10, this.errors = (d10 || []).map((a11) => new bt(a11));
        }
        toString() {
          let a11 = `[${this.name}]
Message:${this.message}
...
Clerk Trace ID: ${this.clerkTraceId}`), a11;
      ...
      function by({ packageName: a10, customMessages: b10 }) {
        let c10 = a10;
      ...
      var bz = by({ packageName: "@clerk/backend" }), { isDevOrStagingUrl: bA } = /* @__PURE__ */ function() {
        let a10 = /* @__PURE__ */ new Map();
        return { isDevOrStagingUrl: (b10) => {
          if (!b10) return false;
          let c10 = "string" == typeof b10 ? b10 : b10.hostname, d10 = a10.get(c10);
          return void 0 === d10 && (d10 = a9.some((a11) => c10.endsWith(a11)), a10.set(c10, d10)), d10;
        } };
      }(), bB = { InvalidSecretKey: "clerk_key_invalid" }, bC = { TokenExpired: "token-expired", TokenInvalid: "token-invalid", TokenInvalidAlgorithm: "token-invalid-algorithm", TokenInvalidAuthorizedParties: "token-invalid-authorized-parties", TokenInvalidSignature: "token-invalid-signature", TokenNotActiveYet: "token-not-active-yet", TokenIatInTheFuture: "token-iat-in-the-future", TokenVerificationFailed: "token-verification-failed", InvalidSecretKey: "secret-key-invalid", LocalJWKMissing: "jwk-local-missing", RemoteJWKFailedToLoad: "jwk-remote-failed-to-load", JWKFailedToResolve: "jwk-failed-to-resolve", JWKKidMismatch: "jwk-kid-mismatch" }, bD = { ContactSupport: "Contact support@clerk.com", EnsureClerkJWT: "Make sure that this is a valid Clerk-generated JWT.", SetClerkJWTKey: "Set the CLERK_JWT_KEY environment variable.", SetClerkSecretKey: "Set the CLERK_SECRET_KEY environment variable." }, bE = class a10 extends Error {
      ...
      }, bF = { TokenInvalid: "token-invalid", InvalidSecretKey: "secret-key-invalid", UnexpectedError: "unexpected-error", TokenVerificationFailed: "token-verification-failed" }, bG = class a10 extends bs {
      ...
      bG.kind = "MachineTokenVerificationError";
      let bH = crypto;
      var bI = fetch.bind(globalThis), bJ = { crypto: bH, get fetch() {
        return bI;
      }, AbortController: globalThis.AbortController, Blob: globalThis.Blob, FormData: globalThis.FormData, Headers: globalThis.Headers, Request: globalThis.Request, Response: globalThis.Response }, bK = { parse: (a10, b10) => function(a11, b11, c10 = {}) {
        if (!b11.codes) {
          b11.codes = {};
        ...
        let e10 = new (c10.out ?? Uint8Array)(d10 * b11.bits / 8 | 0), f10 = 0, g10 = 0, h6 = 0;
        for (let c11 = 0; c11 < d10; ++c11) {
          let d11 = b11.codes[a11[c11]];
          if (void 0 === d11) throw SyntaxError("Invalid character " + a11[c11]);
          g10 = g10 << b11.bits | d11, (f10 += b11.bits) >= 8 && (f10 -= 8, e10[h6++] = 255 & g10 >> f10);
        }
        if (f10 >= b11.bits || 255 & g10 << 8 - f10) throw SyntaxError("Unexpected end of data");
        return e10;
      }(a10, bL, b10) }, bL = { chars: "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_", bits: 6 }, bM = { RS256: "SHA-256", RS384: "SHA-384", RS512: "SHA-512" }, bN = "RSASSA-PKCS1-v1_5", bO = { RS256: bN, RS384: bN, RS512: bN }, bP = Object.keys(bM), bQ = (a10, b10) => {
        if (void 0 === a10 && void 0 === b10) return;
        let c10 = b10 ?? "JWT", d10 = Array.isArray(c10) ? c10 : [c10];
        if (!d10.includes(a10)) throw new bE({ action: bD.EnsureClerkJWT, reason: bC.TokenInvalid, message: `Invalid JWT type ${JSON.stringify(a10)}. Expected "${d10.join(", ")}".` });
      }, bR = (a10) => {
        if (!bP.includes(a10)) throw new bE({ action: bD.EnsureClerkJWT, reason: bC.TokenInvalidAlgorithm, message: `Invalid JWT algorithm ${JSON.stringify(a10)}. Supported: ${bP}.` });
      };
      async function bS(a10, b10) {
        let { header: c10, signature: d10, raw: e10 } = a10, f10 = new TextEncoder().encode([e10.header, e10.payload].join(".")), g10 = function(a11) {
          let b11 = bM[a11], c11 = bO[a11];
          if (!b11 || !c11) throw Error(`Unsupported algorithm ${a11}, expected one of ${bP.join(",")}.`);
          return { hash: { name: bM[a11] }, name: bO[a11] };
        }(c10.alg);
        try {
          let a11 = await function(a12, b11, c11) {
            if ("object" == typeof a12) return bJ.crypto.subtle.importKey("jwk", a12, b11, false, [c11]);
            ...
            return bJ.crypto.subtle.importKey(e11, d11, b11, false, [c11]);
          }(b10, g10, "verify");
          return { data: await bJ.crypto.subtle.verify(g10.name, a11, d10, f10) };
        } catch (a11) {
          return { errors: [new bE({ reason: bC.TokenInvalidSignature, message: a11?.message })] };
        }
      }
      function bT(a10) {
        let b10 = (a10 || "").toString().split(".");
        if (3 !== b10.length) return { errors: [new bE({ reason: bC.TokenInvalid, message: "Invalid JWT form. A JWT consists of three parts separated by dots." })] };
        let [c10, d10, e10] = b10, f10 = new TextDecoder(), g10 = JSON.parse(f10.decode(bK.parse(c10, { loose: true }))), h6 = JSON.parse(f10.decode(bK.parse(d10, { loose: true })));
        return { data: { header: g10, payload: h6, signature: bK.parse(e10, { loose: true }), raw: { header: c10, payload: d10, signature: e10, text: a10 } } };
      }
      async function bU(a10, b10) {
        let { audience: c10, authorizedParties: d10, clockSkewInMs: e10, key: f10, headerType: g10 } = b10, h6 = "number" == typeof e10 && Number.isFinite(e10) ? e10 : 5e3, { data: i2, errors: j2 } = bT(a10);
        ...
        let { data: m2, errors: n2 } = await bS(i2, f10);
        if (n2) return { errors: [new bE({ action: bD.EnsureClerkJWT, reason: bC.TokenVerificationFailed, message: `Error verifying JWT signature. ${n2[0]}` })] };
        if (!m2) return { errors: [new bE({ reason: bC.TokenInvalidSignature, message: "JWT signature is invalid." })] };
        try {
          let { azp: a11, sub: b11, aud: e11, iat: f11, exp: g11, nbf: i3 } = l2;
          if ("string" != typeof b11) throw new bE({ action: bD.EnsureClerkJWT, reason: bC.TokenVerificationFailed, message: `Subject claim (sub) is required and must be a string. Received ${JSON.stringify(b11)}.` });
          let j3 = [c10].flat().filter((a12) => !!a12), k3 = [e11].flat().filter((a12) => !!a12);
          if (j3.length > 0 && k3.length > 0) if ("string" == typeof e11) {
            if (!j3.includes(e11)) throw new bE({ action: bD.EnsureClerkJWT, reason: bC.TokenVerificationFailed, message: `Invalid JWT audience claim (aud) ${JSON.stringify(e11)}. Is not included in "${JSON.stringify(j3)}".` });
          } else {
            let a12;
            if (a12 = e11, Array.isArray(a12) && a12.length > 0 && a12.every((a13) => "string" == typeof a13) && !e11.some((a13) => j3.includes(a13))) throw new bE({ action: bD.EnsureClerkJWT, reason: bC.TokenVerificationFailed, message: `Invalid JWT audience claim array (aud) ${JSON.stringify(e11)}. Is not included in "${JSON.stringify(j3)}".` });
          }
          if (a11 && d10 && 0 !== d10.length && !d10.includes(a11)) throw new bE({ reason: bC.TokenInvalidAuthorizedParties, message: `Invalid JWT Authorized party claim (azp) ${JSON.stringify(a11)}. Expected "${d10}".` });
          if ("number" != typeof g11) throw new bE({ action: bD.EnsureClerkJWT, reason: bC.TokenVerificationFailed, message: `Invalid JWT expiry date claim (exp) ${JSON.stringify(g11)}. Expected number.` });
          let m3 = new Date(Date.now()), n3 = /* @__PURE__ */ new Date(0);
          if (n3.setUTCSeconds(g11), n3.getTime() <= m3.getTime() - h6) throw new bE({ reason: bC.TokenExpired, message: `JWT is expired. Expiry date: ${n3.toUTCString()}, Current date: ${m3.toUTCString()}.` });
          ((a12, b12) => {
            if (void 0 === a12) return;
            if ("number" != typeof a12) throw new bE({ action: bD.EnsureClerkJWT, reason: bC.TokenVerificationFailed, message: `Invalid JWT not before date claim (nbf) ${JSON.stringify(a12)}. Expected number.` });
            let c11 = new Date(Date.now()), d11 = /* @__PURE__ */ new Date(0);
            if (d11.setUTCSeconds(a12), d11.getTime() > c11.getTime() + b12) throw new bE({ reason: bC.TokenNotActiveYet, message: `JWT cannot be used prior to not before date claim (nbf). Not before date: ${d11.toUTCString()}; Current date: ${c11.toUTCString()};` });
          })(i3, h6), ((a12, b12) => {
            if (void 0 === a12) return;
            if ("number" != typeof a12) throw new bE({ action: bD.EnsureClerkJWT, reason: bC.TokenVerificationFailed, message: `Invalid JWT issued at date claim (iat) ${JSON.stringify(a12)}. Expected number.` });
            let c11 = new Date(Date.now()), d11 = /* @__PURE__ */ new Date(0);
            if (d11.setUTCSeconds(a12), d11.getTime() > c11.getTime() + b12) throw new bE({ reason: bC.TokenIatInTheFuture, message: `JWT issued at date claim (iat) is in the future. Issued at date: ${d11.toUTCString()}; Current date: ${c11.toUTCString()};` });
          })(f11, h6);
        } catch (a11) {
          return { errors: [a11] };
        }
      ...
      var bV = Object.create, bW = Object.defineProperty, bX = Object.getOwnPropertyDescriptor, bY = Object.getOwnPropertyNames, bZ = Object.getPrototypeOf, b$ = Object.prototype.hasOwnProperty, b_ = (a10) => {
        throw TypeError(a10);
      }, b0 = (a10, b10, c10) => b10.has(a10) || b_("Cannot " + c10), b1 = (a10, b10, c10) => b10.has(a10) ? b_("Cannot add the same private member more than once") : b10 instanceof WeakSet ? b10.add(a10) : b10.set(a10, c10), b2 = (a10, b10, c10) => (b0(a10, b10, "access private method"), c10);
      function b3(a10) {
      ...
      let b5 = [".vercel.app"];
      function b6(a10) {
        return b5.some((b10) => a10?.endsWith(b10)) ?? false;
      }
      let b7 = { strict_mfa: { afterMinutes: 10, level: "multi_factor" }, strict: { afterMinutes: 10, level: "second_factor" }, moderate: { afterMinutes: 60, level: "second_factor" }, lax: { afterMinutes: 1440, level: "second_factor" } }, b8 = /* @__PURE__ */ new Set(["first_factor", "second_factor", "multi_factor"]), b9 = /* @__PURE__ */ new Set(["strict_mfa", "strict", "moderate", "lax"]), ca = /* @__PURE__ */ new Set(["o", "org", "organization"]), cb = /* @__PURE__ */ new Set(["u", "user"]), cc = (a10) => "number" == typeof a10 && Number.isFinite(a10) && (-1 === a10 || a10 >= 0), cd = (a10) => a10.replace(/^(org:)*/, "org:"), ce = (a10, b10) => {
        let { org: c10, user: d10 } = cf(a10), [e10, f10] = b10.split(":"), g10 = void 0 !== f10, h6 = f10 || e10;
        if (g10 && !ca.has(e10) && !cb.has(e10)) throw Error(`Invalid scope: ${e10}`);
        if (g10) {
          if (ca.has(e10)) return c10.includes(h6);
          if (cb.has(e10)) return d10.includes(h6);
        }
        return [...c10, ...d10].includes(h6);
      }, cf = (a10) => {
        let b10 = [], c10 = [];
        ...
        for (let a11 = 0; a11 < d10.length; a11++) {
          ...
          let g10 = e10.slice(0, f10), h6 = e10.slice(f10 + 1);
          "o" === g10 ? b10.push(h6) : "u" === g10 ? c10.push(h6) : ("ou" === g10 || "uo" === g10) && (b10.push(h6), c10.push(h6));
        }
        return { org: b10, user: c10 };
      };
      var cg = /* @__PURE__ */ ((a10, b10) => function() {
        return b10 || (0, a10[bY(a10)[0]])((b10 = { exports: {} }).exports, b10), b10.exports;
      })({ "../../node_modules/.pnpm/cookie@1.1.1/node_modules/cookie/dist/index.js"(a10) {
        Object.defineProperty(a10, "__esModule", { value: true }), a10.parseCookie = i2, a10.parse = i2, a10.stringifyCookie = function(a11, d11) {
          let e11 = d11?.encode || encodeURIComponent, f11 = [];
          for (let d12 of Object.keys(a11)) {
            let g11 = a11[d12];
            if (void 0 === g11) continue;
            if (!b10.test(d12)) throw TypeError(`cookie name is invalid: ${d12}`);
            let h7 = e11(g11);
            if (!c10.test(h7)) throw TypeError(`cookie val is invalid: ${g11}`);
            f11.push(`${d12}=${h7}`);
          }
          return f11.join("; ");
        }, a10.stringifySetCookie = j2, a10.serialize = j2, a10.parseSetCookie = function(a11, b11) {
          let c11 = b11?.decode || n2, d11 = a11.length, e11 = k2(a11, 0, d11), g11 = l2(a11, 0, e11), h7 = -1 === g11 ? { name: "", value: c11(m2(a11, 0, e11)) } : { name: m2(a11, 0, g11), value: c11(m2(a11, g11 + 1, e11)) }, i3 = e11 + 1;
          for (; i3 < d11; ) {
            let b12 = k2(a11, i3, d11), c12 = l2(a11, i3, b12), e12 = -1 === c12 ? m2(a11, i3, b12) : m2(a11, i3, c12), g12 = -1 === c12 ? void 0 : m2(a11, c12 + 1, b12);
            switch (e12.toLowerCase()) {
              case "httponly":
                h7.httpOnly = true;
                break;
              case "secure":
              ...
              case "path":
                ...
                break;
              case "max-age":
                g12 && f10.test(g12) && (h7.maxAge = Number(g12));
                break;
              case "expires":
                if (!g12) break;
                let j3 = new Date(g12);
                Number.isFinite(j3.valueOf()) && (h7.expires = j3);
                break;
              case "priority":
                if (!g12) break;
                let n3 = g12.toLowerCase();
                ("low" === n3 || "medium" === n3 || "high" === n3) && (h7.priority = n3);
                break;
              case "samesite":
                if (!g12) break;
                let o2 = g12.toLowerCase();
                ("lax" === o2 || "strict" === o2 || "none" === o2) && (h7.sameSite = o2);
            }
            i3 = b12 + 1;
          }
          return h7;
        }, a10.stringifySetCookie = j2, a10.serialize = j2;
        var b10 = /^[\u0021-\u003A\u003C\u003E-\u007E]+$/, c10 = /^[\u0021-\u003A\u003C-\u007E]*$/, d10 = /^([.]?[a-z0-9]([a-z0-9-]{0,61}[a-z0-9])?)([.][a-z0-9]([a-z0-9-]{0,61}[a-z0-9])?)*$/i, e10 = /^[\u0020-\u003A\u003D-\u007E]*$/, f10 = /^-?\d+$/, g10 = Object.prototype.toString, h6 = (() => {
          let a11 = function() {
          };
          return a11.prototype = /* @__PURE__ */ Object.create(null), a11;
        })();
        function i2(a11, b11) {
          let c11 = new h6(), d11 = a11.length;
          if (d11 < 2) return c11;
          let e11 = b11?.decode || n2, f11 = 0;
          do {
            let b12 = l2(a11, f11, d11);
            if (-1 === b12) break;
            let g11 = k2(a11, f11, d11);
            if (b12 > g11) {
              f11 = a11.lastIndexOf(";", b12 - 1) + 1;
              continue;
            }
            let h7 = m2(a11, f11, b12);
            void 0 === c11[h7] && (c11[h7] = e11(m2(a11, b12 + 1, g11))), f11 = g11 + 1;
          } while (f11 < d11);
          return c11;
        }
        function j2(a11, f11, h7) {
          let i3 = "object" == typeof a11 ? a11 : { ...h7, name: a11, value: String(f11) }, j3 = ("object" == typeof f11 ? f11 : h7)?.encode || encodeURIComponent;
          if (!b10.test(i3.name)) throw TypeError(`argument name is invalid: ${i3.name}`);
          let k3 = i3.value ? j3(i3.value) : "";
          if (!c10.test(k3)) throw TypeError(`argument val is invalid: ${i3.value}`);
          let l3 = i3.name + "=" + k3;
          if (void 0 !== i3.maxAge) {
            if (!Number.isInteger(i3.maxAge)) throw TypeError(`option maxAge is invalid: ${i3.maxAge}`);
            l3 += "; Max-Age=" + i3.maxAge;
          }
          if (i3.domain) {
            if (!d10.test(i3.domain)) throw TypeError(`option domain is invalid: ${i3.domain}`);
            l3 += "; Domain=" + i3.domain;
          }
          if (i3.path) {
            if (!e10.test(i3.path)) throw TypeError(`option path is invalid: ${i3.path}`);
            l3 += "; Path=" + i3.path;
          }
          if (i3.expires) {
            var m3;
            if (m3 = i3.expires, "[object Date]" !== g10.call(m3) || !Number.isFinite(i3.expires.valueOf())) throw TypeError(`option expires is invalid: ${i3.expires}`);
            l3 += "; Expires=" + i3.expires.toUTCString();
          }
          if (i3.httpOnly && (l3 += "; HttpOnly"), i3.secure && (l3 += "; Secure"), i3.partitioned && (l3 += "; Partitioned"), i3.priority) switch ("string" == typeof i3.priority ? i3.priority.toLowerCase() : void 0) {
            case "low":
              l3 += "; Priority=Low";
              break;
            case "medium":
            ...
            case "high":
              ...
              break;
            default:
              throw TypeError(`option priority is invalid: ${i3.priority}`);
          }
          if (i3.sameSite) switch ("string" == typeof i3.sameSite ? i3.sameSite.toLowerCase() : i3.sameSite) {
            case true:
            case "strict":
              l3 += "; SameSite=Strict";
              break;
            ...
            case "none":
              ...
              break;
            default:
              throw TypeError(`option sameSite is invalid: ${i3.sameSite}`);
          }
          return l3;
        }
        function k2(a11, b11, c11) {
          let d11 = a11.indexOf(";", b11);
          return -1 === d11 ? c11 : d11;
        }
        function l2(a11, b11, c11) {
          let d11 = a11.indexOf("=", b11);
          return d11 < c11 ? d11 : -1;
        }
        function m2(a11, b11, c11) {
          let d11 = b11, e11 = c11;
          do {
            let b12 = a11.charCodeAt(d11);
            if (32 !== b12 && 9 !== b12) break;
          } while (++d11 < e11);
          for (; e11 > d11; ) {
            let b12 = a11.charCodeAt(e11 - 1);
            if (32 !== b12 && 9 !== b12) break;
            e11--;
          }
          return a11.slice(d11, e11);
        }
        function n2(a11) {
      ...
      } }), ch = "https://api.clerk.com", ci = "@clerk/backend@3.4.13", cj = "2025-11-10", ck = { Session: "__session", Refresh: "__refresh", ClientUat: "__client_uat", Handshake: "__clerk_handshake", DevBrowser: "__clerk_db_jwt", RedirectCount: "__clerk_redirect_count", HandshakeNonce: "__clerk_handshake_nonce" }, cl = { ClerkSynced: "__clerk_synced", SuffixedCookies: "suffixed_cookies", ClerkRedirectUrl: "__clerk_redirect_url", DevBrowser: ck.DevBrowser, Handshake: ck.Handshake, HandshakeHelp: "__clerk_help", LegacyDevBrowser: "__dev_session", HandshakeReason: "__clerk_hs_reason", HandshakeNonce: ck.HandshakeNonce, HandshakeFormat: "format", Session: "__session" }, cm = { NeedsSync: "false", Completed: "true" }, cn = { Cookies: ck, Headers: { Accept: "accept", AuthMessage: "x-clerk-auth-message", Authorization: "authorization", AuthReason: "x-clerk-auth-reason", AuthSignature: "x-clerk-auth-signature", AuthStatus: "x-clerk-auth-status", AuthToken: "x-clerk-auth-token", CacheControl: "cache-control", ClerkRedirectTo: "x-clerk-redirect-to", ClerkRequestData: "x-clerk-request-data", ClerkUrl: "x-clerk-clerk-url", CloudFrontForwardedProto: "cloudfront-forwarded-proto", ContentType: "content-type", ContentSecurityPolicy: "content-security-policy", ContentSecurityPolicyReportOnly: "content-security-policy-report-only", EnableDebug: "x-clerk-debug", ForwardedHost: "x-forwarded-host", ForwardedPort: "x-forwarded-port", ForwardedProto: "x-forwarded-proto", Host: "host", Location: "location", Nonce: "x-nonce", Origin: "origin", Referrer: "referer", SecFetchDest: "sec-fetch-dest", SecFetchSite: "sec-fetch-site", UserAgent: "user-agent", ReportingEndpoints: "reporting-endpoints" }, ContentTypes: { Json: "application/json" }, QueryParameters: cl, ClerkSyncStatus: cm }, co = (a10, b10, c10, d10, e10) => {
        if ("" === a10) return cp(b10.toString(), c10?.toString());
        let f10 = new URL(a10), g10 = c10 ? new URL(c10, f10) : void 0, h6 = new URL(b10, f10), i2 = `${f10.hostname}:${f10.port}` != `${h6.hostname}:${h6.port}`;
        return g10 && (i2 && e10 && g10.searchParams.set(cn.QueryParameters.ClerkSynced, cm.NeedsSync), h6.searchParams.set("redirect_url", g10.toString())), i2 && d10 && h6.searchParams.set(cn.QueryParameters.DevBrowser, d10), h6.toString();
      }, cp = (a10, b10) => {
        let c10;
      ...
      var cs = { SessionToken: "session_token", ApiKey: "api_key", M2MToken: "m2m_token", OAuthToken: "oauth_token" }, ct = class {
        constructor(a10, b10, c10) {
          this.cookieSuffix = a10, this.clerkRequest = b10, this.originalFrontendApi = "";
          let d10 = function({ publishableKey: a11, hasDomain: b11 = false, hasProxyUrl: c11 = false, environment: d11 = "undefined" != typeof process && process.env ? process.env : {} }) {
            if (c11 || b11 || !bk(a11) || "production" !== d11.VERCEL_TARGET_ENV) return "";
            let e10 = d11.VERCEL_PROJECT_PRODUCTION_URL;
            return e10 && b6(function(a12) {
              if (a12.startsWith("http://") || a12.startsWith("https://")) try {
                return new URL(a12).hostname;
              } catch {
                return "";
              }
              return a12.split("/")[0] || "";
            }(e10)) ? "/__clerk" : "";
          }({ publishableKey: c10.publishableKey ?? "", hasProxyUrl: !!c10.proxyUrl, hasDomain: !!c10.domain });
          d10 && (c10 = { ...c10, proxyUrl: `${b10.clerkUrl.origin}${d10}` }), c10.acceptsToken === cs.M2MToken || c10.acceptsToken === cs.ApiKey ? this.initHeaderValues() : (this.initPublishableKeyValues(c10), this.initHeaderValues(), this.initCookieValues(), this.initHandshakeValues()), Object.assign(this, c10), this.clerkUrl = this.clerkRequest.clerkUrl, this.proxyUrl?.startsWith("/") && (this.proxyUrl = `${this.clerkUrl.origin}${this.proxyUrl}`);
        }
        get sessionToken() {
          return this.sessionTokenInCookie || this.tokenInHeader;
        }
        usesSuffixedCookies() {
          let a10 = this.getSuffixedCookie(cn.Cookies.ClientUat), b10 = this.getCookie(cn.Cookies.ClientUat), c10 = this.getSuffixedCookie(cn.Cookies.Session) || "", d10 = this.getCookie(cn.Cookies.Session) || "";
          if (d10 && !this.tokenHasIssuer(d10)) return false;
          if (d10 && !this.tokenBelongsToInstance(d10)) return true;
          if (!a10 && !c10) return false;
          let { data: e10 } = bT(d10), f10 = e10?.payload.iat || 0, { data: g10 } = bT(c10), h6 = g10?.payload.iat || 0;
          if ("0" !== a10 && "0" !== b10 && f10 > h6 || "0" === a10 && "0" !== b10) return false;
        ...
        isKnownClerkReferrer() {
          ...
          try {
            ...
            if (a7.some((a11) => b10.startsWith("accounts.") && b10.endsWith(a11)) || a8.some((a11) => b10.endsWith(a11) && !b10.endsWith(".clerk" + a11))) return true;
            let c10 = b3(this.frontendApi);
            if (c10) {
        ...
        initPublishableKeyValues(a10) {
          ...
          let c10 = bi(this.publishableKey, { fatal: true, domain: a10.domain, isSatellite: a10.isSatellite });
          this.originalFrontendApi = c10.frontendApi;
          let d10 = bi(this.publishableKey, { fatal: true, proxyUrl: b10, domain: a10.domain, isSatellite: a10.isSatellite });
          this.instanceType = d10.instanceType, this.frontendApi = d10.frontendApi;
        }
        initHeaderValues() {
          this.method = this.clerkRequest.method, this.tokenInHeader = this.parseAuthorizationHeader(this.getHeader(cn.Headers.Authorization)), this.origin = this.getHeader(cn.Headers.Origin), this.host = this.getHeader(cn.Headers.Host), this.forwardedHost = this.getHeader(cn.Headers.ForwardedHost), this.forwardedProto = this.getHeader(cn.Headers.CloudFrontForwardedProto) || this.getHeader(cn.Headers.ForwardedProto), this.referrer = this.getHeader(cn.Headers.Referrer), this.userAgent = this.getHeader(cn.Headers.UserAgent), this.secFetchDest = this.getHeader(cn.Headers.SecFetchDest), this.accept = this.getHeader(cn.Headers.Accept);
        }
        initCookieValues() {
          this.sessionTokenInCookie = this.getSuffixedOrUnSuffixedCookie(cn.Cookies.Session), this.refreshTokenInCookie = this.getSuffixedCookie(cn.Cookies.Refresh), this.clientUat = Number.parseInt(this.getSuffixedOrUnSuffixedCookie(cn.Cookies.ClientUat) || "") || 0;
        }
        initHandshakeValues() {
          this.devBrowserToken = this.getQueryParam(cn.QueryParameters.DevBrowser) || this.getSuffixedOrUnSuffixedCookie(cn.Cookies.DevBrowser), this.handshakeToken = this.getQueryParam(cn.QueryParameters.Handshake) || this.getCookie(cn.Cookies.Handshake), this.handshakeRedirectLoopCounter = Number(this.getCookie(cn.Cookies.RedirectCount)) || 0, this.handshakeNonce = this.getQueryParam(cn.QueryParameters.HandshakeNonce) || this.getCookie(cn.Cookies.HandshakeNonce);
        }
        getQueryParam(a10) {
        ...
        tokenHasIssuer(a10) {
          let { data: b10, errors: c10 } = bT(a10);
      ...
      }, cu = async (a10, b10) => new ct(b10.publishableKey ? await bm(b10.publishableKey, bJ.crypto.subtle) : "", a10, b10), cv = RegExp("(?<!:)/{1,}", "g");
      function cw(...a10) {
        let b10 = a10.filter((a11) => a11).join("/").replace(cv, "/");
      ...
      var cx = class {
      ...
      }, cy = "/actor_tokens", cz = class extends cx {
        async create(a10) {
          return this.request({ method: "POST", path: cy, bodyParams: a10 });
        }
        async revoke(a10) {
          return this.requireId(a10), this.request({ method: "POST", path: cw(cy, a10, "revoke") });
        }
      }, cA = "/agents/tasks", cB = class extends cx {
        async create(a10) {
          return this.request({ method: "POST", path: cA, bodyParams: a10, options: { deepSnakecaseBodyParamKeys: true } });
        }
        async revoke(a10) {
          return this.requireId(a10), this.request({ method: "POST", path: cw(cA, a10, "revoke") });
        }
      }, cC = "/accountless_applications", cD = class extends cx {
        async createAccountlessApplication(a10) {
          let b10 = a10?.requestHeaders ? Object.fromEntries(a10.requestHeaders.entries()) : void 0;
          return this.request({ method: "POST", path: cC, headerParams: b10 });
        }
        async completeAccountlessApplicationOnboarding(a10) {
          let b10 = a10?.requestHeaders ? Object.fromEntries(a10.requestHeaders.entries()) : void 0;
          return this.request({ method: "POST", path: cw(cC, "complete"), headerParams: b10 });
        }
      }, cE = "/allowlist_identifiers", cF = class extends cx {
        async getAllowlistIdentifierList(a10 = {}) {
          return this.request({ method: "GET", path: cE, queryParams: { ...a10, paginated: true } });
        }
        ...
        async deleteAllowlistIdentifier(a10) {
          return this.requireId(a10), this.request({ method: "DELETE", path: cw(cE, a10) });
        }
      }, cG = "/api_keys", cH = class extends cx {
        async list(a10) {
          return this.request({ method: "GET", path: cG, queryParams: a10 });
        }
        async create(a10) {
          return this.request({ method: "POST", path: cG, bodyParams: a10 });
        }
        async get(a10) {
          return this.requireId(a10), this.request({ method: "GET", path: cw(cG, a10) });
        }
        async update(a10) {
          let { apiKeyId: b10, ...c10 } = a10;
          return this.requireId(b10), this.request({ method: "PATCH", path: cw(cG, b10), bodyParams: c10 });
        }
        async delete(a10) {
          return this.requireId(a10), this.request({ method: "DELETE", path: cw(cG, a10) });
        }
        async revoke(a10) {
          let { apiKeyId: b10, revocationReason: c10 = null } = a10;
          return this.requireId(b10), this.request({ method: "POST", path: cw(cG, b10, "revoke"), bodyParams: { revocationReason: c10 } });
        }
        async getSecret(a10) {
          return this.requireId(a10), this.request({ method: "GET", path: cw(cG, a10, "secret") });
        }
        async verify(a10) {
          return this.request({ method: "POST", path: cw(cG, "verify"), bodyParams: { secret: a10 } });
        }
      }, cI = class extends cx {
        async changeDomain(a10) {
          return this.request({ method: "POST", path: cw("/beta_features", "change_domain"), bodyParams: a10 });
        }
      }, cJ = "/blocklist_identifiers", cK = class extends cx {
        async getBlocklistIdentifierList(a10 = {}) {
          return this.request({ method: "GET", path: cJ, queryParams: a10 });
        }
        ...
        async deleteBlocklistIdentifier(a10) {
          return this.requireId(a10), this.request({ method: "DELETE", path: cw(cJ, a10) });
        }
      }, cL = "/clients", cM = class extends cx {
        async getClientList(a10 = {}) {
          return this.request({ method: "GET", path: cL, queryParams: { ...a10, paginated: true } });
        }
        async getClient(a10) {
          return this.requireId(a10), this.request({ method: "GET", path: cw(cL, a10) });
        }
        verifyClient(a10) {
          return this.request({ method: "POST", path: cw(cL, "verify"), bodyParams: { token: a10 } });
        }
        async getHandshakePayload(a10) {
          return this.request({ method: "GET", path: cw(cL, "handshake_payload"), queryParams: a10 });
        }
      }, cN = "/domains", cO = class extends cx {
        async list() {
        ...
        async update(a10) {
          ...
          return this.requireId(b10), this.request({ method: "PATCH", path: cw(cN, b10), bodyParams: c10 });
        }
        async delete(a10) {
          return this.deleteDomain(a10);
        }
        async deleteDomain(a10) {
          return this.requireId(a10), this.request({ method: "DELETE", path: cw(cN, a10) });
        }
      }, cP = "/email_addresses", cQ = class extends cx {
        async getEmailAddress(a10) {
          return this.requireId(a10), this.request({ method: "GET", path: cw(cP, a10) });
        }
        async createEmailAddress(a10) {
          return this.request({ method: "POST", path: cP, bodyParams: a10 });
        }
        async updateEmailAddress(a10, b10 = {}) {
          return this.requireId(a10), this.request({ method: "PATCH", path: cw(cP, a10), bodyParams: b10 });
        }
        async deleteEmailAddress(a10) {
          return this.requireId(a10), this.request({ method: "DELETE", path: cw(cP, a10) });
        }
      }, cR = "/enterprise_connections", cS = class extends cx {
        async createEnterpriseConnection(a10) {
          return this.request({ method: "POST", path: cR, bodyParams: a10, options: { deepSnakecaseBodyParamKeys: true } });
        }
        async updateEnterpriseConnection(a10, b10) {
          return this.requireId(a10), this.request({ method: "PATCH", path: cw(cR, a10), bodyParams: b10, options: { deepSnakecaseBodyParamKeys: true } });
        }
        ...
        async getEnterpriseConnection(a10) {
          return this.requireId(a10), this.request({ method: "GET", path: cw(cR, a10) });
        }
        async deleteEnterpriseConnection(a10) {
          return this.requireId(a10), this.request({ method: "DELETE", path: cw(cR, a10) });
        }
      }, cT = class extends cx {
        async verify(a10) {
          return this.request({ method: "POST", path: cw("/oauth_applications/access_tokens", "verify"), bodyParams: { access_token: a10 } });
        }
      }, cU = "/instance", cV = class extends cx {
        async get() {
          return this.request({ method: "GET", path: cU });
        }
        async update(a10) {
          return this.request({ method: "PATCH", path: cU, bodyParams: a10 });
        }
        async updateRestrictions(a10) {
          return this.request({ method: "PATCH", path: cw(cU, "restrictions"), bodyParams: a10 });
        }
        async getOrganizationSettings() {
          return this.request({ method: "GET", path: cw(cU, "organization_settings") });
        }
        async updateOrganizationSettings(a10) {
          return this.request({ method: "PATCH", path: cw(cU, "organization_settings"), bodyParams: a10 });
        }
      }, cW = "/invitations", cX = class extends cx {
        ...
        async createInvitationBulk(a10) {
          return this.request({ method: "POST", path: cw(cW, "bulk"), bodyParams: a10 });
        }
        async revokeInvitation(a10) {
          return this.requireId(a10), this.request({ method: "POST", path: cw(cW, a10, "revoke") });
        }
      }, cY = "/machines", cZ = class extends cx {
        async get(a10) {
          return this.requireId(a10), this.request({ method: "GET", path: cw(cY, a10) });
        }
        async list(a10 = {}) {
          return this.request({ method: "GET", path: cY, queryParams: a10 });
        }
        async create(a10) {
          return this.request({ method: "POST", path: cY, bodyParams: a10 });
        }
        async update(a10) {
          ...
          return this.requireId(b10), this.request({ method: "PATCH", path: cw(cY, b10), bodyParams: c10 });
        }
        async delete(a10) {
          return this.requireId(a10), this.request({ method: "DELETE", path: cw(cY, a10) });
        }
        async getSecretKey(a10) {
          return this.requireId(a10), this.request({ method: "GET", path: cw(cY, a10, "secret_key") });
        }
        async rotateSecretKey(a10) {
          let { machineId: b10, previousTokenTtl: c10 } = a10;
          return this.requireId(b10), this.request({ method: "POST", path: cw(cY, b10, "secret_key", "rotate"), bodyParams: { previousTokenTtl: c10 } });
        }
        async createScope(a10, b10) {
          return this.requireId(a10), this.request({ method: "POST", path: cw(cY, a10, "scopes"), bodyParams: { toMachineId: b10 } });
        }
        async deleteScope(a10, b10) {
          return this.requireId(a10), this.request({ method: "DELETE", path: cw(cY, a10, "scopes", b10) });
        }
      }, c$ = class a10 {
        constructor(a11, b10, c10, d10, e10, f10, g10, h6, i2, j2, k2) {
          this.id = a11, this.clientId = b10, this.type = c10, this.subject = d10, this.scopes = e10, this.revoked = f10, this.revocationReason = g10, this.expired = h6, this.expiration = i2, this.createdAt = j2, this.updatedAt = k2;
        }
        static fromJSON(b10) {
        ...
        constructor(a11, b10, c10, d10, e10, f10, g10, h6, i2, j2, k2) {
          this.id = a11, this.subject = b10, this.scopes = c10, this.claims = d10, this.revoked = e10, this.revocationReason = f10, this.expired = g10, this.expiration = h6, this.createdAt = i2, this.updatedAt = j2, this.token = k2;
        }
        static fromJSON(b10) {
      ...
      function c2(a10, b10, c10 = true) {
        c0[a10] = b10, c1 = c10 ? Date.now() : -1;
      }
      function c3(a10) {
        let { kid: b10, pem: c10 } = a10, d10 = `local-${b10}`, e10 = c0[d10];
        if (e10) return e10;
        if (!c10) throw new bE({ action: bD.SetClerkJWTKey, message: "Missing local JWK.", reason: bC.LocalJWKMissing });
        ...
        return c2(d10, f10, false), f10;
      }
      async function c4(a10) {
        let { secretKey: b10, apiUrl: c10 = ch, apiVersion: d10 = "v1", kid: e10, skipJwksCache: f10 } = a10;
        if (f10 || function() {
          if (-1 === c1) return false;
          let a11 = Date.now() - c1 >= 3e5;
          return a11 && (c0 = {}), a11;
        }() || !c0[e10]) {
          if (!b10) throw new bE({ action: bD.ContactSupport, message: "Failed to load JWKS from Clerk Backend or Frontend API.", reason: bC.RemoteJWKFailedToLoad });
          let { keys: a11 } = await bq(() => c5(c10, b10, d10));
          if (!a11 || !a11.length) throw new bE({ action: bD.ContactSupport, message: "The JWKS endpoint did not contain any signing keys. Contact support@clerk.com.", reason: bC.RemoteJWKFailedToLoad });
          a11.forEach((a12) => c2(a12.kid, a12));
        }
        let g10 = c0[e10];
        if (!g10) {
          let a11 = Object.values(c0).map((a12) => a12.kid).sort().join(", ");
          throw new bE({ action: `Go to your Dashboard and validate your secret and public keys are correct. ${bD.ContactSupport} if the issue persists.`, message: `Unable to find a signing key in JWKS that matches the kid='${e10}' of the provided session token. Please make sure that the __session cookie or the HTTP authorization header contain a Clerk-generated session JWT. The following kid is available: ${a11}`, reason: bC.JWKKidMismatch });
        }
        return g10;
      }
      async function c5(a10, b10, c10) {
        if (!b10) throw new bE({ action: bD.SetClerkSecretKey, message: "Missing Clerk Secret Key or API Key. Go to https://dashboard.clerk.com and get your key for your instance.", reason: bC.RemoteJWKFailedToLoad });
        let d10 = new URL(a10);
        d10.pathname = cw(d10.pathname, c10, "/jwks");
        let e10 = await bJ.fetch(d10.href, { headers: { Authorization: `Bearer ${b10}`, "Clerk-API-Version": cj, "Content-Type": "application/json", "User-Agent": ci } });
        if (!e10.ok) {
          let a11 = await e10.json(), b11 = c6(a11?.errors, bB.InvalidSecretKey);
          if (b11) {
            let a12 = bC.InvalidSecretKey;
            throw new bE({ action: bD.ContactSupport, message: b11.message, reason: a12 });
          }
          throw new bE({ action: bD.ContactSupport, message: `Error loading Clerk JWKS from ${d10.href} with code=${e10.status}`, reason: bC.RemoteJWKFailedToLoad });
        }
        return e10.json();
      }
      var c6 = (a10, b10) => a10 ? a10.find((a11) => a11.code === b10) : null, c7 = "mch_", c8 = "oat_", c9 = ["mt_", c8, "ak_"], da = /^[a-zA-Z0-9\-_]+\.[a-zA-Z0-9\-_]+\.[a-zA-Z0-9\-_]+$/;
      function db(a10) {
        return da.test(a10);
      }
      var dc = ["at+jwt", "application/at+jwt"];
      function dd(a10) {
        if (!db(a10)) return false;
        try {
          let { data: b10, errors: c10 } = bT(a10);
          return !c10 && !!b10 && dc.includes(b10.header.typ);
        } catch {
          return false;
        }
      }
      function de(a10) {
        ...
        try {
          let { data: b10, errors: c10 } = bT(a10);
          return !c10 && !!b10 && "string" == typeof b10.payload.sub && b10.payload.sub.startsWith(c7);
        } catch {
          return false;
        }
      }
      function df(a10) {
        return c9.some((b10) => a10.startsWith(b10));
      }
      function dg(a10) {
        return df(a10) || dd(a10) || de(a10);
      }
      function dh(a10) {
        if (a10.startsWith("mt_") || de(a10)) return cs.M2MToken;
        if (a10.startsWith(c8) || dd(a10)) return cs.OAuthToken;
        if (a10.startsWith("ak_")) return cs.ApiKey;
        throw Error("Unknown machine token type");
      }
      var di = (a10, b10) => !!a10 && ("any" === b10 || (Array.isArray(b10) ? b10 : [b10]).includes(a10)), dj = /* @__PURE__ */ new Set([cs.ApiKey, cs.M2MToken, cs.OAuthToken]);
      async function dk(a10, b10, c10, d10) {
        try {
          let e10;
          if (c10.jwtKey) e10 = c3({ kid: b10, pem: c10.jwtKey });
          else {
            if (!c10.secretKey) return { error: new bG({ action: bD.SetClerkJWTKey, message: "Failed to resolve JWK during verification.", code: bF.TokenVerificationFailed }) };
            e10 = await c4({ ...c10, kid: b10 });
          }
          let { data: f10, errors: g10 } = await bU(a10, { ...c10, key: e10, ...d10 ? { headerType: d10 } : {} });
          if (g10) return { error: new bG({ code: bF.TokenVerificationFailed, message: g10[0].message }) };
          return { payload: f10 };
        } catch (a11) {
          return { error: new bG({ code: bF.TokenVerificationFailed, message: a11.message }) };
        }
      }
      async function dl(a10, b10, c10) {
        let d10 = await dk(a10, b10.header.kid, c10);
        return "error" in d10 ? { data: void 0, tokenType: cs.M2MToken, errors: [d10.error] } : { data: c_.fromJwtPayload(d10.payload, c10.clockSkewInMs), tokenType: cs.M2MToken, errors: void 0 };
      }
      async function dm(a10, b10, c10) {
        let d10 = await dk(a10, b10.header.kid, c10, dc);
        return "error" in d10 ? { data: void 0, tokenType: cs.OAuthToken, errors: [d10.error] } : { data: c$.fromJwtPayload(d10.payload, c10.clockSkewInMs), tokenType: cs.OAuthToken, errors: void 0 };
      }
      var dn = "/m2m_tokens", dp = class extends cx {
        constructor(a10, b10 = {}) {
          super(a10), b1(this, gv), b1(this, gu), ((a11, b11, c10, d10) => (b0(a11, b11, "write to private field"), d10 ? d10.call(a11, c10) : b11.set(a11, c10)))(this, gu, b10);
        }
        async list(a10) {
          let { machineSecretKey: b10, ...c10 } = a10, d10 = b2(this, gv, gw).call(this, { method: "GET", path: dn, queryParams: c10 }, b10);
          return this.request(d10);
        }
        async createToken(a10) {
          let { claims: b10 = null, machineSecretKey: c10, minRemainingTtlSeconds: d10, secondsUntilExpiration: e10 = null, tokenFormat: f10 = "opaque" } = a10 || {}, g10 = b2(this, gv, gw).call(this, { method: "POST", path: dn, bodyParams: { secondsUntilExpiration: e10, claims: b10, minRemainingTtlSeconds: d10, tokenFormat: f10 } }, c10);
          return this.request(g10);
        }
        async revokeToken(a10) {
          let { m2mTokenId: b10, revocationReason: c10 = null, machineSecretKey: d10 } = a10;
          this.requireId(b10);
          let e10 = b2(this, gv, gw).call(this, { method: "POST", path: cw(dn, b10, "revoke"), bodyParams: { revocationReason: c10 } }, d10);
          return this.request(e10);
        }
        async verify(a10) {
          let { token: b10, machineSecretKey: c10 } = a10;
          if (de(b10)) return b2(this, gv, gx).call(this, b10);
          let d10 = b2(this, gv, gw).call(this, { method: "POST", path: cw(dn, "verify"), bodyParams: { token: b10 } }, c10);
          return this.request(d10);
        }
      };
      gu = /* @__PURE__ */ new WeakMap(), gv = /* @__PURE__ */ new WeakSet(), gw = function(a10, b10) {
        return b10 ? { ...a10, headerParams: { ...a10.headerParams, Authorization: `Bearer ${b10}` } } : a10;
      }, gx = async function(a10) {
        let b10, c10, d10;
        try {
          let { data: c11, errors: d11 } = bT(a10);
          if (d11) throw d11[0];
          b10 = c11;
        } catch (a11) {
          throw new bG({ code: bF.TokenInvalid, message: a11.message });
        }
        let e10 = await dl(a10, b10, (b0(this, c10 = gu, "read from private field"), d10 ? d10.call(this) : c10.get(this)));
        if (e10.errors) throw e10.errors[0];
        return e10.data;
      };
      var dq = class extends cx {
        async getJwks() {
          return this.request({ method: "GET", path: "/jwks" });
        }
      }, dr = "/jwt_templates", ds = class extends cx {
        async list(a10 = {}) {
          return this.request({ method: "GET", path: dr, queryParams: { ...a10, paginated: true } });
        }
        async get(a10) {
          return this.requireId(a10), this.request({ method: "GET", path: cw(dr, a10) });
        }
        async create(a10) {
        ...
        async update(a10) {
          ...
          return this.requireId(b10), this.request({ method: "PATCH", path: cw(dr, b10), bodyParams: c10 });
        }
        async delete(a10) {
          return this.requireId(a10), this.request({ method: "DELETE", path: cw(dr, a10) });
        }
      }, dt = "/organizations", du = class extends cx {
        async getOrganizationList(a10) {
          return this.request({ method: "GET", path: dt, queryParams: a10 });
        }
        ...
        async getOrganization(a10) {
          ...
          return this.requireId(c10), this.request({ method: "GET", path: cw(dt, c10), queryParams: { includeMembersCount: b10 } });
        }
        async updateOrganization(a10, b10) {
          return this.requireId(a10), this.request({ method: "PATCH", path: cw(dt, a10), bodyParams: b10 });
        }
        async updateOrganizationLogo(a10, b10) {
          this.requireId(a10);
          let c10 = new bJ.FormData();
          return c10.append("file", b10?.file), b10?.uploaderUserId && c10.append("uploader_user_id", b10?.uploaderUserId), this.request({ method: "PUT", path: cw(dt, a10, "logo"), formData: c10 });
        }
        async deleteOrganizationLogo(a10) {
          return this.requireId(a10), this.request({ method: "DELETE", path: cw(dt, a10, "logo") });
        }
        async updateOrganizationMetadata(a10, b10) {
          return this.requireId(a10), this.request({ method: "PATCH", path: cw(dt, a10, "metadata"), bodyParams: b10 });
        }
        async deleteOrganization(a10) {
          return this.request({ method: "DELETE", path: cw(dt, a10) });
        }
        async getOrganizationMembershipList(a10) {
          let { organizationId: b10, ...c10 } = a10;
          return this.requireId(b10), this.request({ method: "GET", path: cw(dt, b10, "memberships"), queryParams: c10 });
        }
        ...
        async createOrganizationMembership(a10) {
          let { organizationId: b10, ...c10 } = a10;
          return this.requireId(b10), this.request({ method: "POST", path: cw(dt, b10, "memberships"), bodyParams: c10 });
        }
        async updateOrganizationMembership(a10) {
          let { organizationId: b10, userId: c10, ...d10 } = a10;
          return this.requireId(b10), this.request({ method: "PATCH", path: cw(dt, b10, "memberships", c10), bodyParams: d10 });
        }
        async updateOrganizationMembershipMetadata(a10) {
          let { organizationId: b10, userId: c10, ...d10 } = a10;
          return this.request({ method: "PATCH", path: cw(dt, b10, "memberships", c10, "metadata"), bodyParams: d10 });
        }
        async deleteOrganizationMembership(a10) {
          let { organizationId: b10, userId: c10 } = a10;
          return this.requireId(b10), this.request({ method: "DELETE", path: cw(dt, b10, "memberships", c10) });
        }
        async getOrganizationInvitationList(a10) {
          let { organizationId: b10, ...c10 } = a10;
          return this.requireId(b10), this.request({ method: "GET", path: cw(dt, b10, "invitations"), queryParams: c10 });
        }
        async createOrganizationInvitation(a10) {
          let { organizationId: b10, ...c10 } = a10;
          return this.requireId(b10), this.request({ method: "POST", path: cw(dt, b10, "invitations"), bodyParams: c10 });
        }
        async createOrganizationInvitationBulk(a10, b10) {
          return this.requireId(a10), this.request({ method: "POST", path: cw(dt, a10, "invitations", "bulk"), bodyParams: b10 });
        }
        async getOrganizationInvitation(a10) {
          let { organizationId: b10, invitationId: c10 } = a10;
          return this.requireId(b10), this.requireId(c10), this.request({ method: "GET", path: cw(dt, b10, "invitations", c10) });
        }
        async revokeOrganizationInvitation(a10) {
          let { organizationId: b10, invitationId: c10, ...d10 } = a10;
          return this.requireId(b10), this.request({ method: "POST", path: cw(dt, b10, "invitations", c10, "revoke"), bodyParams: d10 });
        }
        async getOrganizationDomainList(a10) {
          let { organizationId: b10, ...c10 } = a10;
          return this.requireId(b10), this.request({ method: "GET", path: cw(dt, b10, "domains"), queryParams: c10 });
        }
        async createOrganizationDomain(a10) {
          let { organizationId: b10, ...c10 } = a10;
          return this.requireId(b10), this.request({ method: "POST", path: cw(dt, b10, "domains"), bodyParams: { ...c10, verified: c10.verified ?? true } });
        }
        async updateOrganizationDomain(a10) {
          let { organizationId: b10, domainId: c10, ...d10 } = a10;
          return this.requireId(b10), this.requireId(c10), this.request({ method: "PATCH", path: cw(dt, b10, "domains", c10), bodyParams: d10 });
        }
        async deleteOrganizationDomain(a10) {
          let { organizationId: b10, domainId: c10 } = a10;
          return this.requireId(b10), this.requireId(c10), this.request({ method: "DELETE", path: cw(dt, b10, "domains", c10) });
        }
      }, dv = "/oauth_applications", dw = class extends cx {
        async list(a10 = {}) {
          return this.request({ method: "GET", path: dv, queryParams: a10 });
        }
        async get(a10) {
          return this.requireId(a10), this.request({ method: "GET", path: cw(dv, a10) });
        }
        async create(a10) {
          return this.request({ method: "POST", path: dv, bodyParams: a10 });
        }
        async update(a10) {
          let { oauthApplicationId: b10, ...c10 } = a10;
          return this.requireId(b10), this.request({ method: "PATCH", path: cw(dv, b10), bodyParams: c10 });
        }
        async delete(a10) {
          return this.requireId(a10), this.request({ method: "DELETE", path: cw(dv, a10) });
        }
        async rotateSecret(a10) {
          return this.requireId(a10), this.request({ method: "POST", path: cw(dv, a10, "rotate_secret") });
        }
      }, dx = "/phone_numbers", dy = class extends cx {
        async getPhoneNumber(a10) {
          return this.requireId(a10), this.request({ method: "GET", path: cw(dx, a10) });
        }
        async createPhoneNumber(a10) {
          return this.request({ method: "POST", path: dx, bodyParams: a10 });
        }
        async updatePhoneNumber(a10, b10 = {}) {
          return this.requireId(a10), this.request({ method: "PATCH", path: cw(dx, a10), bodyParams: b10 });
        }
        async deletePhoneNumber(a10) {
          return this.requireId(a10), this.request({ method: "DELETE", path: cw(dx, a10) });
        }
      }, dz = class extends cx {
        async verify(a10) {
          return this.request({ method: "POST", path: "/proxy_checks", bodyParams: a10 });
        }
      }, dA = "/redirect_urls", dB = class extends cx {
        async getRedirectUrlList() {
          return this.request({ method: "GET", path: dA, queryParams: { paginated: true } });
        }
        async getRedirectUrl(a10) {
          return this.requireId(a10), this.request({ method: "GET", path: cw(dA, a10) });
        }
        async createRedirectUrl(a10) {
          return this.request({ method: "POST", path: dA, bodyParams: a10 });
        }
        async deleteRedirectUrl(a10) {
          return this.requireId(a10), this.request({ method: "DELETE", path: cw(dA, a10) });
        }
      }, dC = "/saml_connections", dD = class extends cx {
        async getSamlConnectionList(a10 = {}) {
          return this.request({ method: "GET", path: dC, queryParams: a10 });
        }
        async createSamlConnection(a10) {
          return this.request({ method: "POST", path: dC, bodyParams: a10, options: { deepSnakecaseBodyParamKeys: true } });
        }
        async getSamlConnection(a10) {
          return this.requireId(a10), this.request({ method: "GET", path: cw(dC, a10) });
        }
        async updateSamlConnection(a10, b10 = {}) {
          return this.requireId(a10), this.request({ method: "PATCH", path: cw(dC, a10), bodyParams: b10, options: { deepSnakecaseBodyParamKeys: true } });
        }
        async deleteSamlConnection(a10) {
          return this.requireId(a10), this.request({ method: "DELETE", path: cw(dC, a10) });
        }
      }, dE = "/sessions", dF = class extends cx {
        async getSessionList(a10 = {}) {
          return this.request({ method: "GET", path: dE, queryParams: { ...a10, paginated: true } });
        }
        async getSession(a10) {
          return this.requireId(a10), this.request({ method: "GET", path: cw(dE, a10) });
        }
        async createSession(a10) {
          return this.request({ method: "POST", path: dE, bodyParams: a10 });
        }
        async revokeSession(a10) {
          return this.requireId(a10), this.request({ method: "POST", path: cw(dE, a10, "revoke") });
        }
        async verifySession(a10, b10) {
          return this.requireId(a10), this.request({ method: "POST", path: cw(dE, a10, "verify"), bodyParams: { token: b10 } });
        }
        async getToken(a10, b10, c10) {
          this.requireId(a10);
          let d10 = { method: "POST", path: b10 ? cw(dE, a10, "tokens", b10) : cw(dE, a10, "tokens") };
        ...
        async refreshSession(a10, b10) {
          ...
          return this.request({ method: "POST", path: cw(dE, a10, "refresh"), bodyParams: d10, queryParams: { suffixed_cookies: c10 } });
        }
      }, dG = "/sign_in_tokens", dH = class extends cx {
        async createSignInToken(a10) {
          return this.request({ method: "POST", path: dG, bodyParams: a10 });
        }
        async revokeSignInToken(a10) {
          return this.requireId(a10), this.request({ method: "POST", path: cw(dG, a10, "revoke") });
        }
      }, dI = "/sign_ups", dJ = class extends cx {
        async get(a10) {
          return this.requireId(a10), this.request({ method: "GET", path: cw(dI, a10) });
        }
        async update(a10) {
          let { signUpAttemptId: b10, ...c10 } = a10;
          return this.request({ method: "PATCH", path: cw(dI, b10), bodyParams: c10 });
        }
      }, dK = class extends cx {
        async createTestingToken() {
          return this.request({ method: "POST", path: "/testing_tokens" });
        }
      }, dL = "/users", dM = class extends cx {
        async getUserList(a10 = {}) {
          let { limit: b10, offset: c10, orderBy: d10, ...e10 } = a10, [f10, g10] = await Promise.all([this.request({ method: "GET", path: dL, queryParams: a10 }), this.getCount(e10)]);
          return { data: f10, totalCount: g10 };
        }
        async getUser(a10) {
          return this.requireId(a10), this.request({ method: "GET", path: cw(dL, a10) });
        }
        async createUser(a10) {
          return this.request({ method: "POST", path: dL, bodyParams: a10 });
        }
        async updateUser(a10, b10 = {}) {
          return this.requireId(a10), this.request({ method: "PATCH", path: cw(dL, a10), bodyParams: b10 });
        }
        async updateUserProfileImage(a10, b10) {
          this.requireId(a10);
          let c10 = new bJ.FormData();
          return c10.append("file", b10?.file), this.request({ method: "POST", path: cw(dL, a10, "profile_image"), formData: c10 });
        }
        async updateUserMetadata(a10, b10) {
          return this.requireId(a10), this.request({ method: "PATCH", path: cw(dL, a10, "metadata"), bodyParams: b10 });
        }
        async deleteUser(a10) {
          return this.requireId(a10), this.request({ method: "DELETE", path: cw(dL, a10) });
        }
        async getCount(a10 = {}) {
          return this.request({ method: "GET", path: cw(dL, "count"), queryParams: a10 });
        }
        async getUserOauthAccessToken(a10, b10) {
          this.requireId(a10);
          let c10 = b10.startsWith("oauth_"), d10 = c10 ? b10 : `oauth_${b10}`;
          return c10 && ((a11, b11, c11) => {
            let d11 = a5(), e10 = c11 ?? a11;
            a6.has(e10) || d11 || (a6.add(e10), console.warn(`Clerk - DEPRECATION WARNING: "${a11}" is deprecated and will be removed in the next major release.
${b11}`));
          })("getUserOauthAccessToken(userId, provider)", "Remove the `oauth_` prefix from the `provider` argument."), this.request({ method: "GET", path: cw(dL, a10, "oauth_access_tokens", d10), queryParams: { paginated: true } });
        }
        async disableUserMFA(a10) {
          return this.requireId(a10), this.request({ method: "DELETE", path: cw(dL, a10, "mfa") });
        }
        async getOrganizationMembershipList(a10) {
          let { userId: b10, limit: c10, offset: d10 } = a10;
          return this.requireId(b10), this.request({ method: "GET", path: cw(dL, b10, "organization_memberships"), queryParams: { limit: c10, offset: d10 } });
        }
        async getOrganizationInvitationList(a10) {
          let { userId: b10, ...c10 } = a10;
          return this.requireId(b10), this.request({ method: "GET", path: cw(dL, b10, "organization_invitations"), queryParams: c10 });
        }
        async verifyPassword(a10) {
          let { userId: b10, password: c10 } = a10;
          return this.requireId(b10), this.request({ method: "POST", path: cw(dL, b10, "verify_password"), bodyParams: { password: c10 } });
        }
        async verifyTOTP(a10) {
          let { userId: b10, code: c10 } = a10;
          return this.requireId(b10), this.request({ method: "POST", path: cw(dL, b10, "verify_totp"), bodyParams: { code: c10 } });
        }
        async banUser(a10) {
          return this.requireId(a10), this.request({ method: "POST", path: cw(dL, a10, "ban") });
        }
        async unbanUser(a10) {
          return this.requireId(a10), this.request({ method: "POST", path: cw(dL, a10, "unban") });
        }
        async lockUser(a10) {
          return this.requireId(a10), this.request({ method: "POST", path: cw(dL, a10, "lock") });
        }
        async unlockUser(a10) {
          return this.requireId(a10), this.request({ method: "POST", path: cw(dL, a10, "unlock") });
        }
        async deleteUserProfileImage(a10) {
          return this.requireId(a10), this.request({ method: "DELETE", path: cw(dL, a10, "profile_image") });
        }
        async deleteUserPasskey(a10) {
          return this.requireId(a10.userId), this.requireId(a10.passkeyIdentificationId), this.request({ method: "DELETE", path: cw(dL, a10.userId, "passkeys", a10.passkeyIdentificationId) });
        }
        async deleteUserWeb3Wallet(a10) {
          return this.requireId(a10.userId), this.requireId(a10.web3WalletIdentificationId), this.request({ method: "DELETE", path: cw(dL, a10.userId, "web3_wallets", a10.web3WalletIdentificationId) });
        }
        async deleteUserExternalAccount(a10) {
          return this.requireId(a10.userId), this.requireId(a10.externalAccountId), this.request({ method: "DELETE", path: cw(dL, a10.userId, "external_accounts", a10.externalAccountId) });
        }
        async deleteUserBackupCodes(a10) {
          return this.requireId(a10), this.request({ method: "DELETE", path: cw(dL, a10, "backup_code") });
        }
        async deleteUserTOTP(a10) {
          return this.requireId(a10), this.request({ method: "DELETE", path: cw(dL, a10, "totp") });
        }
        async setPasswordCompromised(a10, b10 = { revokeAllSessions: false }) {
          return this.requireId(a10), this.request({ method: "POST", path: cw(dL, a10, "password", "set_compromised"), bodyParams: b10 });
        }
        async unsetPasswordCompromised(a10) {
          return this.requireId(a10), this.request({ method: "POST", path: cw(dL, a10, "password", "unset_compromised") });
        }
      }, dN = "/waitlist_entries", dO = class extends cx {
        async list(a10 = {}) {
        ...
        async createBulk(a10) {
          return this.request({ method: "POST", path: cw(dN, "bulk"), bodyParams: a10 });
        }
        async invite(a10, b10 = {}) {
          return this.requireId(a10), this.request({ method: "POST", path: cw(dN, a10, "invite"), bodyParams: b10 });
        }
        async reject(a10) {
          return this.requireId(a10), this.request({ method: "POST", path: cw(dN, a10, "reject") });
        }
        async delete(a10) {
          return this.requireId(a10), this.request({ method: "DELETE", path: cw(dN, a10) });
        }
      }, dP = "/webhooks", dQ = class extends cx {
        async createSvixApp() {
          return this.request({ method: "POST", path: cw(dP, "svix") });
        }
        async generateSvixAuthURL() {
          return this.request({ method: "POST", path: cw(dP, "svix_url") });
        }
        async deleteSvixApp() {
          return this.request({ method: "DELETE", path: cw(dP, "svix") });
        }
      }, dR = "/billing", dS = class extends cx {
        async getPlanList(a10) {
          return this.request({ method: "GET", path: cw(dR, "plans"), queryParams: a10 });
        }
        async cancelSubscriptionItem(a10, b10) {
          return this.requireId(a10), this.request({ method: "DELETE", path: cw(dR, "subscription_items", a10), queryParams: b10 });
        }
        async extendSubscriptionItemFreeTrial(a10, b10) {
          return this.requireId(a10), this.request({ method: "POST", path: cw("/billing", "subscription_items", a10, "extend_free_trial"), bodyParams: b10 });
        }
        async getOrganizationBillingSubscription(a10) {
          return this.requireId(a10), this.request({ method: "GET", path: cw("/organizations", a10, "billing", "subscription") });
        }
        async getUserBillingSubscription(a10) {
          return this.requireId(a10), this.request({ method: "GET", path: cw("/users", a10, "billing", "subscription") });
        }
      }, dT = (a10) => "object" == typeof a10 && null !== a10, dU = (a10) => dT(a10) && !(a10 instanceof RegExp) && !(a10 instanceof Error) && !(a10 instanceof Date) && !(globalThis.Blob && a10 instanceof globalThis.Blob), dV = Symbol("mapObjectSkip"), dW = (a10, b10, c10, d10 = /* @__PURE__ */ new WeakMap()) => {
        if (c10 = { deep: false, target: {}, ...c10 }, d10.has(a10)) return d10.get(a10);
        d10.set(a10, c10.target);
        let { target: e10 } = c10;
        delete c10.target;
        let f10 = (a11) => a11.map((a12) => dU(a12) ? dW(a12, b10, c10, d10) : a12);
        if (Array.isArray(a10)) return f10(a10);
        for (let [g10, h6] of Object.entries(a10)) {
          let i2 = b10(g10, h6, a10);
          if (i2 === dV) continue;
          let [j2, k2, { shouldRecurse: l2 = true } = {}] = i2;
          "__proto__" !== j2 && (c10.deep && l2 && dU(k2) && (k2 = Array.isArray(k2) ? f10(k2) : dW(k2, b10, c10, d10)), e10[j2] = k2);
        }
        return e10;
      };
      function dX(a10, b10, c10) {
        if (!dT(a10)) throw TypeError(`Expected an object, got \`${a10}\` (${typeof a10})`);
        if (Array.isArray(a10)) throw TypeError("Expected an object, got an array");
        return dW(a10, b10, c10);
      }
      var dY = /([\p{Ll}\d])(\p{Lu})/gu, dZ = /(\p{Lu})([\p{Lu}][\p{Ll}])/gu, d$ = /(\d)\p{Ll}|(\p{L})\d/u, d_ = /[^\p{L}\d]+/giu, d0 = "$1\0$2";
      function d1(a10) {
        let b10 = a10.trim();
        b10 = (b10 = b10.replace(dY, d0).replace(dZ, d0)).replace(d_, "\0");
      ...
      function d2(a10) {
        ...
        for (let a11 = 0; a11 < b10.length; a11++) {
          let c10 = b10[a11], d10 = d$.exec(c10);
          if (d10) {
      ...
      function d3(a10, b10) {
        ...
        let [e10, f10, g10] = function(a11, b11 = {}) {
          let c11 = b11.split ?? (b11.separateNumbers ? d2 : d1), d11 = b11.prefixCharacters ?? "", e11 = b11.suffixCharacters ?? "", f11 = 0, g11 = a11.length;
          for (; f11 < a11.length; ) {
      ...
      function d6(a10, b10, c10) {
        return c10.shouldRecurse ? { shouldRecurse: c10.shouldRecurse(a10, b10) } : void 0;
      }
      var d7 = function(a10, b10) {
        if (Array.isArray(a10)) {
          if (a10.some((a11) => a11.constructor !== d4)) throw Error("obj must be array of plain objects");
          let c11 = (b10 = { deep: true, exclude: [], parsingOptions: {}, ...b10 }).snakeCase || ((a11) => d3(a11, b10.parsingOptions));
          return a10.map((a11) => dX(a11, (a12, d10) => [d5(b10.exclude, a12) ? a12 : c11(a12), d10, d6(a12, d10, b10)], b10));
        }
        if (a10.constructor !== d4) throw Error("obj must be an plain object");
        let c10 = (b10 = { deep: true, exclude: [], parsingOptions: {}, ...b10 }).snakeCase || ((a11) => d3(a11, b10.parsingOptions));
        return dX(a10, (a11, d10) => [d5(b10.exclude, a11) ? a11 : c10(a11), d10, d6(a11, d10, b10)], b10);
      }, d8 = class a10 {
        ...
        constructor(a11, b10, c10, d10) {
          this.agentId = a11, this.taskId = b10, this.agentTaskId = c10, this.url = d10;
        }
        static fromJSON(b10) {
          let c10 = b10.agent_task_id ?? b10.task_id ?? "";
          return new a10(b10.agent_id, c10, c10, b10.url);
        }
      }, ea = class a10 {
        constructor(a11, b10, c10, d10, e10, f10, g10, h6) {
          this.id = a11, this.status = b10, this.userId = c10, this.actor = d10, this.token = e10, this.url = f10, this.createdAt = g10, this.updatedAt = h6;
        }
        static fromJSON(b10) {
        ...
        constructor(a11, b10, c10, d10, e10, f10, g10, h6, i2, j2, k2, l2, m2, n2, o2, p2) {
          this.id = a11, this.type = b10, this.name = c10, this.subject = d10, this.scopes = e10, this.claims = f10, this.revoked = g10, this.revocationReason = h6, this.expired = i2, this.expiration = j2, this.createdBy = k2, this.description = l2, this.lastUsedAt = m2, this.createdAt = n2, this.updatedAt = o2, this.secret = p2;
        }
        static fromJSON(b10) {
        ...
        constructor(a11, b10, c10, d10, e10, f10, g10, h6) {
          this.id = a11, this.isMobile = b10, this.ipAddress = c10, this.city = d10, this.country = e10, this.browserVersion = f10, this.browserName = g10, this.deviceType = h6;
        }
        static fromJSON(b10) {
        ...
        constructor(a11, b10, c10, d10, e10, f10, g10, h6, i2, j2, k2, l2 = null) {
          this.id = a11, this.clientId = b10, this.userId = c10, this.status = d10, this.lastActiveAt = e10, this.expireAt = f10, this.abandonAt = g10, this.createdAt = h6, this.updatedAt = i2, this.lastActiveOrganizationId = j2, this.latestActivity = k2, this.actor = l2;
        }
        static fromJSON(b10) {
          return new a10(b10.id, b10.client_id, b10.user_id, b10.status, b10.last_active_at, b10.expire_at, b10.abandon_at, b10.created_at, b10.updated_at, b10.last_active_organization_id, b10.latest_activity && ee.fromJSON(b10.latest_activity), b10.actor);
        }
      }, eg = class a10 {
        constructor(a11, b10, c10, d10, e10, f10, g10, h6, i2) {
          this.id = a11, this.sessionIds = b10, this.sessions = c10, this.signInId = d10, this.signUpId = e10, this.lastActiveSessionId = f10, this.lastAuthenticationStrategy = g10, this.createdAt = h6, this.updatedAt = i2;
        }
        static fromJSON(b10) {
          return new a10(b10.id, b10.session_ids, b10.sessions.map((a11) => ef.fromJSON(a11)), b10.sign_in_id, b10.sign_up_id, b10.last_active_session_id, b10.last_authentication_strategy, b10.created_at, b10.updated_at);
        }
      }, eh = class a10 {
        ...
        constructor(a11, b10, c10, d10, e10, f10, g10, h6) {
          this.id = a11, this.name = b10, this.isSatellite = c10, this.frontendApiUrl = d10, this.developmentOrigin = e10, this.cnameTargets = f10, this.accountsPortalUrl = g10, this.proxyUrl = h6;
        }
        static fromJSON(b10) {
          return new a10(b10.id, b10.name, b10.is_satellite, b10.frontend_api_url, b10.development_origin, b10.cname_targets && b10.cname_targets.map((a11) => eh.fromJSON(a11)), b10.accounts_portal_url, b10.proxy_url);
        }
      }, el = class a10 {
        constructor(a11, b10, c10, d10, e10, f10, g10, h6, i2, j2, k2) {
          this.id = a11, this.fromEmailName = b10, this.emailAddressId = c10, this.toEmailAddress = d10, this.subject = e10, this.body = f10, this.bodyPlain = g10, this.status = h6, this.slug = i2, this.data = j2, this.deliveredByClerk = k2;
        }
        static fromJSON(b10) {
        ...
        static fromJSON(b10) {
          return new a10(b10.id, b10.email_address, b10.verification && en.fromJSON(b10.verification), b10.linked_to.map((a11) => em.fromJSON(a11)));
        }
      }, ep = class a10 {
        ...
        constructor(a11, b10, c10, d10, e10, f10, g10, h6, i2, j2, k2, l2, m2, n2, o2, p2) {
          this.id = a11, this.name = b10, this.slug = c10, this.description = d10, this.isDefault = e10, this.isRecurring = f10, this.hasBaseFee = g10, this.publiclyVisible = h6, this.fee = i2, this.annualFee = j2, this.annualMonthlyFee = k2, this.forPayerType = l2, this.features = m2, this.avatarUrl = n2, this.freeTrialDays = o2, this.freeTrialEnabled = p2;
        }
        static fromJSON(b10) {
          ...
          return new a10(b10.id, b10.name, b10.slug, b10.description ?? null, b10.is_default, b10.is_recurring, b10.has_base_fee, b10.publicly_visible, c10(b10.fee), c10(b10.annual_fee), c10(b10.annual_monthly_fee), b10.for_payer_type, (b10.features ?? []).map((a11) => ep.fromJSON(a11)), b10.avatar_url, b10.free_trial_days, b10.free_trial_enabled);
        }
      }, er = class a10 {
        constructor(a11, b10, c10, d10, e10, f10, g10, h6, i2, j2, k2, l2, m2, n2, o2, p2, q2) {
          this.id = a11, this.status = b10, this.planPeriod = c10, this.periodStart = d10, this.nextPayment = e10, this.amount = f10, this.plan = g10, this.planId = h6, this.createdAt = i2, this.updatedAt = j2, this.periodEnd = k2, this.canceledAt = l2, this.pastDueAt = m2, this.endedAt = n2, this.payerId = o2, this.isFreeTrial = p2, this.lifetimePaid = q2;
        }
        static fromJSON(b10) {
          function c10(a11) {
        ...
        constructor(a11, b10, c10, d10, e10, f10, g10, h6, i2, j2) {
          this.id = a11, this.status = b10, this.payerId = c10, this.createdAt = d10, this.updatedAt = e10, this.activeAt = f10, this.pastDueAt = g10, this.subscriptionItems = h6, this.nextPayment = i2, this.eligibleForFreeTrial = j2;
        }
        static fromJSON(b10) {
        ...
        constructor(a11, b10, c10, d10, e10, f10, g10, h6, i2, j2, k2, l2, m2) {
          this.id = a11, this.active = b10, this.allowIdpInitiated = c10, this.allowSubdomains = d10, this.disableAdditionalIdentifications = e10, this.domain = f10, this.logoPublicUrl = g10, this.name = h6, this.protocol = i2, this.provider = j2, this.syncUserAttributes = k2, this.createdAt = l2, this.updatedAt = m2;
        }
        static fromJSON(b10) {
        ...
        constructor(a11, b10, c10, d10, e10, f10, g10, h6, i2, j2, k2, l2, m2) {
          this.id = a11, this.active = b10, this.emailAddress = c10, this.enterpriseConnection = d10, this.firstName = e10, this.lastName = f10, this.protocol = g10, this.provider = h6, this.providerUserId = i2, this.publicMetadata = j2, this.verification = k2, this.lastAuthenticatedAt = l2, this.enterpriseConnectionId = m2;
        }
        static fromJSON(b10) {
          return new a10(b10.id, b10.active, b10.email_address, b10.enterprise_connection && et.fromJSON(b10.enterprise_connection), b10.first_name, b10.last_name, b10.protocol, b10.provider, b10.provider_user_id, b10.public_metadata, b10.verification && en.fromJSON(b10.verification), b10.last_authenticated_at, b10.enterprise_connection_id);
        }
      }, ev = class a10 {
        constructor(a11, b10, c10, d10, e10, f10, g10, h6, i2, j2, k2, l2, m2) {
          this.id = a11, this.name = b10, this.idpEntityId = c10, this.idpSsoUrl = d10, this.idpCertificate = e10, this.idpMetadataUrl = f10, this.idpMetadata = g10, this.acsUrl = h6, this.spEntityId = i2, this.spMetadataUrl = j2, this.syncUserAttributes = k2, this.allowSubdomains = l2, this.allowIdpInitiated = m2;
        }
        static fromJSON(b10) {
        ...
        constructor(a11, b10, c10, d10, e10, f10, g10, h6, i2, j2, k2, l2) {
          this.id = a11, this.name = b10, this.domains = c10, this.organizationId = d10, this.active = e10, this.syncUserAttributes = f10, this.allowSubdomains = g10, this.disableAdditionalIdentifications = h6, this.createdAt = i2, this.updatedAt = j2, this.samlConnection = k2, this.oauthConfig = l2;
        }
        static fromJSON(b10) {
          return new a10(b10.id, b10.name, b10.domains, b10.organization_id, b10.active, b10.sync_user_attributes, b10.allow_subdomains, b10.disable_additional_identifications, b10.created_at, b10.updated_at, null != b10.saml_connection ? ev.fromJSON(b10.saml_connection) : null, null != b10.oauth_config ? ew.fromJSON(b10.oauth_config) : null);
        }
      }, ey = class a10 {
        constructor(a11, b10, c10, d10, e10, f10, g10, h6, i2, j2, k2, l2, m2 = {}, n2, o2) {
          this.id = a11, this.provider = b10, this.providerUserId = c10, this.identificationId = d10, this.externalId = e10, this.approvedScopes = f10, this.emailAddress = g10, this.firstName = h6, this.lastName = i2, this.imageUrl = j2, this.username = k2, this.phoneNumber = l2, this.publicMetadata = m2, this.label = n2, this.verification = o2;
        }
        static fromJSON(b10) {
          return new a10(b10.id, b10.provider, b10.provider_user_id, b10.identification_id, b10.provider_user_id, b10.approved_scopes, b10.email_address, b10.first_name, b10.last_name, b10.image_url || "", b10.username, b10.phone_number, b10.public_metadata, b10.label, b10.verification && en.fromJSON(b10.verification));
        }
      }, ez = class a10 {
        constructor(a11, b10, c10) {
        ...
        constructor(a11, b10, c10, d10, e10, f10, g10, h6) {
          this.id = a11, this.emailAddress = b10, this.publicMetadata = c10, this.createdAt = d10, this.updatedAt = e10, this.status = f10, this.url = g10, this.revoked = h6, this._raw = null;
        }
        get raw() {
          return this._raw;
        }
        ...
        constructor(a11, b10, c10, d10, e10, f10, g10, h6) {
          this.id = a11, this.name = b10, this.instanceId = c10, this.createdAt = d10, this.updatedAt = e10, this.scopedMachines = f10, this.defaultTokenTtl = g10, this.secretKey = h6;
        }
        static fromJSON(b10) {
        ...
        constructor(a11, b10, c10, d10 = {}, e10, f10, g10, h6, i2) {
          this.externalAccountId = a11, this.provider = b10, this.token = c10, this.publicMetadata = d10, this.label = e10, this.scopes = f10, this.tokenSecret = g10, this.expiresAt = h6, this.idToken = i2;
        }
        static fromJSON(b10) {
        ...
        constructor(a11, b10, c10, d10, e10, f10, g10, h6 = {}, i2 = {}, j2, k2, l2, m2) {
          this.id = a11, this.name = b10, this.slug = c10, this.imageUrl = d10, this.hasImage = e10, this.createdAt = f10, this.updatedAt = g10, this.publicMetadata = h6, this.privateMetadata = i2, this.maxAllowedMemberships = j2, this.adminDeleteEnabled = k2, this.membersCount = l2, this.createdBy = m2, this._raw = null;
        }
        get raw() {
          return this._raw;
        }
        ...
        constructor(a11, b10, c10, d10, e10, f10, g10, h6, i2, j2, k2 = {}, l2 = {}, m2) {
          this.id = a11, this.emailAddress = b10, this.role = c10, this.roleName = d10, this.organizationId = e10, this.createdAt = f10, this.updatedAt = g10, this.expiresAt = h6, this.url = i2, this.status = j2, this.publicMetadata = k2, this.privateMetadata = l2, this.publicOrganizationData = m2, this._raw = null;
        }
        get raw() {
          return this._raw;
        }
        ...
        constructor(a11, b10, c10, d10 = {}, e10 = {}, f10, g10, h6, i2) {
          this.id = a11, this.role = b10, this.permissions = c10, this.publicMetadata = d10, this.privateMetadata = e10, this.createdAt = f10, this.updatedAt = g10, this.organization = h6, this.publicUserData = i2, this._raw = null;
        }
        get raw() {
          return this._raw;
        }
        static fromJSON(b10) {
          let c10 = new a10(b10.id, b10.role, b10.permissions, b10.public_metadata, b10.private_metadata, b10.created_at, b10.updated_at, eK.fromJSON(b10.organization), eN.fromJSON(b10.public_user_data));
          return c10._raw = b10, c10;
        }
      }, eN = class a10 {
        constructor(a11, b10, c10, d10, e10, f10) {
        ...
        constructor(a11, b10, c10, d10, e10, f10, g10, h6, i2, j2) {
          this.enabled = a11, this.maxAllowedMemberships = b10, this.maxAllowedRoles = c10, this.maxAllowedPermissions = d10, this.creatorRole = e10, this.adminDeleteEnabled = f10, this.domainsEnabled = g10, this.slugDisabled = h6, this.domainsEnrollmentModes = i2, this.domainsDefaultRole = j2;
        }
        static fromJSON(b10) {
        ...
        static fromJSON(b10) {
          return new a10(b10.id, b10.phone_number, b10.reserved_for_second_factor, b10.default_second_factor, b10.verification && en.fromJSON(b10.verification), b10.linked_to.map((a11) => em.fromJSON(a11)));
        }
      }, eQ = class a10 {
        constructor(a11, b10, c10, d10, e10, f10, g10) {
        ...
        constructor(a11, b10, c10, d10, e10, f10, g10, h6, i2, j2, k2, l2, m2, n2, o2, p2, q2, r2, s2, t2, u2) {
          this.id = a11, this.name = b10, this.domain = c10, this.organizationId = d10, this.idpEntityId = e10, this.idpSsoUrl = f10, this.idpCertificate = g10, this.idpMetadataUrl = h6, this.idpMetadata = i2, this.acsUrl = j2, this.spEntityId = k2, this.spMetadataUrl = l2, this.active = m2, this.provider = n2, this.userCount = o2, this.syncUserAttributes = p2, this.allowSubdomains = q2, this.allowIdpInitiated = r2, this.createdAt = s2, this.updatedAt = t2, this.attributeMapping = u2;
        }
        static fromJSON(b10) {
          return new a10(b10.id, b10.name, b10.domain, b10.organization_id, b10.idp_entity_id, b10.idp_sso_url, b10.idp_certificate, b10.idp_metadata_url, b10.idp_metadata, b10.acs_url, b10.sp_entity_id, b10.sp_metadata_url, b10.active, b10.provider, b10.user_count, b10.sync_user_attributes, b10.allow_subdomains, b10.allow_idp_initiated, b10.created_at, b10.updated_at, b10.attribute_mapping && eT.fromJSON(b10.attribute_mapping));
        }
      }, eT = class a10 {
        constructor(a11, b10, c10, d10) {
        ...
        static fromJSON(b10) {
          return new a10(b10.email_address && eV.fromJSON(b10.email_address), b10.phone_number && eV.fromJSON(b10.phone_number), b10.web3_wallet && eV.fromJSON(b10.web3_wallet), b10.external_account);
        }
      }, eX = class a10 {
        constructor(a11, b10, c10, d10, e10, f10, g10, h6, i2, j2, k2, l2, m2, n2, o2, p2, q2, r2, s2, t2, u2, v2) {
          this.id = a11, this.status = b10, this.requiredFields = c10, this.optionalFields = d10, this.missingFields = e10, this.unverifiedFields = f10, this.verifications = g10, this.username = h6, this.emailAddress = i2, this.phoneNumber = j2, this.web3Wallet = k2, this.passwordEnabled = l2, this.firstName = m2, this.lastName = n2, this.customAction = o2, this.externalId = p2, this.createdSessionId = q2, this.createdUserId = r2, this.abandonAt = s2, this.legalAcceptedAt = t2, this.publicMetadata = u2, this.unsafeMetadata = v2;
        }
        static fromJSON(b10) {
          return new a10(b10.id, b10.status, b10.required_fields, b10.optional_fields, b10.missing_fields, b10.unverified_fields, b10.verifications ? eW.fromJSON(b10.verifications) : null, b10.username, b10.email_address, b10.phone_number, b10.web3_wallet, b10.password_enabled, b10.first_name, b10.last_name, b10.custom_action, b10.external_id, b10.created_session_id, b10.created_user_id, b10.abandon_at, b10.legal_accepted_at, b10.public_metadata, b10.unsafe_metadata);
        }
      }, eY = class a10 {
        constructor(a11, b10, c10, d10, e10, f10, g10) {
        ...
        static fromJSON(b10) {
          return new a10(b10.id, b10.email_address, b10.status, b10.invitation && eC.fromJSON(b10.invitation), b10.created_at, b10.updated_at, b10.is_locked);
        }
      };
      function e1(a10) {
        if ("string" != typeof a10 && "object" in a10 && "deleted" in a10) return ej.fromJSON(a10);
        switch (a10.object) {
          case eD.AccountlessApplication:
            return d8.fromJSON(a10);
          case eD.ActorToken:
            return ea.fromJSON(a10);
          case eD.AllowlistIdentifier:
            return eb.fromJSON(a10);
          case eD.ApiKey:
            return ec.fromJSON(a10);
          case eD.BlocklistIdentifier:
          ...
          case eD.EmailAddress:
            return eo.fromJSON(a10);
          case eD.EnterpriseAccount:
            return eu.fromJSON(a10);
          case eD.Email:
            return el.fromJSON(a10);
          case eD.IdpOAuthAccessToken:
            return c$.fromJSON(a10);
          case eD.Instance:
            return ez.fromJSON(a10);
          case eD.InstanceRestrictions:
            return eA.fromJSON(a10);
          case eD.InstanceSettings:
            return eB.fromJSON(a10);
          case eD.Invitation:
            return eC.fromJSON(a10);
          case eD.JwtTemplate:
          ...
          case eD.MachineScope:
            return eG.fromJSON(a10);
          case eD.MachineSecretKey:
            return eH.fromJSON(a10);
          case eD.M2MToken:
            return c_.fromJSON(a10);
          case eD.OauthAccessToken:
            return eI.fromJSON(a10);
          case eD.OAuthApplication:
            return eJ.fromJSON(a10);
          case eD.Organization:
            return eK.fromJSON(a10);
          case eD.OrganizationInvitation:
            return eL.fromJSON(a10);
          case eD.OrganizationMembership:
            return eM.fromJSON(a10);
          case eD.OrganizationSettings:
            return eO.fromJSON(a10);
          case eD.PhoneNumber:
          ...
          case eD.EnterpriseConnection:
            return ex.fromJSON(a10);
          case eD.SamlConnection:
            return eS.fromJSON(a10);
          case eD.SignInToken:
            return eU.fromJSON(a10);
          case eD.AgentTask:
            return d9.fromJSON(a10);
          case eD.SignUpAttempt:
            return eX.fromJSON(a10);
          case eD.Session:
            return ef.fromJSON(a10);
          case eD.SmsMessage:
          ...
          case eD.User:
            return e_.fromJSON(a10);
          case eD.WaitlistEntry:
            return e0.fromJSON(a10);
          case eD.BillingPlan:
            return eq.fromJSON(a10);
          case eD.BillingSubscription:
            return es.fromJSON(a10);
          case eD.BillingSubscriptionItem:
            return er.fromJSON(a10);
          case eD.Feature:
            return ep.fromJSON(a10);
          default:
      ...
      function e2(a10) {
        ...
        return b10 = async (b11) => {
          let c10, { secretKey: d10, machineSecretKey: e10, useMachineSecretKey: f10 = false, requireSecretKey: g10 = true, apiUrl: h6 = ch, apiVersion: i2 = "v1", userAgent: j2 = ci, skipApiVersionInUrl: k2 = false } = a10, { path: l2, method: m2, queryParams: n2, headerParams: o2, bodyParams: p2, formData: q2, options: r2 } = b11, { deepSnakecaseBodyParamKeys: s2 = false } = r2 || {};
          g10 && cr(d10);
          let t2 = new URL(k2 ? cw(h6, l2) : cw(h6, i2, l2));
          if (n2) for (let [a11, b12] of Object.entries(d7({ ...n2 }))) b12 && [b12].flat().forEach((b13) => t2.searchParams.append(a11, b13));
          let u2 = new Headers({ "Clerk-API-Version": cj, [cn.Headers.UserAgent]: j2, ...o2 }), v2 = cn.Headers.Authorization;
          !u2.has(v2) && (f10 && e10 ? u2.set(v2, `Bearer ${e10}`) : d10 && u2.set(v2, `Bearer ${d10}`));
          try {
            q2 ? c10 = await bJ.fetch(t2.href, { method: m2, headers: u2, body: q2 }) : (u2.set("Content-Type", "application/json"), c10 = await bJ.fetch(t2.href, { method: m2, headers: u2, ...(() => {
              if (!("GET" !== m2 && p2 && Object.keys(p2).length > 0)) return null;
              let a12 = (a13) => d7(a13, { deep: s2 });
              return { body: JSON.stringify(Array.isArray(p2) ? p2.map(a12) : a12(p2)) };
            })() }));
            let a11 = c10?.headers && c10.headers?.get(cn.Headers.ContentType) === cn.ContentTypes.Json, b12 = await (a11 ? c10.json() : c10.text());
            if (!c10.ok) return { data: null, errors: e5(b12), status: c10?.status, statusText: c10?.statusText, clerkTraceId: e3(b12, c10?.headers), retryAfter: e4(c10?.headers) };
            return { ...function(a12) {
              var b13, c11;
              let d11;
              if (Array.isArray(a12)) return { data: a12.map((a13) => e1(a13)) };
              if ((b13 = a12) && "object" == typeof b13 && "m2m_tokens" in b13 && Array.isArray(b13.m2m_tokens)) return { data: d11 = a12.m2m_tokens.map((a13) => e1(a13)), totalCount: a12.total_count };
              return (c11 = a12) && "object" == typeof c11 && "data" in c11 && Array.isArray(c11.data) && void 0 !== c11.data ? { data: d11 = a12.data.map((a13) => e1(a13)), totalCount: a12.total_count } : { data: e1(a12) };
            }(b12), errors: null };
          } catch (a11) {
            if (a11 instanceof Error) return { data: null, errors: [{ code: "unexpected_error", message: a11.message || "Unexpected error" }], clerkTraceId: e3(a11, c10?.headers) };
            return { data: null, errors: e5(a11), status: c10?.status, statusText: c10?.statusText, clerkTraceId: e3(a11, c10?.headers), retryAfter: e4(c10?.headers) };
          }
        }, async (...a11) => {
          let { data: c10, errors: d10, totalCount: e10, status: f10, statusText: g10, clerkTraceId: h6, retryAfter: i2 } = await b10(...a11);
          if (d10) {
            let a12 = new bv(g10 || "", { data: [], status: f10, clerkTraceId: h6, retryAfter: i2 });
      ...
      function e5(a10) {
        if (a10 && "object" == typeof a10 && "errors" in a10) {
          let b10 = a10.errors;
          return b10.length > 0 ? b10.map(bu) : [];
        }
        return [];
      }
      function e6(a10) {
        let b10 = e2(a10);
        return { __experimental_accountlessApplications: new cD(e2({ ...a10, requireSecretKey: false })), actorTokens: new cz(b10), agentTasks: new cB(b10), allowlistIdentifiers: new cF(b10), apiKeys: new cH(e2({ ...a10, skipApiVersionInUrl: true })), betaFeatures: new cI(b10), blocklistIdentifiers: new cK(b10), billing: new dS(b10), clients: new cM(b10), domains: new cO(b10), emailAddresses: new cQ(b10), enterpriseConnections: new cS(b10), idPOAuthAccessToken: new cT(e2({ ...a10, skipApiVersionInUrl: true })), instance: new cV(b10), invitations: new cX(b10), jwks: new dq(b10), jwtTemplates: new ds(b10), machines: new cZ(b10), m2m: new dp(e2({ ...a10, skipApiVersionInUrl: true, requireSecretKey: false, useMachineSecretKey: true }), { secretKey: a10.secretKey, apiUrl: a10.apiUrl, jwtKey: a10.jwtKey }), oauthApplications: new dw(b10), organizations: new du(b10), phoneNumbers: new dy(b10), proxyChecks: new dz(b10), redirectUrls: new dB(b10), sessions: new dF(b10), signInTokens: new dH(b10), signUps: new dJ(b10), testingTokens: new dK(b10), users: new dM(b10), waitlistEntries: new dO(b10), webhooks: new dQ(b10), samlConnections: new dD(b10) };
      }
      var e7 = (a10) => () => {
        let b10 = { ...a10 };
      ...
      function e8(a10, b10) {
        return { tokenType: cs.SessionToken, sessionClaims: null, sessionId: null, sessionStatus: b10 ?? null, userId: null, actor: null, orgId: null, orgRole: null, orgSlug: null, orgPermissions: null, factorVerificationAge: null, getToken: () => Promise.resolve(null), has: () => false, debug: e7(a10), isAuthenticated: false };
      }
      function e9(a10, b10) {
        let c10 = { id: null, subject: null, scopes: null, has: () => false, getToken: () => Promise.resolve(null), debug: e7(b10), isAuthenticated: false };
        switch (a10) {
          case cs.ApiKey:
        ...
        return { status: fc.SignedIn, reason: null, message: null, proxyUrl: b10.proxyUrl || "", publishableKey: b10.publishableKey || "", isSatellite: b10.isSatellite || false, domain: b10.domain || "", signInUrl: b10.signInUrl || "", signUpUrl: b10.signUpUrl || "", afterSignInUrl: b10.afterSignInUrl || "", afterSignUpUrl: b10.afterSignUpUrl || "", isSignedIn: true, isAuthenticated: true, tokenType: a10.tokenType, toAuth: ({ treatPendingAsSignedOut: c11 = true } = {}) => {
          if (a10.tokenType === cs.SessionToken) {
            let { sessionClaims: e11 } = a10, f11 = function(a11, b11, c12) {
                ...
                if (2 === a12.v) {
                  if (a12.o) {
                    ...
                    e13 = function({ features: a13, permissions: b13, featurePermissionMap: c14 }) {
                      ...
                      return d13;
                    }({ features: f14, featurePermissionMap: h7, permissions: g13 });
                  }
              ...
              return { tokenType: cs.SessionToken, actor: e12, sessionClaims: c12, sessionId: f12, sessionStatus: g11, userId: h6, orgId: i2, orgRole: j2, orgSlug: k2, orgPermissions: l2, factorVerificationAge: m2, getToken: o2, has: (d11 = { orgId: i2, orgRole: j2, orgPermissions: l2, userId: h6, factorVerificationAge: m2, features: c12.fea || "", plans: c12.pla || "" }, (a12) => {
                let b12;
                return !!d11.userId && (b12 = [((a13, b13) => {
                  ...
                  return f13 || g12 ? f13 && "string" != typeof a13.role || g12 && "string" != typeof a13.permission || !c13 || f13 && ("string" != typeof d12 || !d12 || cd(d12) !== cd(a13.role)) || g12 && (!Array.isArray(e13) || !e13.includes(cd(a13.permission))) ? "fail" : "pass" : "skip";
                })(a12, d11), ((a13, b13) => {
                  ...
                  if (e13) {
                    ...
                    try {
                      if (!ce(c13, a13.feature)) return "fail";
                    } catch {
                      return "fail";
                    }
                  }
                  if (f13) {
                    ...
                    try {
                      if (!ce(d12, a13.plan)) return "fail";
                    } catch {
                      return "fail";
                    }
                  }
                  ...
                  if (!b13 || !Array.isArray(b13) || 2 !== b13.length || !cc(b13[0]) || !cc(b13[1])) return "fail";
                  let c13 = ((a14) => {
                    let b14, c14;
                    if (!a14) return false;
                    let d13 = "string" == typeof a14 && b9.has(a14), e14 = "object" == typeof a14 && (b14 = a14.level, b8.has(b14)) && "number" == typeof (c14 = a14.afterMinutes) && c14 > 0;
                    return (!!d13 || !!e14) && ((a15) => "string" == typeof a15 ? b7[a15] : a15).bind(null, a14);
                  })(a13.reverification);
                  if (!c13) return "fail";
                  let { level: d12, afterMinutes: e13 } = c13(), [f13, g12] = b13;
                  if (-1 === f13 && -1 === g12) return "fail";
                  let h7 = -1 !== f13 && e13 > f13, i3 = -1 !== g12 && e13 > g12;
                  switch (d12) {
                    case "first_factor":
                      return h7 ? "pass" : "fail";
                    case "second_factor":
                      if (-1 === g12) return h7 ? "pass" : "fail";
                      return i3 ? "pass" : "fail";
                    case "multi_factor":
                      if (-1 === g12) return h7 ? "pass" : "fail";
                      if (-1 === f13) return "fail";
                      return h7 && i3 ? "pass" : "fail";
                  }
                })(a12, d11)]).some((a13) => "pass" === a13) && b12.every((a13) => "pass" === a13 || "skip" === a13);
              }), debug: e7({ ...a11, sessionToken: b11 }), isAuthenticated: true };
            }(b10, d10, e11);
            return c11 && "pending" === f11.sessionStatus ? e8(void 0, f11.sessionStatus) : f11;
          }
          let { machineData: e10 } = a10;
          var f10 = a10.tokenType;
          let g10 = { id: e10.id, subject: e10.subject, getToken: () => Promise.resolve(d10), has: () => false, debug: e7(b10), isAuthenticated: true };
          switch (f10) {
            case cs.ApiKey:
      ...
      function ff(a10) {
        ...
        return fg({ status: fc.SignedOut, reason: d10, message: e10, proxyUrl: b10.proxyUrl || "", publishableKey: b10.publishableKey || "", isSatellite: b10.isSatellite || false, domain: b10.domain || "", signInUrl: b10.signInUrl || "", signUpUrl: b10.signUpUrl || "", afterSignInUrl: b10.afterSignInUrl || "", afterSignUpUrl: b10.afterSignUpUrl || "", isSignedIn: false, isAuthenticated: false, tokenType: f10, toAuth: () => f10 === cs.SessionToken ? e8({ ...b10, status: fc.SignedOut, reason: d10, message: e10 }) : e9(f10, { reason: d10, message: e10, headers: c10 }), headers: c10, token: null });
      }
      var fg = (a10) => {
        let b10 = new Headers(a10.headers || {});
        if (a10.message) try {
          b10.set(cn.Headers.AuthMessage, a10.message);
        } catch {
        }
        if (a10.reason) try {
          b10.set(cn.Headers.AuthReason, a10.reason);
        } catch {
        }
        if (a10.status) try {
          b10.set(cn.Headers.AuthStatus, a10.status);
        } catch {
        }
        return a10.headers = b10, a10;
      }, fh = ((a10, b10, c10) => (c10 = null != a10 ? bV(bZ(a10)) : {}, ((a11, b11, c11, d10) => {
        if (b11 && "object" == typeof b11 || "function" == typeof b11) for (let e10 of bY(b11)) b$.call(a11, e10) || e10 === c11 || bW(a11, e10, { get: () => b11[e10], enumerable: !(d10 = bX(b11, e10)) || d10.enumerable });
        return a11;
      })(!b10 && a10 && a10.__esModule ? c10 : bW(c10, "default", { value: a10, enumerable: true }), a10)))(cg()), fi = class extends URL {
        isCrossOrigin(a10) {
          return this.origin !== new URL(a10.toString()).origin;
        }
      }, fj = (...a10) => new fi(...a10), fk = class extends Request {
        constructor(a10, b10) {
          let c10, d10 = "string" != typeof a10 && "url" in a10 ? a10.url : String(a10);
          b10 ? c10 = b10 : "string" != typeof a10 && (c10 = new Proxy(a10, { get(a11, b11) {
            if ("signal" !== b11) return Reflect.get(a11, b11, a11);
          } })), super(d10, c10), this.clerkUrl = this.deriveUrlFromHeaders(this), this.cookies = this.parseCookies(this);
        }
        toJSON() {
        ...
        deriveUrlFromHeaders(a10) {
          let b10 = new URL(a10.url), c10 = a10.headers.get(cn.Headers.ForwardedProto), d10 = a10.headers.get(cn.Headers.ForwardedHost), e10 = a10.headers.get(cn.Headers.Host), f10 = b10.protocol, g10 = this.getFirstValueFromHeader(d10) ?? e10, h6 = this.getFirstValueFromHeader(c10) ?? f10?.replace(/[:/]/, ""), i2 = g10 && h6 ? `${h6}://${g10}` : b10.origin;
          if (i2 === b10.origin) return fj(b10);
          try {
            return fj(b10.pathname + b10.search, i2);
          } catch {
            return fj(b10);
          }
        }
        ...
        parseCookies(a10) {
          return new Map(Object.entries((0, fh.parse)(this.decodeCookieValue(a10.headers.get("cookie") || ""))));
        }
        decodeCookieValue(a10) {
          return a10 ? a10.replace(/(%[0-9A-Z]{2})+/g, decodeURIComponent) : a10;
        }
      }, fl = (...a10) => a10[0] && "object" == typeof a10[0] && "clerkUrl" in a10[0] && "cookies" in a10[0] ? a10[0] : new fk(...a10), fm = (a10) => a10.split(";")[0]?.split("=")[0], fn = (a10) => a10.split(";")[0]?.split("=")[1];
      async function fo(a10, b10) {
        let { data: c10, errors: d10 } = bT(a10);
        if (d10) return { errors: d10 };
        let { header: e10 } = c10, { kid: f10 } = e10;
        try {
          let c11;
          if (b10.jwtKey) c11 = c3({ kid: f10, pem: b10.jwtKey });
          else {
            if (!b10.secretKey) return { errors: [new bE({ action: bD.SetClerkJWTKey, message: "Failed to resolve JWK during verification.", reason: bC.JWKFailedToResolve })] };
            c11 = await c4({ ...b10, kid: f10 });
          }
          return await bU(a10, { ...b10, key: c11 });
        } catch (a11) {
          return { errors: [a11] };
        }
      }
      function fp(a10, b10, c10) {
        if (bw(b10)) {
          ...
          switch (b10.status) {
            case 401:
              d10 = bF.InvalidSecretKey, e10 = b10.errors[0]?.message || "Invalid secret key";
              break;
            case 404:
              d10 = bF.TokenInvalid, e10 = c10;
              break;
            default:
              d10 = bF.UnexpectedError, e10 = "Unexpected error";
          }
          return { data: void 0, tokenType: a10, errors: [new bG({ message: e10, code: d10, status: b10.status })] };
        }
        return { data: void 0, tokenType: a10, errors: [new bG({ message: "Unexpected error", code: bF.UnexpectedError, status: b10.status })] };
      }
      async function fq(a10, b10) {
        try {
          let c10 = e6(b10);
          return { data: await c10.m2m.verify({ token: a10 }), tokenType: cs.M2MToken, errors: void 0 };
        } catch (a11) {
          return fp(cs.M2MToken, a11, "Machine token not found");
        }
      }
      async function fr(a10, b10) {
        try {
          let c10 = e6(b10);
          return { data: await c10.idPOAuthAccessToken.verify(a10), tokenType: cs.OAuthToken, errors: void 0 };
        } catch (a11) {
          return fp(cs.OAuthToken, a11, "OAuth token not found");
        }
      }
      async function fs(a10, b10) {
        try {
          let c10 = e6(b10);
          return { data: await c10.apiKeys.verify(a10), tokenType: cs.ApiKey, errors: void 0 };
        } catch (a11) {
          return fp(cs.ApiKey, a11, "API key not found");
        }
      }
      async function ft(a10, b10) {
        if (db(a10)) {
          let c10;
          try {
            let { data: b11, errors: d10 } = bT(a10);
            if (d10) throw d10[0];
            c10 = b11;
          } catch (a11) {
            return { data: void 0, tokenType: cs.M2MToken, errors: [new bG({ code: bF.TokenInvalid, message: a11.message })] };
          }
          return c10.payload.sub.startsWith(c7) ? dl(a10, c10, b10) : dc.includes(c10.header.typ) ? dm(a10, c10, b10) : { data: void 0, tokenType: cs.OAuthToken, errors: [new bG({ code: bF.TokenVerificationFailed, message: `Invalid JWT type: ${c10.header.typ ?? "missing"}. Expected one of: ${dc.join(", ")} for OAuth, or sub starting with 'mch_' for M2M` })] };
        }
        if (a10.startsWith("mt_")) return fq(a10, b10);
        if (a10.startsWith(c8)) return fr(a10, b10);
        if (a10.startsWith("ak_")) return fs(a10, b10);
        throw Error("Unknown machine token type");
      }
      async function fu(a10, { key: b10 }) {
        let { data: c10, errors: d10 } = bT(a10);
        if (d10) throw d10[0];
        let { header: e10, payload: f10 } = c10, { typ: g10, alg: h6 } = e10;
        bQ(g10), bR(h6);
        let { data: i2, errors: j2 } = await bS(c10, b10);
        if (j2) throw new bE({ reason: bC.TokenVerificationFailed, message: `Error verifying handshake token. ${j2[0]}` });
        if (!i2) throw new bE({ reason: bC.TokenInvalidSignature, message: "Handshake signature is invalid." });
        return f10;
      }
      async function fv(a10, b10) {
        let c10, { secretKey: d10, apiUrl: e10, apiVersion: f10, jwksCacheTtlInMs: g10, jwtKey: h6, skipJwksCache: i2 } = b10, { data: j2, errors: k2 } = bT(a10);
        if (k2) throw k2[0];
        let { kid: l2 } = j2.header;
        if (h6) c10 = c3({ kid: l2, pem: h6 });
        else if (d10) c10 = await c4({ secretKey: d10, apiUrl: e10, apiVersion: f10, kid: l2, jwksCacheTtlInMs: g10, skipJwksCache: i2 });
        else throw new bE({ action: bD.SetClerkJWTKey, message: "Failed to resolve JWK during handshake verification.", reason: bC.JWKFailedToResolve });
        return fu(a10, { key: c10 });
      }
      var fw = class {
        constructor(a10, b10, c10) {
        ...
        buildRedirectToHandshake(a10) {
          ...
          d10.searchParams.append("redirect_url", b10?.href || ""), d10.searchParams.append("__clerk_api_version", cj), d10.searchParams.append(cn.QueryParameters.SuffixedCookies, this.authenticateContext.usesSuffixedCookies().toString()), d10.searchParams.append(cn.QueryParameters.HandshakeReason, a10), d10.searchParams.append(cn.QueryParameters.HandshakeFormat, "nonce"), this.authenticateContext.sessionToken && d10.searchParams.append(cn.QueryParameters.Session, this.authenticateContext.sessionToken), "development" === this.authenticateContext.instanceType && this.authenticateContext.devBrowserToken && d10.searchParams.append(cn.QueryParameters.DevBrowser, this.authenticateContext.devBrowserToken);
          ...
          }), new Headers({ [cn.Headers.Location]: d10.href });
        }
        async getCookiesFromHandshake() {
          ...
          if (this.authenticateContext.handshakeNonce) try {
            ...
            let b10 = await fv(this.authenticateContext.handshakeToken, this.authenticateContext);
        ...
        async resolveHandshake() {
          ...
          if (b10.forEach((b11) => {
            a10.append("Set-Cookie", b11), fm(b11).startsWith(cn.Cookies.Session) && (c10 = fn(b11));
          }), "development" === this.authenticateContext.instanceType) {
            let b11 = new URL(this.authenticateContext.clerkUrl);
            b11.searchParams.delete(cn.QueryParameters.Handshake), b11.searchParams.delete(cn.QueryParameters.HandshakeHelp), b11.searchParams.delete(cn.QueryParameters.DevBrowser), b11.searchParams.delete(cn.QueryParameters.HandshakeNonce), a10.append(cn.Headers.Location, b11.toString()), a10.set(cn.Headers.CacheControl, "no-store");
          }
          if ("" === c10) return ff({ tokenType: cs.SessionToken, authenticateContext: this.authenticateContext, reason: fd.SessionTokenMissing, message: "", headers: a10 });
          let { data: d10, errors: [e10] = [] } = await fo(c10, this.authenticateContext);
          if (d10) return fe({ tokenType: cs.SessionToken, authenticateContext: this.authenticateContext, sessionClaims: d10, headers: a10, token: c10 });
          if ("development" === this.authenticateContext.instanceType && (e10?.reason === bC.TokenExpired || e10?.reason === bC.TokenNotActiveYet || e10?.reason === bC.TokenIatInTheFuture)) {
            let b11 = new bE({ action: e10.action, message: e10.message, reason: e10.reason });
...
${b11.getFullMessage()}`);
            let { data: d11, errors: [f10] = [] } = await fo(c10, { ...this.authenticateContext, clockSkewInMs: 864e5 });
            if (d11) return fe({ tokenType: cs.SessionToken, authenticateContext: this.authenticateContext, sessionClaims: d11, headers: a10, token: c10 });
        ...
        handleTokenVerificationErrorInDevelopment(a10) {
          if (a10.reason === bC.TokenInvalidSignature) throw Error("Clerk: Handshake token verification failed due to an invalid signature. If you have switched Clerk keys locally, clear your cookies and try again.");
        ...
        checkAndTrackRedirectLoop(a10) {
          ...
          let b10 = this.authenticateContext.handshakeRedirectLoopCounter + 1, c10 = cn.Cookies.RedirectCount;
          return a10.append("Set-Cookie", `${c10}=${b10}; SameSite=Lax; HttpOnly; Max-Age=2`), false;
        }
        removeDevBrowserFromURL(a10) {
          let b10 = new URL(a10);
          return b10.searchParams.delete(cn.QueryParameters.DevBrowser), b10.searchParams.delete(cn.QueryParameters.LegacyDevBrowser), b10;
        }
        ...
        createMatcher(a10) {
          ...
          try {
            return function(a11, b10) {
              try {
                var c10, d10, e10, f10, g10, h6, i2;
                return c10 = void 0, d10 = [], e10 = a3(a11, d10, c10), f10 = d10, g10 = c10, void 0 === g10 && (g10 = {}), h6 = g10.decode, i2 = void 0 === h6 ? function(a12) {
                  return a12;
                } : h6, function(a12) {
                  var b11 = e10.exec(a12);
                  if (!b11) return false;
                  for (var c11 = b11[0], d11 = b11.index, g11 = /* @__PURE__ */ Object.create(null), h7 = 1; h7 < b11.length; h7++) !function(a13) {
                    if (void 0 !== b11[a13]) {
                      var c12 = f10[a13 - 1];
...
${a12.message}`);
      ...
      }, fy = { NonEligibleNoCookie: "non-eligible-no-refresh-cookie", NonEligibleNonGet: "non-eligible-non-get", InvalidSessionToken: "invalid-session-token", MissingApiClient: "missing-api-client", MissingSessionToken: "missing-session-token", MissingRefreshToken: "missing-refresh-token", ExpiredSessionTokenDecodeFailed: "expired-session-token-decode-failed", ExpiredSessionTokenMissingSidClaim: "expired-session-token-missing-sid-claim", FetchError: "fetch-error", UnexpectedSDKError: "unexpected-sdk-error", UnexpectedBAPIError: "unexpected-bapi-error" };
      function fz(a10, b10, c10) {
        return di(a10, b10) ? null : ff({ tokenType: "string" == typeof b10 ? b10 : a10, authenticateContext: c10, reason: fd.TokenTypeMismatch });
      }
      var fA = async (a10, b10) => {
        let c10 = await cu(fl(a10), b10), d10 = b10.acceptsToken ?? cs.SessionToken;
        if (d10 !== cs.M2MToken && (cr(c10.secretKey), c10.isSatellite)) {
        ...
        let g10 = new fx(b10.organizationSyncOptions), h6 = new fw(c10, { organizationSyncOptions: b10.organizationSyncOptions }, g10);
        async function i2(c11) {
          if (!b10.apiClient) return { data: null, error: { message: "An apiClient is needed to perform token refresh.", cause: { reason: fy.MissingApiClient } } };
          let { sessionToken: d11, refreshTokenInCookie: e11 } = c11;
          if (!d11) return { data: null, error: { message: "Session token must be provided.", cause: { reason: fy.MissingSessionToken } } };
          if (!e11) return { data: null, error: { message: "Refresh token must be provided.", cause: { reason: fy.MissingRefreshToken } } };
          let { data: f11, errors: g11 } = bT(d11);
          if (!f11 || g11) return { data: null, error: { message: "Unable to decode the expired session token.", cause: { reason: fy.ExpiredSessionTokenDecodeFailed, errors: g11 } } };
          if (!f11?.payload?.sid) return { data: null, error: { message: "Expired session token is missing the `sid` claim.", cause: { reason: fy.ExpiredSessionTokenMissingSidClaim } } };
          try {
            ...
            if (!a11?.errors?.length) return { data: null, error: { message: "Unexpected Server/BAPI error", cause: { reason: fy.UnexpectedBAPIError, errors: [a11] } } };
            if ("unexpected_error" === a11.errors[0].code) return { data: null, error: { message: "Fetch unexpected error", cause: { reason: fy.FetchError, errors: a11.errors } } };
        ...
        async function j2(a11) {
          ...
          b11.forEach((a12) => {
            d11.append("Set-Cookie", a12), fm(a12).startsWith(cn.Cookies.Session) && (e11 = fn(a12));
          });
          let { data: f11, errors: g11 } = await fo(e11, a11);
          return g11 ? { data: null, error: { message: "Clerk: unable to verify refreshed session token.", cause: { reason: fy.InvalidSessionToken, errors: g11 } } } : { data: { jwtPayload: f11, sessionToken: e11, headers: d11 }, error: null };
        }
        function k2(a11, b11, c11, d11) {
          if (!h6.isRequestEligibleForHandshake()) return ff({ tokenType: cs.SessionToken, authenticateContext: a11, reason: b11, message: c11 });
          let e11 = d11 ?? h6.buildRedirectToHandshake(b11);
          return (e11.get(cn.Headers.Location) && e11.set(cn.Headers.CacheControl, "no-store"), h6.checkAndTrackRedirectLoop(e11)) ? (console.log("Clerk: Refreshing the session token resulted in an infinite redirect loop. This usually means that your Clerk instance keys do not match - make sure to copy the correct publishable and secret keys from the Clerk dashboard."), ff({ tokenType: cs.SessionToken, authenticateContext: a11, reason: b11, message: c11 })) : function(a12, b12, c12 = "", d12) {
            return fg({ status: fc.Handshake, reason: b12, message: c12, publishableKey: a12.publishableKey || "", isSatellite: a12.isSatellite || false, domain: a12.domain || "", proxyUrl: a12.proxyUrl || "", signInUrl: a12.signInUrl || "", signUpUrl: a12.signUpUrl || "", afterSignInUrl: a12.afterSignInUrl || "", afterSignUpUrl: a12.afterSignUpUrl || "", isSignedIn: false, isAuthenticated: false, tokenType: cs.SessionToken, toAuth: () => null, headers: d12, token: null });
          }(a11, b11, c11, e11);
        }
        async function l2() {
          let { tokenInHeader: a11 } = c10;
          if (dd(a11) || de(a11)) return ff({ tokenType: cs.SessionToken, authenticateContext: c10, reason: fd.TokenTypeMismatch, message: "" });
          try {
            let { data: b11, errors: d11 } = await fo(a11, c10);
            if (d11) throw d11[0];
            return fe({ tokenType: cs.SessionToken, authenticateContext: c10, sessionClaims: b11, headers: new Headers(), token: a11 });
          } catch (a12) {
        ...
        async function m2() {
          ...
          if (c10.handshakeNonce || c10.handshakeToken) try {
            return await h6.resolveHandshake();
          } catch (a12) {
            a12 instanceof bE && "development" === c10.instanceType ? h6.handleTokenVerificationErrorInDevelopment(a12) : console.error("Clerk: unable to resolve handshake:", a12);
          }
          let e11 = c10.isSatellite && "document" === c10.secFetchDest && "GET" === c10.method, f11 = c10.clerkUrl.searchParams.get(cn.QueryParameters.ClerkSynced), i3 = f11 === cn.ClerkSyncStatus.NeedsSync, j3 = f11 === cn.ClerkSyncStatus.Completed, l3 = b11 || a11, m3 = true !== c10.satelliteAutoSync && !l3 && !i3;
          if ("production" === c10.instanceType && e11 && !j3) {
            if (m3) return ff({ tokenType: cs.SessionToken, authenticateContext: c10, reason: fd.SessionTokenAndUATMissing });
            if (!l3 || i3) return k2(c10, fd.SatelliteCookieNeedsSyncing, "");
          }
          if ("development" === c10.instanceType && e11 && !j3) {
            if (m3) return ff({ tokenType: cs.SessionToken, authenticateContext: c10, reason: fd.SessionTokenAndUATMissing });
            if (!l3 || i3) {
              let a12 = new URL(c10.signInUrl);
              a12.searchParams.append(cn.QueryParameters.ClerkRedirectUrl, c10.clerkUrl.toString());
              let b12 = new Headers({ [cn.Headers.Location]: a12.toString() });
              return k2(c10, fd.SatelliteCookieNeedsSyncing, "", b12);
            }
          }
          let o3 = new URL(c10.clerkUrl).searchParams.get(cn.QueryParameters.ClerkRedirectUrl);
          if ("development" === c10.instanceType && !c10.isSatellite && o3) {
            let a12 = new URL(o3);
            c10.devBrowserToken && a12.searchParams.append(cn.QueryParameters.DevBrowser, c10.devBrowserToken), a12.searchParams.set(cn.QueryParameters.ClerkSynced, cn.ClerkSyncStatus.Completed);
            let b12 = new Headers({ [cn.Headers.Location]: a12.toString() });
            return k2(c10, fd.PrimaryRespondsToSyncing, "", b12);
          }
          if ("development" === c10.instanceType && c10.clerkUrl.searchParams.has(cn.QueryParameters.DevBrowser)) return k2(c10, fd.DevBrowserSync, "");
          if ("development" === c10.instanceType && !d11) return k2(c10, fd.DevBrowserMissing, "");
          if (!a11 && !b11) return ff({ tokenType: cs.SessionToken, authenticateContext: c10, reason: fd.SessionTokenAndUATMissing });
          if (!a11 && b11) return k2(c10, fd.SessionTokenWithoutClientUAT, "");
          if (a11 && !b11) return k2(c10, fd.ClientUATWithoutSessionToken, "");
          let { data: p3, errors: q3 } = bT(c10.sessionTokenInCookie);
          if (q3) return n2(q3[0], "cookie");
          if (p3.payload.iat < c10.clientUat) return k2(c10, fd.SessionTokenIATBeforeClientUAT, "");
          try {
            let { data: a12, errors: b12 } = await fo(c10.sessionTokenInCookie, c10);
            if (b12) throw b12[0];
            ...
            let d12 = fe({ tokenType: cs.SessionToken, authenticateContext: c10, sessionClaims: a12, headers: new Headers(), token: c10.sessionTokenInCookie });
            if (!c10.isSatellite && "GET" === c10.method && "document" === c10.secFetchDest && c10.isCrossOriginReferrer() && !c10.isKnownClerkReferrer() && 0 === c10.handshakeRedirectLoopCounter) return k2(c10, fd.PrimaryDomainCrossOriginSync, "Cross-origin request from satellite domain requires handshake");
            let e12 = d12.toAuth();
            if (e12.userId) {
              let a13 = function(a14, b13) {
                ...
                let e13 = k2(a14, fd.ActiveOrganizationMismatch, "");
        ...
        async function n2(b11, d11) {
          let e11;
          if (!(b11 instanceof bE)) return ff({ tokenType: cs.SessionToken, authenticateContext: c10, reason: fd.UnexpectedError });
          if (b11.reason === bC.TokenExpired && c10.refreshTokenInCookie && "GET" === a10.method) {
            let { data: a11, error: b12 } = await j2(c10);
            if (a11) return fe({ tokenType: cs.SessionToken, authenticateContext: c10, sessionClaims: a11.jwtPayload, headers: a11.headers, token: a11.sessionToken });
            e11 = b12?.cause?.reason ? b12.cause.reason : fy.UnexpectedSDKError;
          } else e11 = "GET" !== a10.method ? fy.NonEligibleNonGet : c10.refreshTokenInCookie ? null : fy.NonEligibleNoCookie;
          return (b11.tokenCarrier = d11, [bC.TokenExpired, bC.TokenNotActiveYet, bC.TokenIatInTheFuture].includes(b11.reason)) ? k2(c10, fC({ tokenError: b11.reason, refreshError: e11 }), b11.getFullMessage()) : ff({ tokenType: cs.SessionToken, authenticateContext: c10, reason: b11.reason, message: b11.getFullMessage() });
        }
        function o2(a11, b11) {
          return b11 instanceof bG ? ff({ tokenType: a11, authenticateContext: c10, reason: b11.code, message: b11.getFullMessage() }) : ff({ tokenType: a11, authenticateContext: c10, reason: fd.UnexpectedError });
        }
        async function p2() {
          let { tokenInHeader: a11 } = c10;
          if (!a11) return n2(Error("Missing token in header"), "header");
          if (!dg(a11)) return ff({ tokenType: d10, authenticateContext: c10, reason: fd.TokenTypeMismatch, message: "" });
          let b11 = fz(dh(a11), d10, c10);
          if (b11) return b11;
          let { data: e11, tokenType: f11, errors: g11 } = await ft(a11, c10);
          return g11 ? o2(f11, g11[0]) : fe({ tokenType: f11, authenticateContext: c10, machineData: e11, token: a11 });
        }
        async function q2() {
          let { tokenInHeader: a11 } = c10;
          if (!a11) return n2(Error("Missing token in header"), "header");
          if (dg(a11)) {
            let b12 = fz(dh(a11), d10, c10);
            if (b12) return b12;
            let { data: e12, tokenType: f11, errors: g11 } = await ft(a11, c10);
            return g11 ? o2(f11, g11[0]) : fe({ tokenType: f11, authenticateContext: c10, machineData: e12, token: a11 });
          }
          let { data: b11, errors: e11 } = await fo(a11, c10);
          return e11 ? n2(e11[0], "header") : fe({ tokenType: cs.SessionToken, authenticateContext: c10, sessionClaims: b11, token: a11 });
        }
        return Array.isArray(d10) && !function(a11, b11) {
          let c11 = null, { tokenInHeader: d11 } = b11;
          return d11 && (c11 = dg(d11) ? dh(d11) : cs.SessionToken), di(c11 ?? cs.SessionToken, a11);
        }(d10, c10) ? function() {
          let a11 = fa();
          return fg({ status: fc.SignedOut, reason: fd.TokenTypeMismatch, message: "", proxyUrl: "", publishableKey: "", isSatellite: false, domain: "", signInUrl: "", signUpUrl: "", afterSignInUrl: "", afterSignUpUrl: "", isSignedIn: false, isAuthenticated: false, tokenType: null, toAuth: () => a11, headers: new Headers(), token: null });
        }() : c10.tokenInHeader ? "any" === d10 || Array.isArray(d10) ? q2() : d10 === cs.SessionToken ? l2() : p2() : d10 === cs.OAuthToken || d10 === cs.ApiKey || d10 === cs.M2MToken ? ff({ tokenType: d10, authenticateContext: c10, reason: "No token in header" }) : m2();
      }, fB = (a10) => {
        let { isSignedIn: b10, isAuthenticated: c10, proxyUrl: d10, reason: e10, message: f10, publishableKey: g10, isSatellite: h6, domain: i2 } = a10;
        return { isSignedIn: b10, isAuthenticated: c10, proxyUrl: d10, reason: e10, message: f10, publishableKey: g10, isSatellite: h6, domain: i2 };
      }, fC = ({ tokenError: a10, refreshError: b10 }) => {
        switch (a10) {
          case bC.TokenExpired:
            return `${fd.SessionTokenExpired}-refresh-${b10}`;
          case bC.TokenNotActiveYet:
            return fd.SessionTokenNBF;
          case bC.TokenIatInTheFuture:
            return fd.SessionTokenIatInTheFuture;
          default:
            return fd.UnexpectedError;
        }
      }, fD = { secretKey: "", machineSecretKey: "", jwtKey: "", apiUrl: void 0, apiVersion: void 0, proxyUrl: "", publishableKey: "", isSatellite: false, domain: "", audience: "" }, fE = /* @__PURE__ */ new Set(["connection", "keep-alive", "proxy-authenticate", "proxy-authorization", "te", "trailer", "transfer-encoding", "upgrade"]);
      function fF(a10) {
      ...
      var fG = /* @__PURE__ */ new Set(["content-encoding", "content-length"]);
      function fH(a10) {
        for (; a10.endsWith("/"); ) a10 = a10.slice(0, -1);
        return a10;
      }
      function fI(a10, b10, c10) {
      ...
      async function fJ(a10, b10) {
        let c10 = fH(b10?.proxyPath || be), d10 = b10?.publishableKey || ("undefined" != typeof process ? process.env?.CLERK_PUBLISHABLE_KEY : void 0), e10 = b10?.secretKey || ("undefined" != typeof process ? process.env?.CLERK_SECRET_KEY : void 0);
        if (!d10) return fI("proxy_configuration_error", "Missing publishableKey. Provide it in options or set CLERK_PUBLISHABLE_KEY environment variable.", 500);
        if (!e10) return fI("proxy_configuration_error", "Missing secretKey. Provide it in options or set CLERK_SECRET_KEY environment variable.", 500);
        let f10 = new URL(a10.url);
        if (!(f10.pathname === c10 || f10.pathname.startsWith(c10 + "/"))) return fI("proxy_path_mismatch", `Request path "${f10.pathname}" does not match proxy path "${c10}"`, 400);
        let g10 = function(a11) {
          let b11 = bi(a11)?.frontendApi;
          return b11?.startsWith("clerk.") && a7.some((a12) => b11?.endsWith(a12)) ? bd : ba.some((a12) => b11?.endsWith(a12)) ? "https://frontend-api.lclclerk.com" : bb.some((a12) => b11?.endsWith(a12)) ? "https://frontend-api.clerkstage.dev" : bd;
        }(d10), h6 = new URL(g10).host, i2 = f10.pathname.slice(c10.length) || "/", j2 = new URL(`${g10}${i2}`);
        if (j2.search = f10.search, j2.host !== h6) return fI("proxy_request_failed", "Resolved target does not match the expected host", 400);
        let k2 = new Headers(), l2 = fF(a10.headers);
        a10.headers.forEach((a11, b11) => {
          let c11 = b11.toLowerCase();
          fE.has(c11) || l2.has(c11) || k2.set(b11, a11);
        });
        let m2 = function(a11, b11) {
          let c11 = a11.headers.get("x-forwarded-proto")?.split(",")[0]?.trim(), d11 = a11.headers.get("x-forwarded-host")?.split(",")[0]?.trim();
          return c11 && d11 ? `${c11}://${d11}` : b11.origin;
        }(a10, f10), n2 = `${m2}${c10}`;
        k2.set("Clerk-Proxy-Url", n2), k2.set("Clerk-Secret-Key", e10), k2.set("Host", h6), k2.set("Accept-Encoding", "identity"), k2.has("X-Forwarded-Host") || k2.set("X-Forwarded-Host", f10.host), k2.has("X-Forwarded-Proto") || k2.set("X-Forwarded-Proto", f10.protocol.replace(":", ""));
        let o2 = function(a11) {
        ...
        o2 && k2.set("X-Forwarded-For", o2);
        let p2 = null !== a10.body;
        try {
          let b11 = { method: a10.method, headers: k2, redirect: "manual" };
          p2 && (b11.duplex = "half", b11.body = a10.body);
          let c11 = await fetch(j2.toString(), b11), d11 = fF(c11.headers), e11 = new Headers();
          c11.headers.forEach((a11, b12) => {
            let c12 = b12.toLowerCase();
            fE.has(c12) || fG.has(c12) || d11.has(c12) || ("set-cookie" === c12 ? e11.append(b12, a11) : e11.set(b12, a11));
          });
          let f11 = c11.headers.get("location");
          if (f11) try {
            let a11 = new URL(f11, g10);
            if (a11.host === h6) {
          ...
          let i3 = new Response(c11.body, { status: c11.status, statusText: c11.statusText, headers: e11 });
          for (let a11 of fG) i3.headers.delete(a11);
          return i3;
        } catch (b11) {
          let a11 = b11 instanceof Error ? b11.message : "Unknown error";
          return fI("proxy_request_failed", `Failed to proxy request to Clerk FAPI: ${a11}`, 502);
        }
      }
      c(821), c(167), c(830).s;
      var fK = c(159);
      let fL = "" + fK.s8 + ";404";
      fK.s8, fK.s8, c(792).X, c(280), "undefined" == typeof URLPattern || URLPattern, c(557), c(602), c(801), c(335), /* @__PURE__ */ new WeakMap();
      let fM = { Headers: { NextRewrite: "x-middleware-rewrite", NextResume: "x-middleware-next", NextRedirect: "Location", NextUrl: "next-url", NextAction: "next-action", NextjsData: "x-nextjs-data" } }, fN = (a10, b10, c10) => (a10.headers.set(b10, c10), a10), fO = "__clerk_db_jwt", fP = { rE: "15.4.11" }, fQ = (a10) => {
      ...
      }, fR = (a10) => (Array.isArray(a10) ? a10 : [a10]).map((a11) => "string" == typeof a11 ? fQ(a11) : JSON.stringify(Object.fromEntries(Object.entries(a11).map(([a12, b10]) => [a12, fQ(b10)])), null, 2)).join(", "), fS = (a10, b10) => (...c10) => {
        let d10 = ("string" == typeof a10 ? /* @__PURE__ */ ((a11, b11) => () => {
          let c11 = [], d11 = false;
          return { enable: () => {
            d11 = true;
          }, debug: (...a12) => {
            d11 && c11.push(a12.map((a13) => "function" == typeof a13 ? a13() : a13));
          }, commit: () => {
            if (d11) {
              var e11, f10;
              for (let d12 of (console.log((e11 = a11, `[clerk debug start: ${e11}]`)), c11)) {
                let a12 = b11(d12);
                a12 = a12.split("\n").map((a13) => `  ${a13}`).join("\n"), process.env.VERCEL && (a12 = function(a13, b12) {
                  let c12 = new TextEncoder(), d13 = new TextDecoder("utf-8"), e12 = c12.encode(a13).slice(0, 4096);
                  return d13.decode(e12).replace(/\uFFFD/g, "");
                }(a12, 4096)), console.log(a12);
              }
              console.log((f10 = a11, `[clerk debug end: ${f10}] (@clerk/nextjs=7.4.1,next=${fP.rE},timestamp=${Math.round((/* @__PURE__ */ new Date()).getTime() / 1e3)})`));
            }
          } };
        })(a10, fR) : a10)(), e10 = b10(d10);
        try {
          let a11 = e10(...c10);
          if ("object" == typeof a11 && "then" in a11 && "function" == typeof a11.then) return a11.then((a12) => (d10.commit(), a12)).catch((a12) => {
            throw d10.commit(), a12;
          });
          return d10.commit(), a11;
        } catch (a11) {
          throw d10.commit(), a11;
        }
      };
      ...
      let fW = process.env.CLERK_API_VERSION || "v1", fX = process.env.CLERK_SECRET_KEY || "", fY = process.env.CLERK_MACHINE_SECRET_KEY || "", fZ = process.env.NEXT_PUBLIC_CLERK_PUBLISHABLE_KEY || "", f$ = process.env.CLERK_ENCRYPTION_KEY || "", f_ = process.env.CLERK_API_URL || ((a10) => {
        let b10 = bi(a10)?.frontendApi;
        return b10?.startsWith("clerk.") && a7.some((a11) => b10?.endsWith(a11)) ? bc : ba.some((a11) => b10?.endsWith(a11)) ? "https://api.lclclerk.com" : bb.some((a11) => b10?.endsWith(a11)) ? "https://api.clerkstage.dev" : bc;
      })(fZ), f0 = process.env.NEXT_PUBLIC_CLERK_DOMAIN || "", f1 = process.env.NEXT_PUBLIC_CLERK_PROXY_URL || "", f2 = fV(process.env.NEXT_PUBLIC_CLERK_IS_SATELLITE) || false, f3 = process.env.NEXT_PUBLIC_CLERK_SIGN_IN_URL || "", f4 = process.env.NEXT_PUBLIC_CLERK_SIGN_UP_URL || "", f5 = fV(process.env.NEXT_PUBLIC_CLERK_TELEMETRY_DISABLED), f6 = fV(process.env.NEXT_PUBLIC_CLERK_TELEMETRY_DEBUG), f7 = fV(process.env.NEXT_PUBLIC_CLERK_KEYLESS_DISABLED) || false, f8 = false, f9 = Symbol.for("clerk_use_cache_error");
      class ga extends (gz = Error, gy = f9, gz) {
        constructor(a10, b10) {
          super(a10), this.originalError = b10, this[gy] = true, this.name = "ClerkUseCacheError";
        }
      }
      let gb = /inside\s+["']use cache["']|["']use cache["'].*(?:headers|cookies)|(?:headers|cookies).*["']use cache["']/i, gc = /cache scope/i, gd = /dynamic data source/i, ge = /Route .*? needs to bail out of prerendering at this point because it used .*?./, gf = (a10) => {
        if (!(a10 instanceof Error) || !("message" in a10)) return false;
        let { message: b10 } = a10, c10 = b10.toLowerCase();
        return ge.test(b10) || c10.includes("dynamic server usage") || c10.includes("this page needs to bail out of prerendering") || c10.includes("during prerendering");
      }, gg = `Clerk: auth() and currentUser() cannot be called inside a "use cache" function. These functions access \`headers()\` internally, which is a dynamic API not allowed in cached contexts.
...
To fix this, call auth() outside the cached function and pass the values you need as arguments:
  ...
  if (userId) {
    const user = await getCachedUser(userId);
      ...
      async function gh() {
        try {
          let { headers: a10 } = await Promise.resolve().then(c.bind(c, 221)), b10 = await a10();
          return new M("https://placeholder.com", { headers: b10 });
        } catch (a10) {
          if (a10 && gf(a10)) throw a10;
          if (a10 && ((a11) => {
            if (!(a11 instanceof Error)) return false;
            let { message: b10 } = a11;
            return !!(gb.test(b10) || gc.test(b10) && gd.test(b10));
          })(a10)) throw new ga(`${gg}
...
Original error: ${a10}`);
      ...
      let gl = /* @__PURE__ */ new Set(["error", "warn", "info", "debug", "trace"]), gm = { samplingRate: 1, maxBufferSize: 5, endpoint: "https://clerk-telemetry.com" };
      var gn = class {
        #g;
        #h;
        #i = {};
        ...
        #k = null;
        constructor(a10) {
          this.#g = { maxBufferSize: a10.maxBufferSize ?? gm.maxBufferSize, samplingRate: a10.samplingRate ?? gm.samplingRate, perEventSampling: a10.perEventSampling ?? true, disabled: a10.disabled ?? false, debug: a10.debug ?? false, endpoint: gm.endpoint }, a10.clerkVersion || "undefined" != typeof window ? this.#i.clerkVersion = a10.clerkVersion ?? "" : this.#i.clerkVersion = "", this.#i.sdk = a10.sdk, this.#i.sdkVersion = a10.sdkVersion, this.#i.publishableKey = a10.publishableKey ?? "";
          let b10 = bi(a10.publishableKey);
          b10 && (this.#i.instanceType = b10.instanceType), a10.secretKey && (this.#i.secretKey = a10.secretKey.substring(0, 16)), this.#h = new gi(gj.isSupported() ? new gj() : new gk());
        }
        get isEnabled() {
          return !("development" !== this.#i.instanceType || this.#g.disabled || "undefined" != typeof process && process.env && fV(process.env.CLERK_TELEMETRY_DISABLED) || "undefined" != typeof window && window?.navigator?.webdriver);
        }
        get isDebug() {
          return this.#g.debug || "undefined" != typeof process && process.env && fV(process.env.CLERK_TELEMETRY_DEBUG);
        }
        record(a10) {
          try {
        ...
        recordLog(a10) {
          try {
            ...
            let b10 = "string" == typeof a10?.level && gl.has(a10.level), c10 = "string" == typeof a10?.message && a10.message.trim().length > 0, d10 = null, e10 = a10?.timestamp;
      ...
      let go = { secretKey: fX, publishableKey: fZ, apiUrl: f_, apiVersion: fW, userAgent: "@clerk/nextjs@7.4.1", proxyUrl: f1, domain: f0, isSatellite: f2, machineSecretKey: fY, sdkMetadata: { name: "@clerk/nextjs", version: "7.4.1", environment: "production" }, telemetry: { disabled: f5, debug: f6 } }, gp = (a10) => function(a11) {
        let b10 = { ...a11 }, c10 = e6(b10), d10 = function(a12) {
          let b11 = cq(fD, a12.options), c11 = a12.apiClient;
          return { authenticateRequest: (a13, d11 = {}) => {
            let { apiUrl: e11, apiVersion: f10 } = b11, g10 = cq(b11, d11);
            return fA(a13, { ...d11, ...g10, apiUrl: e11, apiVersion: f10, apiClient: c11 });
          }, debugRequestState: fB };
        }({ options: b10, apiClient: c10 }), e10 = new gn({ publishableKey: b10.publishableKey, secretKey: b10.secretKey, samplingRate: 0.1, ...b10.sdkMetadata ? { sdk: b10.sdkMetadata.name, sdkVersion: b10.sdkMetadata.version } : {}, ...b10.telemetry || {} });
      ...
      var gr = c(521);
      let gs = /* @__PURE__ */ new Map(), gt = new gr.AsyncLocalStorage();
      var gu, gv, gw, gx, gy, gz, gA, gB, gC, gD, gE, gF, gG, gH = Object.defineProperty, gI = (null == (gA = "undefined" != typeof globalThis ? globalThis : void 0) ? void 0 : gA.crypto) || (null == (gB = void 0 !== c.g ? c.g : void 0) ? void 0 : gB.crypto) || (null == (gC = "undefined" != typeof window ? window : void 0) ? void 0 : gC.crypto) || (null == (gD = "undefined" != typeof self ? self : void 0) ? void 0 : gD.crypto) || (null == (gF = null == (gE = "undefined" != typeof frames ? frames : void 0) ? void 0 : gE[0]) ? void 0 : gF.crypto);
      gG = gI ? (a10) => {
        let b10 = [];
        for (let c10 = 0; c10 < a10; c10 += 4) b10.push(gI.getRandomValues(new Uint32Array(1))[0]);
        return new gK(b10, a10);
      } : (a10) => {
        let b10 = [], c10 = (a11) => {
      ...
      ((a10, b10, c10) => ((a11, b11, c11) => b11 in a11 ? gH(a11, b11, { enumerable: true, configurable: true, writable: true, value: c11 }) : a11[b11] = c11)(a10, "symbol" != typeof b10 ? b10 + "" : b10, c10))(gK, "random", gG);
      var gL = { stringify(a10) {
        ...
        return new gK(c10, b10);
      } }, gN = { stringify(a10) {
        try {
          return decodeURIComponent(escape(gM.stringify(a10)));
        } catch {
          throw Error("Malformed UTF-8 data");
        }
      }, parse: (a10) => gM.parse(unescape(encodeURIComponent(a10))) }, gO = class extends gJ {
        constructor() {
          super(), this._minBufferSize = 0;
        }
        reset() {
          this._data = new gK(), this._nDataBytes = 0;
        }
        _append(a10) {
          let b10 = a10;
          "string" == typeof b10 && (b10 = gN.parse(b10)), this._data.concat(b10), this._nDataBytes += b10.sigBytes;
        }
        _process(a10) {
          let b10, { _data: c10, blockSize: d10 } = this, e10 = c10.words, f10 = c10.sigBytes, g10 = f10 / (4 * d10), h6 = (g10 = a10 ? Math.ceil(g10) : Math.max((0 | g10) - this._minBufferSize, 0)) * d10, i2 = Math.min(4 * h6, f10);
          if (h6) {
            for (let a11 = 0; a11 < h6; a11 += d10) this._doProcessBlock(e10, a11);
            b10 = e10.splice(0, h6), c10.sigBytes -= i2;
          }
          return new gK(b10, i2);
        }
        clone() {
          let a10 = super.clone.call(this);
        ...
        constructor(a10) {
          super(), this.blockSize = 16, this.cfg = Object.assign(new gJ(), a10), this.reset();
        }
        static _createHelper(a10) {
          return (b10, c10) => new a10(c10).finalize(b10);
        }
        static _createHmacHelper(a10) {
          return (b10, c10) => new gQ(a10, c10).finalize(b10);
        }
        reset() {
        ...
        constructor(a10, b10) {
          ...
          this._hasher = c10;
          let d10 = b10;
          "string" == typeof d10 && (d10 = gN.parse(d10));
          ...
          let h6 = d10.clone();
          this._iKey = h6;
          let i2 = g10.words, j2 = h6.words;
          for (let a11 = 0; a11 < e10; a11 += 1) i2[a11] ^= 1549556828, j2[a11] ^= 909522486;
          g10.sigBytes = f10, h6.sigBytes = f10, this.reset();
        }
        reset() {
        ...
        for (let b11 = 0; b11 < f10; b11 += 1) if (b11 % 4) {
          ...
          h6[i2 >>> 2] |= c11 << 24 - i2 % 4 * 8, i2 += 1;
        }
        return gK.create(h6, i2);
      }, _map: "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=" }, gS = [];
      for (let a10 = 0; a10 < 64; a10 += 1) gS[a10] = 4294967296 * Math.abs(Math.sin(a10 + 1)) | 0;
      var gT = (a10, b10, c10, d10, e10, f10, g10) => {
        let h6 = a10 + (b10 & c10 | ~b10 & d10) + e10 + g10;
        return (h6 << f10 | h6 >>> 32 - f10) + b10;
      }, gU = (a10, b10, c10, d10, e10, f10, g10) => {
        let h6 = a10 + (b10 & d10 | c10 & ~d10) + e10 + g10;
        return (h6 << f10 | h6 >>> 32 - f10) + b10;
      }, gV = (a10, b10, c10, d10, e10, f10, g10) => {
        let h6 = a10 + (b10 ^ c10 ^ d10) + e10 + g10;
        return (h6 << f10 | h6 >>> 32 - f10) + b10;
      }, gW = (a10, b10, c10, d10, e10, f10, g10) => {
        let h6 = a10 + (c10 ^ (b10 | ~d10)) + e10 + g10;
        return (h6 << f10 | h6 >>> 32 - f10) + b10;
      }, gX = class extends gP {
        _doReset() {
          this._hash = new gK([1732584193, 4023233417, 2562383102, 271733878]);
        }
        _doProcessBlock(a10, b10) {
          ...
          let c10 = this._hash.words, d10 = a10[b10 + 0], e10 = a10[b10 + 1], f10 = a10[b10 + 2], g10 = a10[b10 + 3], h6 = a10[b10 + 4], i2 = a10[b10 + 5], j2 = a10[b10 + 6], k2 = a10[b10 + 7], l2 = a10[b10 + 8], m2 = a10[b10 + 9], n2 = a10[b10 + 10], o2 = a10[b10 + 11], p2 = a10[b10 + 12], q2 = a10[b10 + 13], r2 = a10[b10 + 14], s2 = a10[b10 + 15], t2 = c10[0], u2 = c10[1], v2 = c10[2], w2 = c10[3];
          t2 = gT(t2, u2, v2, w2, d10, 7, gS[0]), w2 = gT(w2, t2, u2, v2, e10, 12, gS[1]), v2 = gT(v2, w2, t2, u2, f10, 17, gS[2]), u2 = gT(u2, v2, w2, t2, g10, 22, gS[3]), t2 = gT(t2, u2, v2, w2, h6, 7, gS[4]), w2 = gT(w2, t2, u2, v2, i2, 12, gS[5]), v2 = gT(v2, w2, t2, u2, j2, 17, gS[6]), u2 = gT(u2, v2, w2, t2, k2, 22, gS[7]), t2 = gT(t2, u2, v2, w2, l2, 7, gS[8]), w2 = gT(w2, t2, u2, v2, m2, 12, gS[9]), v2 = gT(v2, w2, t2, u2, n2, 17, gS[10]), u2 = gT(u2, v2, w2, t2, o2, 22, gS[11]), t2 = gT(t2, u2, v2, w2, p2, 7, gS[12]), w2 = gT(w2, t2, u2, v2, q2, 12, gS[13]), v2 = gT(v2, w2, t2, u2, r2, 17, gS[14]), u2 = gT(u2, v2, w2, t2, s2, 22, gS[15]), t2 = gU(t2, u2, v2, w2, e10, 5, gS[16]), w2 = gU(w2, t2, u2, v2, j2, 9, gS[17]), v2 = gU(v2, w2, t2, u2, o2, 14, gS[18]), u2 = gU(u2, v2, w2, t2, d10, 20, gS[19]), t2 = gU(t2, u2, v2, w2, i2, 5, gS[20]), w2 = gU(w2, t2, u2, v2, n2, 9, gS[21]), v2 = gU(v2, w2, t2, u2, s2, 14, gS[22]), u2 = gU(u2, v2, w2, t2, h6, 20, gS[23]), t2 = gU(t2, u2, v2, w2, m2, 5, gS[24]), w2 = gU(w2, t2, u2, v2, r2, 9, gS[25]), v2 = gU(v2, w2, t2, u2, g10, 14, gS[26]), u2 = gU(u2, v2, w2, t2, l2, 20, gS[27]), t2 = gU(t2, u2, v2, w2, q2, 5, gS[28]), w2 = gU(w2, t2, u2, v2, f10, 9, gS[29]), v2 = gU(v2, w2, t2, u2, k2, 14, gS[30]), u2 = gU(u2, v2, w2, t2, p2, 20, gS[31]), t2 = gV(t2, u2, v2, w2, i2, 4, gS[32]), w2 = gV(w2, t2, u2, v2, l2, 11, gS[33]), v2 = gV(v2, w2, t2, u2, o2, 16, gS[34]), u2 = gV(u2, v2, w2, t2, r2, 23, gS[35]), t2 = gV(t2, u2, v2, w2, e10, 4, gS[36]), w2 = gV(w2, t2, u2, v2, h6, 11, gS[37]), v2 = gV(v2, w2, t2, u2, k2, 16, gS[38]), u2 = gV(u2, v2, w2, t2, n2, 23, gS[39]), t2 = gV(t2, u2, v2, w2, q2, 4, gS[40]), w2 = gV(w2, t2, u2, v2, d10, 11, gS[41]), v2 = gV(v2, w2, t2, u2, g10, 16, gS[42]), u2 = gV(u2, v2, w2, t2, j2, 23, gS[43]), t2 = gV(t2, u2, v2, w2, m2, 4, gS[44]), w2 = gV(w2, t2, u2, v2, p2, 11, gS[45]), v2 = gV(v2, w2, t2, u2, s2, 16, gS[46]), u2 = gV(u2, v2, w2, t2, f10, 23, gS[47]), t2 = gW(t2, u2, v2, w2, d10, 6, gS[48]), w2 = gW(w2, t2, u2, v2, k2, 10, gS[49]), v2 = gW(v2, w2, t2, u2, r2, 15, gS[50]), u2 = gW(u2, v2, w2, t2, i2, 21, gS[51]), t2 = gW(t2, u2, v2, w2, p2, 6, gS[52]), w2 = gW(w2, t2, u2, v2, g10, 10, gS[53]), v2 = gW(v2, w2, t2, u2, n2, 15, gS[54]), u2 = gW(u2, v2, w2, t2, e10, 21, gS[55]), t2 = gW(t2, u2, v2, w2, l2, 6, gS[56]), w2 = gW(w2, t2, u2, v2, s2, 10, gS[57]), v2 = gW(v2, w2, t2, u2, j2, 15, gS[58]), u2 = gW(u2, v2, w2, t2, q2, 21, gS[59]), t2 = gW(t2, u2, v2, w2, h6, 6, gS[60]), w2 = gW(w2, t2, u2, v2, o2, 10, gS[61]), v2 = gW(v2, w2, t2, u2, f10, 15, gS[62]), u2 = gW(u2, v2, w2, t2, m2, 21, gS[63]), c10[0] = c10[0] + t2 | 0, c10[1] = c10[1] + u2 | 0, c10[2] = c10[2] + v2 | 0, c10[3] = c10[3] + w2 | 0;
        }
        _doFinalize() {
      ...
      gP._createHelper(gX), gP._createHmacHelper(gX);
      var gY = class extends gJ {
        constructor(a10) {
          super(), this.cfg = Object.assign(new gJ(), { keySize: 4, hasher: gX, iterations: 1 }, a10);
        }
        compute(a10, b10) {
          let c10, { cfg: d10 } = this, e10 = d10.hasher.create(), f10 = gK.create(), g10 = f10.words, { keySize: h6, iterations: i2 } = d10;
          for (; g10.length < h6; ) {
            c10 && e10.update(c10), c10 = e10.update(a10).finalize(b10), e10.reset();
            for (let a11 = 1; a11 < i2; a11 += 1) c10 = e10.finalize(c10), e10.reset();
            f10.concat(c10);
          }
          return f10.sigBytes = 4 * h6, f10;
        }
      }, gZ = class extends gO {
        constructor(a10, b10, c10) {
          super(), this.cfg = Object.assign(new gJ(), c10), this._xformMode = a10, this._key = b10, this.reset();
        }
        ...
        static _createHelper(a10) {
          let b10 = (a11) => "string" == typeof a11 ? g5 : g4;
      ...
      gZ._ENC_XFORM_MODE = 1, gZ._DEC_XFORM_MODE = 2, gZ.keySize = 4, gZ.ivSize = 4;
      var g$ = class extends gJ {
        constructor(a10, b10) {
      ...
      var g1 = { pad(a10, b10) {
        ...
        constructor(a10, b10, c10) {
          super(a10, b10, Object.assign({ mode: g0, padding: g1 }, c10)), this.blockSize = 4;
        }
        reset() {
          let a10;
        ...
        static encrypt(a10, b10, c10, d10) {
          let e10 = Object.assign(new gJ(), this.cfg, d10), f10 = a10.createEncryptor(c10, e10), g10 = f10.finalize(b10), h6 = f10.cfg;
          return g3.create({ ciphertext: g10, key: c10, iv: h6.iv, algorithm: a10, mode: h6.mode, padding: h6.padding, blockSize: f10.blockSize, formatter: e10.format });
        }
        static decrypt(a10, b10, c10, d10) {
          let e10 = b10, f10 = Object.assign(new gJ(), this.cfg, d10);
      ...
      g4.cfg = Object.assign(new gJ(), { format: { stringify(a10) {
        let { ciphertext: b10, salt: c10 } = a10;
        return (c10 ? gK.create([1398893684, 1701076831]).concat(c10).concat(b10) : b10).toString(gR);
      }, parse(a10) {
        let b10, c10 = gR.parse(a10), d10 = c10.words;
        return 1398893684 === d10[0] && 1701076831 === d10[1] && (b10 = gK.create(d10.slice(2, 4)), d10.splice(0, 4), c10.sigBytes -= 16), g3.create({ ciphertext: c10, salt: b10 });
      } } });
      var g5 = class extends g4 {
        static encrypt(a10, b10, c10, d10) {
          let e10 = Object.assign(new gJ(), this.cfg, d10), f10 = e10.kdf.execute(c10, a10.keySize, a10.ivSize, e10.salt, e10.hasher);
          e10.iv = f10.iv;
          let g10 = g4.encrypt.call(this, a10, b10, f10.key, e10);
        ...
        static decrypt(a10, b10, c10, d10) {
          ...
          return f10.iv = g10.iv, g4.decrypt.call(this, a10, e10, g10.key, f10);
        }
      };
      g5.cfg = Object.assign(g4.cfg, { kdf: { execute(a10, b10, c10, d10, e10) {
        let f10, g10 = d10;
        g10 || (g10 = gK.random(8)), f10 = e10 ? gY.create({ keySize: b10 + c10, hasher: e10 }).compute(a10, g10) : gY.create({ keySize: b10 + c10 }).compute(a10, g10);
        let h6 = gK.create(f10.words.slice(b10), 4 * c10);
        return f10.sigBytes = 4 * b10, g3.create({ key: f10, iv: h6, salt: g10 });
      } } });
      var g6 = [], g7 = [], g8 = [], g9 = [], ha = [], hb = [], hc = [], hd = [], he = [], hf = [], hg = [];
      for (let a10 = 0; a10 < 256; a10 += 1) a10 < 128 ? hg[a10] = a10 << 1 : hg[a10] = a10 << 1 ^ 283;
      var hh = 0, hi = 0;
      for (let a10 = 0; a10 < 256; a10 += 1) {
        let a11 = hi ^ hi << 1 ^ hi << 2 ^ hi << 3 ^ hi << 4;
        a11 = a11 >>> 8 ^ 255 & a11 ^ 99, g6[hh] = a11, g7[a11] = hh;
        let b10 = hg[hh], c10 = hg[b10], d10 = hg[c10], e10 = 257 * hg[a11] ^ 16843008 * a11;
        g8[hh] = e10 << 24 | e10 >>> 8, g9[hh] = e10 << 16 | e10 >>> 16, ha[hh] = e10 << 8 | e10 >>> 24, hb[hh] = e10, e10 = 16843009 * d10 ^ 65537 * c10 ^ 257 * b10 ^ 16843008 * hh, hc[a11] = e10 << 24 | e10 >>> 8, hd[a11] = e10 << 16 | e10 >>> 16, he[a11] = e10 << 8 | e10 >>> 24, hf[a11] = e10, hh ? (hh = b10 ^ hg[hg[hg[d10 ^ b10]]], hi ^= hg[hg[hi]]) : hh = hi = 1;
      }
      var hj = [0, 1, 2, 4, 8, 16, 32, 64, 128, 27, 54], hk = class extends g2 {
        _doReset() {
          let a10;
          ...
          for (let b11 = 0; b11 < e10; b11 += 1) b11 < d10 ? f10[b11] = c10[b11] : (a10 = f10[b11 - 1], b11 % d10 ? d10 > 6 && b11 % d10 == 4 && (a10 = g6[a10 >>> 24] << 24 | g6[a10 >>> 16 & 255] << 16 | g6[a10 >>> 8 & 255] << 8 | g6[255 & a10]) : a10 = (g6[(a10 = a10 << 8 | a10 >>> 24) >>> 24] << 24 | g6[a10 >>> 16 & 255] << 16 | g6[a10 >>> 8 & 255] << 8 | g6[255 & a10]) ^ hj[b11 / d10 | 0] << 24, f10[b11] = f10[b11 - d10] ^ a10);
          this._invKeySchedule = [];
          let g10 = this._invKeySchedule;
          for (let b11 = 0; b11 < e10; b11 += 1) {
            let c11 = e10 - b11;
            a10 = b11 % 4 ? f10[c11] : f10[c11 - 4], b11 < 4 || c11 <= 4 ? g10[b11] = a10 : g10[b11] = hc[g6[a10 >>> 24]] ^ hd[g6[a10 >>> 16 & 255]] ^ he[g6[a10 >>> 8 & 255]] ^ hf[g6[255 & a10]];
          }
        }
        encryptBlock(a10, b10) {
          this._doCryptBlock(a10, b10, this._keySchedule, g8, g9, ha, hb, g6);
        }
        decryptBlock(a10, b10) {
          let c10 = a10[b10 + 1];
          a10[b10 + 1] = a10[b10 + 3], a10[b10 + 3] = c10, this._doCryptBlock(a10, b10, this._invKeySchedule, hc, hd, he, hf, g7), c10 = a10[b10 + 1], a10[b10 + 1] = a10[b10 + 3], a10[b10 + 3] = c10;
        }
        _doCryptBlock(a10, b10, c10, d10, e10, f10, g10, h6) {
          ...
          for (let a11 = 1; a11 < i2; a11 += 1) {
            ...
            n2 += 1;
            let h7 = d10[l2 >>> 24] ^ e10[m2 >>> 16 & 255] ^ f10[j2 >>> 8 & 255] ^ g10[255 & k2] ^ c10[n2];
            n2 += 1;
            let i3 = d10[m2 >>> 24] ^ e10[j2 >>> 16 & 255] ^ f10[k2 >>> 8 & 255] ^ g10[255 & l2] ^ c10[n2];
            n2 += 1, j2 = a12, k2 = b11, l2 = h7, m2 = i3;
          }
          let o2 = (h6[j2 >>> 24] << 24 | h6[k2 >>> 16 & 255] << 16 | h6[l2 >>> 8 & 255] << 8 | h6[255 & m2]) ^ c10[n2];
          n2 += 1;
          let p2 = (h6[k2 >>> 24] << 24 | h6[l2 >>> 16 & 255] << 16 | h6[m2 >>> 8 & 255] << 8 | h6[255 & j2]) ^ c10[n2];
          n2 += 1;
          let q2 = (h6[l2 >>> 24] << 24 | h6[m2 >>> 16 & 255] << 16 | h6[j2 >>> 8 & 255] << 8 | h6[255 & k2]) ^ c10[n2];
          n2 += 1;
          let r2 = (h6[m2 >>> 24] << 24 | h6[j2 >>> 16 & 255] << 16 | h6[k2 >>> 8 & 255] << 8 | h6[255 & l2]) ^ c10[n2];
          n2 += 1, a10[b10] = o2, a10[b10 + 1] = p2, a10[b10 + 2] = q2, a10[b10 + 3] = r2;
        }
      };
      hk.keySize = 8;
      var hl = g2._createHelper(hk), hm = [], hn = class extends gP {
        _doReset() {
          this._hash = new gK([1732584193, 4023233417, 2562383102, 271733878, 3285377520]);
        }
        _doProcessBlock(a10, b10) {
          let c10 = this._hash.words, d10 = c10[0], e10 = c10[1], f10 = c10[2], g10 = c10[3], h6 = c10[4];
          for (let c11 = 0; c11 < 80; c11 += 1) {
            if (c11 < 16) hm[c11] = 0 | a10[b10 + c11];
            else {
              let a11 = hm[c11 - 3] ^ hm[c11 - 8] ^ hm[c11 - 14] ^ hm[c11 - 16];
              hm[c11] = a11 << 1 | a11 >>> 31;
            }
            let i2 = (d10 << 5 | d10 >>> 27) + h6 + hm[c11];
            c11 < 20 ? i2 += (e10 & f10 | ~e10 & g10) + 1518500249 : c11 < 40 ? i2 += (e10 ^ f10 ^ g10) + 1859775393 : c11 < 60 ? i2 += (e10 & f10 | e10 & g10 | f10 & g10) - 1894007588 : i2 += (e10 ^ f10 ^ g10) - 899497514, h6 = g10, g10 = f10, f10 = e10 << 30 | e10 >>> 2, e10 = d10, d10 = i2;
          }
          c10[0] = c10[0] + d10 | 0, c10[1] = c10[1] + e10 | 0, c10[2] = c10[2] + f10 | 0, c10[3] = c10[3] + g10 | 0, c10[4] = c10[4] + h6 | 0;
        }
        _doFinalize() {
          let a10 = this._data, b10 = a10.words, c10 = 8 * this._nDataBytes, d10 = 8 * a10.sigBytes;
      ...
      }, ho = (gP._createHelper(hn), gP._createHmacHelper(hn));
      let hp = `
...
2) With environment variables e.g.
   ...
   NEXT_PUBLIC_CLERK_IS_SATELLITE='true'`, hr = `Clerk: Unable to decrypt request data.

Refresh the page if your .env file was just updated. If the issue persists, ensure the encryption key is valid and properly set.

For more information, see: https://clerk.com/docs/reference/nextjs/clerk-middleware#dynamic-keys. (code=encryption_key_invalid)`, hs = by({ packageName: "@clerk/nextjs" }), ht = "x-middleware-override-headers", hu = "x-middleware-request", hv = (a10, b10, c10) => {
        a10.headers.get(ht) || (a10.headers.set(ht, [...b10.headers.keys()]), b10.headers.forEach((b11, c11) => {
          a10.headers.set(`${hu}-${c11}`, b11);
        })), Object.entries(c10).forEach(([b11, c11]) => {
          a10.headers.set(ht, `${a10.headers.get(ht)},${b11}`), a10.headers.set(`${hu}-${b11}`, c11);
        });
      }, hw = (a10) => R.redirect(a10, { headers: { [cn.Headers.ClerkRedirectTo]: "true" } }), hx = "clerk_keyless_dummy_key";
      function hy() {
      ...
      function hz(a10, b10) {
        return JSON.parse(hl.decrypt(a10, b10).toString(gN));
      }
      let hA = async () => {
        var a10, b10;
        let c10;
        try {
          let a11 = await gh(), b11 = gq(a11, cn.Headers.ClerkRequestData);
          c10 = function(a12) {
            if (!a12) return {};
            let b12 = a5() ? f$ || fX : f$ || fX || hx;
            try {
              return hz(a12, b12);
            } catch {
              if (f8) try {
          ...
          if (a11 && gf(a11) || a11 && ((a12) => a12 instanceof Error && f9 in a12)(a11)) throw a11;
        }
        let d10 = null != (b10 = null == (a10 = gt.getStore()) ? void 0 : a10.get("requestData")) ? b10 : c10;
        return (null == d10 ? void 0 : d10.secretKey) || (null == d10 ? void 0 : d10.publishableKey) ? gp(d10) : gp({});
      };
      class hB {
      ...
      async function hE() {
        ...
        if (!a10) return `${hC}0`;
        let b10 = a10.split("/").filter(Boolean).slice(-3).reverse().join("/"), c10 = await hD(b10);
        return `${hC}${c10}`;
      }
      async function hF(a10) {
        let b10;
        if (!f8) return;
        let c10 = await hE();
        try {
      ...
      let hG = { REDIRECT_TO_URL: "CLERK_PROTECT_REDIRECT_TO_URL", REDIRECT_TO_SIGN_IN: "CLERK_PROTECT_REDIRECT_TO_SIGN_IN", REDIRECT_TO_SIGN_UP: "CLERK_PROTECT_REDIRECT_TO_SIGN_UP" }, hH = { NOT_FOUND: 404, FORBIDDEN: 403, UNAUTHORIZED: 401 }, hI = new Set(Object.values(hH)), hJ = "NEXT_HTTP_ERROR_FALLBACK";
      function hK(a10) {
        if (!function(a11) {
          if ("object" != typeof a11 || null === a11 || !("digest" in a11) || "string" != typeof a11.digest) return false;
          let [b11, c10] = a11.digest.split(";");
          return b11 === hJ && hI.has(Number(c10));
        }(a10)) return;
        let [, b10] = a10.digest.split(";");
        return Number(b10);
      }
      let hL = "NEXT_REDIRECT";
      function hM(a10, b10, c10 = "replace", d10 = 307) {
        let e10 = Error(hL);
        throw e10.digest = `${hL};${c10};${a10};${d10};`, e10.clerk_digest = hG.REDIRECT_TO_URL, Object.assign(e10, b10), e10;
      }
      function hN(a10, b10) {
      ...
      function hO(a10) {
        ...
        return c10 === hL && ("replace" === d10 || "push" === d10) && "string" == typeof e10 && !isNaN(f10) && 307 === f10;
      }
      function hP() {
        let a10 = Error(hJ);
        throw a10.digest = `${hJ};${hH.UNAUTHORIZED}`, a10;
      }
      let hQ = ["role", "permission", "feature", "plan", "reverification"], hR = (a10) => {
        var b10, c10;
        return !!a10.headers.get(fM.Headers.NextUrl) && ((null == (b10 = a10.headers.get(cn.Headers.Accept)) ? void 0 : b10.includes("text/x-component")) || (null == (c10 = a10.headers.get(cn.Headers.ContentType)) ? void 0 : c10.includes("multipart/form-data")) || !!a10.headers.get(fM.Headers.NextAction));
      }, hS = (a10) => !!a10.headers.get(fM.Headers.NextUrl) && !hR(a10) || hT(), hT = () => {
        ...
        return !!b10;
      }, hU = (a10) => !!a10.headers.get(fM.Headers.NextjsData);
      async function hV({ clerkRequest: a10, request: b10, event: c10, requestState: d10, handler: e10, options: f10, resolvedParams: g10, keyless: h6, logger: i2 }) {
        var j2, k2;
        let { publishableKey: l2, secretKey: m2 } = f10;
        i2.debug("requestState", () => ({ status: d10.status, headers: JSON.stringify(Object.fromEntries(d10.headers)), reason: d10.reason }));
        let n2 = d10.headers.get(cn.Headers.Location);
        if (n2) {
          !function({ locationHeader: a12, requestStateHeaders: b11, publishableKey: c11 }) {
            let d11 = "undefined" != typeof process && !!process.env && (!!process.env.NETLIFY || !!process.env.NETLIFY_FUNCTIONS_TOKEN || "string" == typeof process.env.URL && process.env.URL.endsWith("netlify.app")), e11 = c11.startsWith("test_") || c11.startsWith("pk_test_");
            if (d11 && e11 && !a12.includes("__clerk_handshake")) {
              let c12 = new URL(a12);
              c12.searchParams.append("__clerk_netlify_cache_bust", Date.now().toString()), b11.set("Location", c12.toString());
            }
          }({ locationHeader: n2, requestStateHeaders: d10.headers, publishableKey: d10.publishableKey });
          let a11 = R.redirect(d10.headers.get(cn.Headers.Location) || n2);
          return d10.headers.forEach((b11, c11) => {
            c11 !== cn.Headers.Location && a11.headers.append(c11, b11);
          }), a11;
        }
        if (d10.status === fc.Handshake) throw Error("Clerk: handshake status without redirect");
        let o2 = d10.toAuth();
        i2.debug("auth", () => ({ auth: o2, debug: o2.debug() }));
        let p2 = hW(a10), q2 = hX(a10), r2 = await hY(a10, o2, p2), s2 = hZ(d10, p2, q2);
        s2.protect = r2;
        let t2 = R.next();
        try {
          t2 = await gt.run(gs, async () => null == e10 ? void 0 : e10(s2, b10, c10)) || t2;
        } catch (c11) {
          t2 = h$(c11, a10, b10, d10);
        }
        if (f10.contentSecurityPolicy) {
          let { headers: b11 } = function(a11, b12) {
            var c12;
            let d11 = [], e11 = b12.strict ? function() {
              let a12 = new Uint8Array(16);
              return crypto.getRandomValues(a12), btoa(Array.from(a12, (a13) => String.fromCharCode(a13)).join(""));
            }() : void 0, f11 = function(a12, b13, c13, d12) {
              let e12 = Object.entries(hB.DEFAULT_DIRECTIVES).reduce((a13, [b14, c14]) => (a13[b14] = new Set(c14), a13), {});
              if (e12["connect-src"].add(b13), a12 && (e12["script-src"].delete("http:"), e12["script-src"].delete("https:"), e12["script-src"].add("'strict-dynamic'"), d12 && e12["script-src"].add(`'nonce-${d12}'`)), c13) {
                let a13 = /* @__PURE__ */ new Map();
                Object.entries(c13).forEach(([b14, c14]) => {
                  let d13 = Array.isArray(c14) ? c14 : [c14];
                  hB.DEFAULT_DIRECTIVES[b14] ? function(a14, b15, c15) {
                    if (c15.includes("'none'") || c15.includes("none")) {
                      a14[b15] = /* @__PURE__ */ new Set(["'none'"]);
                      return;
                    }
                    let d14 = /* @__PURE__ */ new Set();
                    a14[b15].forEach((a15) => {
                      d14.add(hB.formatValue(a15));
                    }), c15.forEach((a15) => {
                      d14.add(hB.formatValue(a15));
                    }), a14[b15] = d14;
                  }(e12, b14, d13) : function(a14, b15, c15) {
                    if (c15.includes("'none'") || c15.includes("none")) return a14.set(b15, /* @__PURE__ */ new Set(["'none'"]));
                    let d14 = /* @__PURE__ */ new Set();
                    c15.forEach((a15) => {
                      let b16 = hB.formatValue(a15);
                      d14.add(b16);
                    }), a14.set(b15, d14);
                  }(a13, b14, d13);
                }), a13.forEach((a14, b14) => {
              ...
              return Object.entries(e12).sort(([a13], [b14]) => a13.localeCompare(b14)).map(([a13, b14]) => {
                let c14 = Array.from(b14).map((a14) => ({ raw: a14, formatted: hB.formatValue(a14) }));
                return `${a13} ${c14.map((a14) => a14.formatted).join(" ")}`;
              }).join("; ");
            }(null != (c12 = b12.strict) && c12, a11, b12.directives, e11);
            return b12.reportTo && (f11 += "; report-to csp-endpoint", d11.push([cn.Headers.ReportingEndpoints, `csp-endpoint="${b12.reportTo}"`])), b12.reportOnly ? d11.push([cn.Headers.ContentSecurityPolicyReportOnly, f11]) : d11.push([cn.Headers.ContentSecurityPolicy, f11]), e11 && d11.push([cn.Headers.Nonce, e11]), { headers: d11 };
          }((null != (k2 = null == (j2 = bi(l2)) ? void 0 : j2.frontendApi) ? k2 : "").replace("$", ""), f10.contentSecurityPolicy), c11 = {};
          b11.forEach(([a11, b12]) => {
            fN(t2, a11, b12), c11[a11] = b12;
          }), hv(t2, a10, c11), i2.debug("Clerk generated CSP", () => ({ headers: b11 }));
        }
        if (d10.headers && d10.headers.forEach((a11, b11) => {
          b11 === cn.Headers.ContentSecurityPolicy && i2.debug("Content-Security-Policy detected", () => ({ value: a11 })), t2.headers.append(b11, a11);
        }), t2.headers.get(fM.Headers.NextRedirect)) {
          i2.debug("handlerResult is redirect");
          var u2 = t2;
          let b11 = u2.headers.get("location");
          if ("true" === u2.headers.get(cn.Headers.ClerkRedirectTo) && b11 && bl(f10.secretKey) && a10.clerkUrl.isCrossOrigin(b11)) {
            let c11 = a10.cookies.get(fO) || "", d11 = function(a11, b12) {
              let c12 = new URL(a11), d12 = c12.searchParams.get(fO);
              c12.searchParams.delete(fO);
              let e11 = d12 || b12;
              return e11 && c12.searchParams.set(fO, e11), c12;
            }(new URL(b11), c11);
            return R.redirect(d11.href, u2);
          }
          return u2;
        }
        f10.debug && hv(t2, a10, { [cn.Headers.EnableDebug]: "true" });
        let v2 = m2 === (null == h6 ? void 0 : h6.secretKey) ? { publishableKey: null == h6 ? void 0 : h6.publishableKey, secretKey: null == h6 ? void 0 : h6.secretKey } : {};
        return !function(a11, b11, c11, d11, e11, f11) {
          let g11, { reason: h7, message: i3, status: j3, token: k3 } = c11;
          if (b11 || (b11 = R.next()), b11.headers.get(fM.Headers.NextRedirect)) return;
          "1" === b11.headers.get(fM.Headers.NextResume) && (b11.headers.delete(fM.Headers.NextResume), g11 = new URL(a11.url));
          let l3 = b11.headers.get(fM.Headers.NextRewrite);
          if (l3) {
            let b12 = new URL(a11.url);
            if ((g11 = new URL(l3)).origin !== b12.origin) return;
          }
          if (g11) {
            let c12 = function(a12, b12, c13) {
              var d12;
              let e12 = (a13) => !a13 || !Object.values(a13).some((a14) => void 0 !== a14);
              if (e12(a12) && e12(b12) && !c13) return;
              if (a12.secretKey && !f$) throw Error("Clerk: Missing `CLERK_ENCRYPTION_KEY`. Required for propagating `secretKey` middleware option. See docs: https://clerk.com/docs/references/nextjs/clerk-middleware#dynamic-keys. (code=encryption_key_missing)");
              let f12 = a5() ? f$ || (d12 = () => hs.throwMissingSecretKeyError(), fX || d12(), fX) : f$ || fX || hx;
              return hl.encrypt(JSON.stringify({ ...b12, ...a12, machineAuthObject: null != c13 ? c13 : void 0 }), f12).toString();
            }(d11, e11, f11);
            hv(b11, a11, { [cn.Headers.AuthStatus]: j3, [cn.Headers.AuthToken]: k3 || "", [cn.Headers.AuthSignature]: k3 ? ho(k3, (null == d11 ? void 0 : d11.secretKey) || fX || e11.secretKey || "").toString() : "", [cn.Headers.AuthMessage]: i3 || "", [cn.Headers.AuthReason]: h7 || "", [cn.Headers.ClerkUrl]: a11.clerkUrl.toString(), ...c12 ? { [cn.Headers.ClerkRequestData]: c12 } : {} }), b11.headers.set(fM.Headers.NextRewrite, g11.href);
          }
        }(a10, t2, d10, g10, v2, "session_token" === o2.tokenType ? null : ((a11) => {
          let { debug: b11, getToken: c11, has: d11, ...e11 } = a11;
          return e11;
        })(o2)), t2;
      }
      let hW = (a10) => (b10 = {}) => {
        !function(a11, b11) {
          hM(a11, { clerk_digest: hG.REDIRECT_TO_SIGN_IN, returnBackUrl: hN(a11, b11) });
        }(a10.clerkUrl.toString(), b10.returnBackUrl);
      }, hX = (a10) => (b10 = {}) => {
        !function(a11, b11) {
          hM(a11, { clerk_digest: hG.REDIRECT_TO_SIGN_UP, returnBackUrl: hN(a11, b11) });
        }(a10.clerkUrl.toString(), b10.returnBackUrl);
      }, hY = (a10, b10, c10) => async (d10, e10) => function(a11) {
        let { redirectToSignIn: b11, authObject: c11, redirect: d11, notFound: e11, request: f10, unauthorized: g10 } = a11;
        return async (...a12) => {
          var h6, i2, j2, k2, l2, m2, n2, o2;
          let p2 = ((a13) => {
            if (!a13) return;
            if ("function" == typeof a13) return a13;
            let b12 = {};
            for (let c12 of hQ) void 0 !== a13[c12] && (b12[c12] = a13[c12]);
            if (0 !== Object.keys(b12).length) return b12;
          })(a12[0]), q2 = (null == (h6 = a12[0]) ? void 0 : h6.unauthenticatedUrl) || (null == (i2 = a12[1]) ? void 0 : i2.unauthenticatedUrl), r2 = (null == (j2 = a12[0]) ? void 0 : j2.unauthorizedUrl) || (null == (k2 = a12[1]) ? void 0 : k2.unauthorizedUrl), s2 = (null == (l2 = a12[0]) ? void 0 : l2.token) || (null == (m2 = a12[1]) ? void 0 : m2.token) || cs.SessionToken, t2 = () => c11.tokenType === cs.SessionToken && di(cs.SessionToken, s2) ? r2 ? d11(r2) : e11() : g10();
          if (!di(c11.tokenType, s2)) return t2();
          if (c11.tokenType !== cs.SessionToken) return c11.isAuthenticated ? c11 : t2();
          if ("pending" === c11.sessionStatus || !c11.userId) {
            return q2 ? d11(q2) : "document" === (n2 = f10).headers.get(cn.Headers.SecFetchDest) || "iframe" === n2.headers.get(cn.Headers.SecFetchDest) || (null == (o2 = n2.headers.get(cn.Headers.Accept)) ? void 0 : o2.includes("text/html")) || hS(n2) || hU(n2) ? b11() : hR(f10) ? g10() : e11();
          }
          return p2 ? "function" == typeof p2 ? p2(c11.has) ? c11 : t2() : c11.has(p2) ? c11 : t2() : c11;
        };
      }({ request: a10, redirect: (a11) => hM(a11, { redirectUrl: a11 }), notFound: () => function() {
        let a11 = Object.defineProperty(Error(fL), "__NEXT_ERROR_CODE", { value: "E394", enumerable: false, configurable: true });
        throw a11.digest = fL, a11;
      }(), unauthorized: hP, authObject: fb({ authObject: b10, acceptsToken: (null == d10 ? void 0 : d10.token) || (null == e10 ? void 0 : e10.token) || cs.SessionToken }), redirectToSignIn: c10 })(d10, e10), hZ = (a10, b10, c10) => async (d10) => {
        var e10;
        let f10 = a10.toAuth({ treatPendingAsSignedOut: null == d10 ? void 0 : d10.treatPendingAsSignedOut }), g10 = null != (e10 = null == d10 ? void 0 : d10.acceptsToken) ? e10 : cs.SessionToken, h6 = fb({ authObject: f10, acceptsToken: g10 });
        return h6.tokenType === cs.SessionToken && di(cs.SessionToken, g10) ? Object.assign(h6, { redirectToSignIn: b10, redirectToSignUp: c10 }) : h6;
      }, h$ = (a10, b10, c10, d10) => {
        var e10;
        if (function(a11) {
          return a11 instanceof Error && "MalformedURLError" === a11.name;
        }(a10)) return new R(null, { status: 400, statusText: "Bad Request" });
        if (hK(a10) === hH.UNAUTHORIZED) {
          let a11 = new R(null, { status: 401 }), b11 = d10.toAuth();
          if (b11 && b11.tokenType === cs.OAuthToken) {
            let b12 = bi(d10.publishableKey);
            return fN(a11, "WWW-Authenticate", `Bearer resource_metadata="https://${null == b12 ? void 0 : b12.frontendApi}/.well-known/oauth-protected-resource"`);
          }
          return a11;
        }
        if (function(a11) {
          return "object" == typeof a11 && null !== a11 && "digest" in a11 && "NEXT_NOT_FOUND" === a11.digest || hK(a11) === hH.NOT_FOUND;
        }(a10)) return fN(R.rewrite(new URL(`/clerk_${Date.now()}`, c10.url)), cn.Headers.AuthReason, "protect-rewrite");
        let f10 = function(a11) {
          return !!hO(a11) && "clerk_digest" in a11 && a11.clerk_digest === hG.REDIRECT_TO_SIGN_IN;
        }(a10), g10 = function(a11) {
          return !!hO(a11) && "clerk_digest" in a11 && a11.clerk_digest === hG.REDIRECT_TO_SIGN_UP;
        }(a10);
        if (f10 || g10) {
          let c11 = ((a11) => {
            let { publishableKey: b11, redirectAdapter: c12, signInUrl: d11, signUpUrl: e11, baseUrl: f11, sessionStatus: g12, isSatellite: h6 } = a11, i2 = bi(b11), j2 = i2?.frontendApi, k2 = i2?.instanceType === "development", l2 = b3(j2), m2 = "pending" === g12, n2 = (b12, { returnBackUrl: d12 }) => c12(co(f11, `${b12}/tasks`, d12, k2 ? a11.devBrowserToken : null, h6));
            return { redirectToSignUp: ({ returnBackUrl: b12 } = {}) => {
              e11 || l2 || bz.throwMissingPublishableKeyError();
              let g13 = `${l2}/sign-up`, i3 = e11 || function(a12) {
                if (!a12) return;
                let b13 = new URL(a12, f11);
                return b13.pathname = `${b13.pathname}/create`, b13.toString();
              }(d11) || g13;
              return m2 ? n2(i3, { returnBackUrl: b12 }) : c12(co(f11, i3, b12, k2 ? a11.devBrowserToken : null, h6));
            }, redirectToSignIn: ({ returnBackUrl: b12 } = {}) => {
              d11 || l2 || bz.throwMissingPublishableKeyError();
              let e12 = `${l2}/sign-in`, g13 = d11 || e12;
              return m2 ? n2(g13, { returnBackUrl: b12 }) : c12(co(f11, g13, b12, k2 ? a11.devBrowserToken : null, h6));
            } };
          })({ redirectAdapter: hw, baseUrl: b10.clerkUrl, signInUrl: d10.signInUrl, signUpUrl: d10.signUpUrl, publishableKey: d10.publishableKey, sessionStatus: null == (e10 = d10.toAuth()) ? void 0 : e10.sessionStatus, isSatellite: d10.isSatellite }), { returnBackUrl: g11 } = a10;
          return c11[f10 ? "redirectToSignIn" : "redirectToSignUp"]({ returnBackUrl: g11 });
        }
        if (hO(a10)) return hw(a10.redirectUrl);
        throw a10;
      };
      "undefined" != typeof process && (!process.env.NEXT_PUBLIC_CLERK_PUBLISHABLE_KEY && globalThis.NEXT_PUBLIC_CLERK_PUBLISHABLE_KEY && (process.env.NEXT_PUBLIC_CLERK_PUBLISHABLE_KEY = globalThis.NEXT_PUBLIC_CLERK_PUBLISHABLE_KEY), !process.env.CLERK_SECRET_KEY && globalThis.CLERK_SECRET_KEY && (process.env.CLERK_SECRET_KEY = globalThis.CLERK_SECRET_KEY), process.env.NEXT_PUBLIC_CLERK_PUBLISHABLE_KEY && (process.env.NEXT_PUBLIC_CLERK_PUBLISHABLE_KEY = process.env.NEXT_PUBLIC_CLERK_PUBLISHABLE_KEY.replace(/^\uFEFF/, "").trim()), process.env.CLERK_SECRET_KEY && (process.env.CLERK_SECRET_KEY = process.env.CLERK_SECRET_KEY.replace(/^\uFEFF/, "").trim()), globalThis.NEXT_PUBLIC_CLERK_PUBLISHABLE_KEY && "string" == typeof globalThis.NEXT_PUBLIC_CLERK_PUBLISHABLE_KEY && (globalThis.NEXT_PUBLIC_CLERK_PUBLISHABLE_KEY = globalThis.NEXT_PUBLIC_CLERK_PUBLISHABLE_KEY.replace(/^\uFEFF/, "").trim()), globalThis.CLERK_SECRET_KEY && "string" == typeof globalThis.CLERK_SECRET_KEY && (globalThis.CLERK_SECRET_KEY = globalThis.CLERK_SECRET_KEY.replace(/^\uFEFF/, "").trim()));
      let h_ = ((a10) => {
...
${b12.message}`);
        ...
        return gt.run(gs, () => {
          let a11 = fS("clerkMiddleware", (a12) => async (b11, c11) => {
            let f11 = "function" == typeof e10 ? await e10(b11) : e10, g11 = await hF((a13) => {
              var c12;
              return null == (c12 = b11.cookies.get(a13)) ? void 0 : c12.value;
            }), h7 = function(a13, b12) {
              return a13 || b12(), a13;
            }(f11.publishableKey || fZ || (null == g11 ? void 0 : g11.publishableKey), () => hs.throwMissingPublishableKeyError()), i2 = function(a13, b12) {
              return a13 || b12(), a13;
            }(f11.secretKey || fX || (null == g11 ? void 0 : g11.secretKey), () => hs.throwMissingSecretKeyError()), j2 = new URL(b11.nextUrl.href), k2 = f11.frontendApiProxy, l2 = f11.proxyUrl || f1 || f11.domain || f0;
            if (!k2 && !l2 && bk(h7) && b6(j2.hostname) && (k2 = { enabled: true }), k2) {
              let { enabled: a13, path: c12 = be } = k2;
              if (("function" == typeof a13 ? a13(j2) : a13) && function(a14, b12) {
                let c13 = fH(b12?.proxyPath || be), d11 = new URL(a14.url);
                return d11.pathname === c13 || d11.pathname.startsWith(c13 + "/");
              }(b11, { proxyPath: c12 })) return fJ(b11, { proxyPath: c12, publishableKey: h7, secretKey: i2 });
            }
            let m2 = { publishableKey: h7, secretKey: i2, signInUrl: f11.signInUrl || f3, signUpUrl: f11.signUpUrl || f4, ...f11 };
            gs.set("requestData", m2);
            let n2 = await hA();
            m2.debug && a12.enable();
            let o2 = fl(b11);
            a12.debug("options", m2), a12.debug("url", () => o2.toJSON());
            let p2 = b11.headers.get(cn.Headers.Authorization);
            p2 && p2.startsWith("Basic ") && a12.debug("Basic Auth detected");
            let q2 = b11.headers.get(cn.Headers.ContentSecurityPolicy);
            q2 && a12.debug("Content-Security-Policy detected", () => ({ value: q2 }));
            let r2 = await n2.authenticateRequest(o2, ((a13, b12) => {
              let c12 = b12;
              if (b12.frontendApiProxy && !b12.proxyUrl) {
                let { enabled: d11, path: e11 = be } = b12.frontendApiProxy, f12 = new URL(a13.url);
                if ("function" == typeof d11 ? d11(f12) : d11) {
                  let a14 = `${f12.origin}${e11}`;
                  c12 = { ...b12, proxyUrl: a14 };
                }
              }
              return { ...c12, ...((a14, b13) => {
                let c13, d11 = fT(null == b13 ? void 0 : b13.proxyUrl, a14.clerkUrl, f1);
                c13 = d11 && !b4(d11) ? new URL(d11, a14.clerkUrl).toString() : d11;
                let e11 = fT(b13.isSatellite, new URL(a14.url), f2), f12 = fT(b13.domain, new URL(a14.url), f0), g12 = (null == b13 ? void 0 : b13.signInUrl) || f3;
                if (e11 && !c13 && !f12) throw Error(hp);
                if (e11 && !b4(g12) && bl(b13.secretKey || fX)) throw Error(hq);
                return { proxyUrl: c13, isSatellite: e11, domain: f12, signInUrl: g12 };
              })(a13, c12), acceptsToken: "any" };
            })(o2, m2));
            return hV({ clerkRequest: o2, request: b11, event: c11, requestState: r2, handler: d10, options: m2, resolvedParams: f11, keyless: g11, logger: a12 });
          }), f10 = fS("clerkMiddleware", (a12) => async (b11, c11) => {
            let f11 = "function" == typeof e10 ? await e10(b11) : e10, g11 = await hF((a13) => {
              var c12;
              return null == (c12 = b11.cookies.get(a13)) ? void 0 : c12.value;
            }), h7 = f11.signInUrl || f3 || "", i2 = f11.signUpUrl || f4 || "", j2 = { publishableKey: "", secretKey: "", signInUrl: h7, signUpUrl: i2, ...f11 };
            gs.set("requestData", j2), j2.debug && a12.enable();
            let k2 = fl(b11);
            return a12.debug("keyless bootstrap (no publishable key)", () => ({ signInUrl: h7, signUpUrl: i2 })), a12.debug("url", () => k2.toJSON()), hV({ clerkRequest: k2, request: b11, event: c11, requestState: function({ signInUrl: a13 = "", signUpUrl: b12 = "", isSatellite: c12 = false, domain: d11 = "", proxyUrl: e11 = "", reason: f12 = fd.SessionTokenAndUATMissing, message: g12 = "", headers: h8 = new Headers() } = {}) {
              return fg({ status: fc.SignedOut, reason: f12, message: g12, proxyUrl: e11, publishableKey: "", isSatellite: c12, domain: d11, signInUrl: a13, signUpUrl: b12, afterSignInUrl: "", afterSignUpUrl: "", isSignedIn: false, isAuthenticated: false, tokenType: cs.SessionToken, toAuth: () => e8({ status: fc.SignedOut, reason: f12, message: g12 }), headers: h8, token: null });
            }({ signInUrl: h7, signUpUrl: i2 }), handler: d10, options: j2, resolvedParams: f11, keyless: g11, logger: a12 });
          }), g10 = async (b11, c11) => {
            var d11, g11;
            ...
            let h7 = "function" == typeof e10 ? await e10(b11) : e10, i2 = await hF((a12) => {
              var c12;
              return null == (c12 = b11.cookies.get(a12)) ? void 0 : c12.value;
            }), j2 = !(h7.publishableKey || fZ || (null == i2 ? void 0 : i2.publishableKey)), k2 = null != (g11 = null == (d11 = gq(b11, cn.Headers.Authorization)) ? void 0 : d11.replace("Bearer ", "")) ? g11 : "";
            return j2 && !df(k2) ? f10(b11, c11) : a11(b11, c11);
          }, h6 = async (b11, c11) => f8 ? g10(b11, c11) : a11(b11, c11);
          return b10 && c10 ? h6(b10, c10) : h6;
        });
      })(async (a10, b10) => {
        if ("/api/health" === b10.nextUrl.pathname) return R.next();
        h_(b10) && await a10.protect();
      }, { publishableKey: process.env.NEXT_PUBLIC_CLERK_PUBLISHABLE_KEY }), h1 = { matcher: ["/((?!_next|[^?]*\\.[^?]*$).*)", "/(api|trpc)(.*)"] };
      c(199);
      let h2 = { ...e }, h3 = h2.middleware || h2.default, h4 = "/middleware";
      if ("function" != typeof h3) throw Object.defineProperty(Error(`The Middleware "${h4}" must export a \`middleware\` or a \`default\` function`), "__NEXT_ERROR_CODE", { value: "E120", enumerable: false, configurable: true });
      function h5(a10) {
        return a0({ ...a10, page: h4, handler: async (...a11) => {
          try {
            return await h3(...a11);
          } catch (e10) {
      ...
      function l(a2) {
        let b2 = new Proxy(a2, { get(a3, c2, d2) {
          switch (c2) {
            case "delete":
              return function(...c3) {
                return m("cookies().delete"), a3.delete(...c3), b2;
              };
            case "set":
              return function(...c3) {
                return m("cookies().set"), a3.set(...c3), b2;
              };
            default:
      ...
      function m(a2) {
        if ("action" !== (0, g.XN)(a2).phase) throw new h();
      }
    }, 821: (a, b, c) => {
      "use strict";
      c.d(b, { Q: () => d });
...
var init_edgeFunctionHandler = __esm({
  "node_modules/@opennextjs/aws/dist/core/edgeFunctionHandler.js"() {
    ...
    globalThis._ROUTES = [{ "name": "middleware", "page": "/", "regex": ["^(?:\\/(_next\\/data\\/[^/]{1,}))?(?:\\/((?!_next|[^?]*\\.[^?]*$).*))(\\.json)?[\\/#\\?]?$", "^(?:\\/(_next\\/data\\/[^/]{1,}))?(?:\\/(api|trpc))(.*)(\\.json)?[\\/#\\?]?$"] }];
...
var NextConfig = { "env": {}, "webpack": null, "eslint": { "ignoreDuringBuilds": true }, "typescript": { "ignoreBuildErrors": true, "tsconfigPath": "tsconfig.json" }, "distDir": ".next", "cleanDistDir": true, "assetPrefix": "", "cacheMaxMemorySize": 52428800, "configOrigin": "next.config.ts", "useFileSystemPublicRoutes": true, "generateEtags": true, "pageExtensions": ["tsx", "ts", "jsx", "js"], "poweredByHeader": true, "compress": true, "images": { "deviceSizes": [640, 750, 828, 1080, 1200, 1920, 2048, 3840], "imageSizes": [16, 32, 48, 64, 96, 128, 256, 384], "path": "/_next/image", "loader": "default", "loaderFile": "", "domains": [], "disableStaticImages": false, "minimumCacheTTL": 60, "formats": ["image/webp"], "dangerouslyAllowSVG": false, "contentSecurityPolicy": "script-src 'none'; frame-src 'none'; sandbox;", "contentDispositionType": "attachment", "remotePatterns": [], "unoptimized": false }, "devIndicators": { "position": "bottom-left" }, "onDemandEntries": { "maxInactiveAge": 6e4, "pagesBufferLength": 5 }, "amp": { "canonicalBase": "" }, "basePath": "", "sassOptions": {}, "trailingSlash": false, "i18n": null, "productionBrowserSourceMaps": false, "excludeDefaultMomentLocales": true, "serverRuntimeConfig": {}, "publicRuntimeConfig": {}, "reactProductionProfiling": false, "reactStrictMode": null, "reactMaxHeadersLength": 6e3, "httpAgentOptions": { "keepAlive": true }, "logging": {}, "compiler": {}, "expireTime": 31536e3, "staticPageGenerationTimeout": 60, "output": "standalone", "modularizeImports": { "@mui/icons-material": { "transform": "@mui/icons-material/{{member}}" }, "lodash": { "transform": "lodash/{{member}}" } }, "outputFileTracingRoot": "C:\\Users\\i7 11th\\Desktop\\Proyectos Programaci\xF3n\\Portal Inmobiliario\\portal-inmobiliario", "experimental": { "useSkewCookie": false, "nodeMiddleware": false, "cacheLife": { "default": { "stale": 300, "revalidate": 900, "expire": 4294967294 }, "seconds": { "stale": 0, "revalidate": 1, "expire": 60 }, "minutes": { "stale": 300, "revalidate": 60, "expire": 3600 }, "hours": { "stale": 300, "revalidate": 3600, "expire": 86400 }, "days": { "stale": 300, "revalidate": 86400, "expire": 604800 }, "weeks": { "stale": 300, "revalidate": 604800, "expire": 2592e3 }, "max": { "stale": 300, "revalidate": 2592e3, "expire": 4294967294 } }, "cacheHandlers": {}, "cssChunking": true, "multiZoneDraftMode": false, "appNavFailHandling": false, "prerenderEarlyExit": true, "serverMinification": true, "serverSourceMaps": false, "linkNoTouchStart": false, "caseSensitiveRoutes": false, "clientSegmentCache": false, "dynamicOnHover": false, "preloadEntriesOnStart": true, "clientRouterFilter": true, "clientRouterFilterRedirects": false, "fetchCacheKeyPrefix": "", "middlewarePrefetch": "flexible", "optimisticClientCache": true, "manualClientBasePath": false, "cpus": 7, "memoryBasedWorkersCount": false, "imgOptConcurrency": null, "imgOptTimeoutInSeconds": 7, "imgOptMaxInputPixels": 268402689, "imgOptSequentialRead": null, "isrFlushToDisk": true, "workerThreads": false, "optimizeCss": false, "nextScriptWorkers": false, "scrollRestoration": false, "externalDir": false, "disableOptimizedLoading": false, "gzipSize": true, "craCompat": false, "esmExternals": true, "fullySpecified": false, "swcTraceProfiling": false, "forceSwcTransforms": false, "largePageDataBytes": 128e3, "typedRoutes": false, "typedEnv": false, "parallelServerCompiles": false, "parallelServerBuildTraces": false, "ppr": false, "authInterrupts": false, "webpackMemoryOptimizations": false, "optimizeServerReact": true, "viewTransition": false, "routerBFCache": false, "removeUncaughtErrorAndRejectionListeners": false, "validateRSCRequestHeaders": false, "staleTimes": { "dynamic": 0, "static": 300 }, "serverComponentsHmrCache": true, "staticGenerationMaxConcurrency": 8, "staticGenerationMinPagesPerWorker": 25, "dynamicIO": false, "inlineCss": false, "useCache": false, "globalNotFound": false, "devtoolNewPanelUI": false, "devtoolSegmentExplorer": false, "browserDebugInfoInTerminal": false, "optimizeRouterScrolling": false, "strictNextHead": true, "middlewareClientMaxBodySize": 10485760, "optimizePackageImports": ["lucide-react", "date-fns", "lodash-es", "ramda", "antd", "react-bootstrap", "ahooks", "@ant-design/icons", "@headlessui/react", "@headlessui-float/react", "@heroicons/react/20/solid", "@heroicons/react/24/solid", "@heroicons/react/24/outline", "@visx/visx", "@tremor/react", "rxjs", "@mui/material", "@mui/icons-material", "recharts", "react-use", "effect", "@effect/schema", "@effect/platform", "@effect/platform-node", "@effect/platform-browser", "@effect/platform-bun", "@effect/sql", "@effect/sql-mssql", "@effect/sql-mysql2", "@effect/sql-pg", "@effect/sql-sqlite-node", "@effect/sql-sqlite-bun", "@effect/sql-sqlite-wasm", "@effect/sql-sqlite-react-native", "@effect/rpc", "@effect/rpc-http", "@effect/typeclass", "@effect/experimental", "@effect/opentelemetry", "@material-ui/core", "@material-ui/icons", "@tabler/icons-react", "mui-core", "react-icons/ai", "react-icons/bi", "react-icons/bs", "react-icons/cg", "react-icons/ci", "react-icons/di", "react-icons/fa", "react-icons/fa6", "react-icons/fc", "react-icons/fi", "react-icons/gi", "react-icons/go", "react-icons/gr", "react-icons/hi", "react-icons/hi2", "react-icons/im", "react-icons/io", "react-icons/io5", "react-icons/lia", "react-icons/lib", "react-icons/lu", "react-icons/md", "react-icons/pi", "react-icons/ri", "react-icons/rx", "react-icons/si", "react-icons/sl", "react-icons/tb", "react-icons/tfi", "react-icons/ti", "react-icons/vsc", "react-icons/wi"], "trustHostHeader": false, "isExperimentalCompile": false }, "htmlLimitedBots": "Mediapartners-Google|Chrome-Lighthouse|Slurp|DuckDuckBot|baiduspider|yandex|sogou|bitlybot|tumblr|vkShare|quora link preview|redditbot|ia_archiver|Bingbot|BingPreview|applebot|facebookexternalhit|facebookcatalog|Twitterbot|LinkedInBot|Slackbot|Discordbot|WhatsApp|SkypeUriPreview|Yeti", "bundlePagesRouterDependencies": false, "configFileName": "next.config.ts", "turbopack": { "root": "C:\\Users\\i7 11th\\Desktop\\Proyectos Programaci\xF3n\\Portal Inmobiliario\\portal-inmobiliario" } };
var BuildId = "K7oZ-jQW2VePlCTtO_k3c";
var RoutesManifest = { "basePath": "", "rewrites": { "beforeFiles": [], "afterFiles": [], "fallback": [] }, "redirects": [{ "source": "/:path+/", "destination": "/:path+", "internal": true, "statusCode": 308, "regex": "^(?:/((?:[^/]+?)(?:/(?:[^/]+?))*))/$" }], "routes": { "static": [{ "page": "/", "regex": "^/(?:/)?$", "routeKeys": {}, "namedRegex": "^/(?:/)?$" }, { "page": "/_not-found", "regex": "^/_not\\-found(?:/)?$", "routeKeys": {}, "namedRegex": "^/_not\\-found(?:/)?$" }, { "page": "/admin", "regex": "^/admin(?:/)?$", "routeKeys": {}, "namedRegex": "^/admin(?:/)?$" }, { "page": "/buscar", "regex": "^/buscar(?:/)?$", "routeKeys": {}, "namedRegex": "^/buscar(?:/)?$" }, { "page": "/consejos", "regex": "^/consejos(?:/)?$", "routeKeys": {}, "namedRegex": "^/consejos(?:/)?$" }, { "page": "/dashboard", "regex": "^/dashboard(?:/)?$", "routeKeys": {}, "namedRegex": "^/dashboard(?:/)?$" }, { "page": "/favicon.ico", "regex": "^/favicon\\.ico(?:/)?$", "routeKeys": {}, "namedRegex": "^/favicon\\.ico(?:/)?$" }, { "page": "/sitemap.xml", "regex": "^/sitemap\\.xml(?:/)?$", "routeKeys": {}, "namedRegex": "^/sitemap\\.xml(?:/)?$" }], "dynamic": [{ "page": "/api/propiedades/[id]", "regex": "^/api/propiedades/([^/]+?)(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/api/propiedades/(?<nxtPid>[^/]+?)(?:/)?$" }, { "page": "/api/propiedades/[id]/media", "regex": "^/api/propiedades/([^/]+?)/media(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/api/propiedades/(?<nxtPid>[^/]+?)/media(?:/)?$" }, { "page": "/fotos/[...slug]", "regex": "^/fotos/(.+?)(?:/)?$", "routeKeys": { "nxtPslug": "nxtPslug" }, "namedRegex": "^/fotos/(?<nxtPslug>.+?)(?:/)?$" }, { "page": "/sign-in/[[...sign-in]]", "regex": "^/sign\\-in(?:/(.+?))?(?:/)?$", "routeKeys": { "nxtPsignin": "nxtPsign-in" }, "namedRegex": "^/sign\\-in(?:/(?<nxtPsignin>.+?))?(?:/)?$" }, { "page": "/sign-up/[[...sign-up]]", "regex": "^/sign\\-up(?:/(.+?))?(?:/)?$", "routeKeys": { "nxtPsignup": "nxtPsign-up" }, "namedRegex": "^/sign\\-up(?:/(?<nxtPsignup>.+?))?(?:/)?$" }, { "page": "/[operacion]", "regex": "^/([^/]+?)(?:/)?$", "routeKeys": { "nxtPoperacion": "nxtPoperacion" }, "namedRegex": "^/(?<nxtPoperacion>[^/]+?)(?:/)?$" }, { "page": "/[operacion]/[...slug]", "regex": "^/([^/]+?)/(.+?)(?:/)?$", "routeKeys": { "nxtPoperacion": "nxtPoperacion", "nxtPslug": "nxtPslug" }, "namedRegex": "^/(?<nxtPoperacion>[^/]+?)/(?<nxtPslug>.+?)(?:/)?$" }], "data": { "static": [], "dynamic": [] } }, "locales": [] };
var ConfigHeaders = [];
var PrerenderManifest = { "version": 4, "routes": { "/favicon.ico": { "initialHeaders": { "cache-control": "public, max-age=0, must-revalidate", "content-type": "image/x-icon", "x-next-cache-tags": "_N_T_/layout,_N_T_/favicon.ico/layout,_N_T_/favicon.ico/route,_N_T_/favicon.ico" }, "experimentalBypassFor": [{ "type": "header", "key": "Next-Action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/favicon.ico", "dataRoute": null, "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] } }, "dynamicRoutes": {}, "notFoundRoutes": [], "preview": { "previewModeId": "6ec1d2e4d229fc124df1611a84616429", "previewModeSigningKey": "8bb8ebf6925c1117ac1c511ebe96b1cf298ad1030e109f540ba8beea938beb45", "previewModeEncryptionKey": "4f6ef38a45c485a864d86ae546df18d711eadd621de9d4f2779cc681d9a526d7" } };
var MiddlewareManifest = { "version": 3, "middleware": { "/": { "files": ["server/edge-runtime-webpack.js", "server/middleware.js"], "name": "middleware", "page": "/", "matchers": [{ "regexp": "^(?:\\/(_next\\/data\\/[^/]{1,}))?(?:\\/((?!_next|[^?]*\\.[^?]*$).*))(\\.json)?[\\/#\\?]?$", "originalSource": "/((?!_next|[^?]*\\.[^?]*$).*)" }, { "regexp": "^(?:\\/(_next\\/data\\/[^/]{1,}))?(?:\\/(api|trpc))(.*)(\\.json)?[\\/#\\?]?$", "originalSource": "/(api|trpc)(.*)" }], "wasm": [], "assets": [], "env": { "__NEXT_BUILD_ID": "K7oZ-jQW2VePlCTtO_k3c", "NEXT_SERVER_ACTIONS_ENCRYPTION_KEY": "1THX12bmoO8Qfhay3EsnkKBX0Ti6y6FmChvxPz4Lc5o=", "__NEXT_PREVIEW_MODE_ID": "6ec1d2e4d229fc124df1611a84616429", "__NEXT_PREVIEW_MODE_SIGNING_KEY": "8bb8ebf6925c1117ac1c511ebe96b1cf298ad1030e109f540ba8beea938beb45", "__NEXT_PREVIEW_MODE_ENCRYPTION_KEY": "4f6ef38a45c485a864d86ae546df18d711eadd621de9d4f2779cc681d9a526d7" } } }, "functions": {}, "sortedMiddleware": ["/"] };
var AppPathRoutesManifest = { "/api/admin/cupones/route": "/api/admin/cupones", "/api/admin/migrar-fotos/route": "/api/admin/migrar-fotos", "/api/pagos/flow-create/route": "/api/pagos/flow-create", "/api/fotos/eliminar/route": "/api/fotos/eliminar", "/api/ia/descripcion/route": "/api/ia/descripcion", "/api/propiedades/[id]/media/route": "/api/propiedades/[id]/media", "/api/pagos/preference/route": "/api/pagos/preference", "/api/propiedades/crear/route": "/api/propiedades/crear", "/_not-found/page": "/_not-found", "/api/propiedades/[id]/route": "/api/propiedades/[id]", "/api/upload-video/route": "/api/upload-video", "/api/videos/crear/route": "/api/videos/crear", "/api/upload/route": "/api/upload", "/api/videos/eliminar/route": "/api/videos/eliminar", "/api/webhook-flow/route": "/api/webhook-flow", "/api/webhook-pagos/route": "/api/webhook-pagos", "/favicon.ico/route": "/favicon.ico", "/api/admin/configuraciones/route": "/api/admin/configuraciones", "/api/admin/usuarios/route": "/api/admin/usuarios", "/api/health/route": "/api/health", "/api/visitas/route": "/api/visitas", "/api/visitas/estadisticas/route": "/api/visitas/estadisticas", "/fotos/[...slug]/route": "/fotos/[...slug]", "/sitemap.xml/route": "/sitemap.xml", "/admin/page": "/admin", "/sign-in/[[...sign-in]]/page": "/sign-in/[[...sign-in]]", "/sign-up/[[...sign-up]]/page": "/sign-up/[[...sign-up]]", "/[operacion]/page": "/[operacion]", "/dashboard/page": "/dashboard", "/[operacion]/[...slug]/page": "/[operacion]/[...slug]", "/consejos/page": "/consejos", "/buscar/page": "/buscar", "/page": "/" };
